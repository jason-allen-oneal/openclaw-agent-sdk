...
import { a as readRecentSessionMessagesWithStatsAsync, f as readSessionMessagesWithSourceAsync } from "./session-utils.fs-Y_TmTCGQ.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-BoQs4wK-.js";
import { g as resolveGatewaySessionStoreTarget, m as resolveFreshestSessionEntryFromStoreKeys } from "./session-utils-CFmlVr6t.js";
import { a as sendJson, i as sendInvalidRequest, l as setSseHeaders, o as sendMethodNotAllowed } from "./http-common-B7U3wQMs.js";
import { f as resolveSharedSecretHttpOperatorScopes, i as checkGatewayHttpRequestAuth, o as getHeader, r as authorizeScopedGatewayHttpRequestOrReply } from "./http-auth-utils-DAMcdY14.js";
import "./http-utils-6sBFWbZ9.js";
import { n as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS, t as resolveTranscriptPathForComparison } from "./session-transcript-path-CXYa7E96.js";
import { n as buildSessionHistorySnapshot, r as resolveSessionHistoryTailReadOptions, t as SessionHistorySseState } from "./session-history-state-x-Fv_rvW.js";
...
async function handleSessionHistoryHttpRequest(req, res, opts) {
	...
	const boundedSnapshot = cursor === void 0 && typeof limit === "number" ? await readRecentSessionMessagesWithStatsAsync(entry.sessionId, target.storePath, entry.sessionFile, {
		...resolveSessionHistoryTailReadOptions(limit),
		allowResetArchiveFallback: true
	}) : void 0;
	const fullSnapshot = boundedSnapshot === void 0 && entry?.sessionId ? await readSessionMessagesWithSourceAsync(entry.sessionId, target.storePath, entry.sessionFile, {
		mode: "full",
