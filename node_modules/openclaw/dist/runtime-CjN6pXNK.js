...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-Dl6XGYSG.js")]);
...
//#endregion
export { makePluginSessionSchedulerJobKey as A, isPluginRegistryActivated as C, deletePluginSessionSchedulerJob as D, clearPluginRunContext as E, normalizePluginHostHookId as F, createEmptyPluginRegistry as I, setPluginRunContext as M, withPluginHostCleanupTimeout as N, getPluginRunContext as O, buildPluginAgentTurnPrepareContext as P, setActivePluginRegistry as S, cleanupPluginSessionSchedulerJobs as T, requireActivePluginChannelRegistry as _, getActivePluginHttpRouteRegistryVersion as a, resetPluginRuntimeStateForTest as b, getActivePluginRegistryVersion as c, listImportedRuntimePluginIds as d, pinActivePluginChannelRegistry as f, releasePinnedPluginHttpRouteRegistry as g, releasePinnedPluginChannelRegistry as h, getActivePluginHttpRouteRegistry as i, registerPluginSessionSchedulerJob as j, getPluginSessionSchedulerJobGeneration as k, getActivePluginRegistryWorkspaceDir as l, recordImportedPluginId as m, getActivePluginChannelRegistryVersion as n, getActivePluginRegistry as o, pinActivePluginHttpRouteRegistry as p, getActivePluginGatewayCommandRegistry as r, getActivePluginRegistryKey as s, getActivePluginChannelRegistry as t, getActivePluginRuntimeSubagentMode as u, requireActivePluginHttpRouteRegistry as v, isPluginRegistryRetired as w, resolveActivePluginHttpRouteRegistry as x, requireActivePluginRegistry as y };
