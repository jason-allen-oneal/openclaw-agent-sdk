...
import { i as createActionGate } from "./common-CEBsSh4n.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-EAs5v0O0.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-D1WUExii.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-FkwDDoeD.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-F-TLiS3r.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DGmM3dk9.js";
import { n as createFeishuSendReceipt } from "./send-result-xJX9QZnH.js";
...
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-D__WOg2t.js";
import { t as messageActionTargetAliases } from "./security-audit-BFDpgjpY.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-BzsP0Npo.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DNO5Tunf.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-B8Td_6It.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-MOjtq6jV.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-DkVAMZPO.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CSBUy56o.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-pYgdSkwd.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-AosTqAM4.js");
