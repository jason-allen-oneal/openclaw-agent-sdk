...
let browserRegistrationRuntimeModulePromise = null;
const loadBrowserRegistrationRuntimeModule = async () => {
	browserRegistrationRuntimeModulePromise ??= import("./extensions/browser/register.runtime.js");
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-CH7-zl4u.js");
