...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-Bs4s6Vxq.js";
import { r as resolveCrestodianOperation } from "./dialogue-BERzoiqc.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-rzCBPRph.js")).runCrestodianTui;
	opts.onReady?.();
