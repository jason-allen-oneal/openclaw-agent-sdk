...
import { i as readSessionEntry } from "./store-load-BEkoRRyW.js";
import "./sessions-DieR2Eem.js";
import { n as buildAgentRunTerminalOutcomeFromWaitResult } from "./agent-run-terminal-outcome-X--EiwYW.js";
...
import { n as sanitizeTextContent, t as extractAssistantText } from "./chat-history-text-BOxvyH9H.js";
import { n as wrapPromptDataBlock } from "./sanitize-for-prompt-ByaJGDhT.js";
import "./server-plugins-C0AakYiQ.js";
...
async function readSubagentOutput(sessionKey, _outcome, options) {
	let messages;
	if (options?.sessionFile) messages = await subagentAnnounceOutputDeps.readSessionMessagesAsync(sessionKey, void 0, options.sessionFile, {
		mode: "recent",
		maxMessages: 100,
		maxBytes: 1024 * 1024
	});
