...
import { l as isSecretRef } from "./types.secrets-B6pb_3Jn.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { s as normalizePluginsConfig } from "./config-state-0eXXevbb.js";
import { a as markAutoFallbackPrimaryProbe, h as resolveEffectiveModelFallbacks, i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-B4NxGkqZ.js";
import { a as isSubagentSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { c as isUnscopedSessionKeySentinel, f as resolveAgentIdFromSessionKey, g as scopeLegacySessionKeyToAgent, s as classifySessionKeyShape, u as normalizeAgentId } from "./session-key-B_NoIfpX.js";
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-Ckm_ksHY.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DNJywrQV.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-fQmSDfK-.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-CG8AzHpQ.js";
...
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BFetL3S9.js";
import { b as withAgentRunLifecycleGeneration, h as registerAgentRunContext, i as clearAgentRunContext, n as captureAgentRunLifecycleGeneration, s as emitAgentEvent, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-C3fRM85v.js";
...
import { o as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-7QnPW4As.js";
import { g as resolveConfiguredModelRef, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as resolveModelRefFromString } from "./model-selection-shared-By-X2JmI.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-CYEDNFte.js";
import { a as normalizeModelRef, i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-CBjx3j0e.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-D05d2kfO.js";
import { d as ensureAgentWorkspace } from "./workspace-C9ULOsP_.js";
...
import { K as createTrajectoryRuntimeRecorder, t as resolveAvailableAgentHarnessPolicy } from "./selection-kQiC501t.js";
import { s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-DivWGEJB.js";
import { t as buildOutboundSessionContext } from "./session-context-BJdulVUq.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-D1kculJq.js";
import { f as LiveSessionModelSwitchError, o as runWithModelFallback } from "./model-fallback-CB6h6-6n.js";
import { n as resolveSession } from "./session-DKwhiUG7.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets--sBbmioM.js";
import { n as repairProviderWrappedModelOverride, t as applyModelOverrideToSessionEntry } from "./model-overrides-D5WaLvcp.js";
...
import { t as prepareInternalSessionEffectsTranscript } from "./internal-session-effects-D37ZLYJ5.js";
...
import "./live-model-switch-CEKgoPs8.js";
import { t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-qSEiduY5.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-DeRronv4.js";
import { t as resolveFastModeState } from "./fast-mode-Gt-xvstA.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-c9clcyWx.js";
import { t as NodeRegistry } from "./node-registry-D3vmVKIR.js";
import { r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-Y_4xWgUk.js";
import { n as applyVerboseOverride } from "./level-overrides-p_MXaFgW.js";
import { a as resolveInternalEventTranscriptBody, i as resolveAcpPromptBody, n as persistSessionEntry$1, r as prependInternalEventContext, t as resolveAgentRunContext } from "./run-context-DjmrX8fz.js";
...
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-WHbnUIqa.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-BEZlvrUq.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-DOsEVxP2.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-t-JeVBd7.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-BVZXhfD0.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-CVmmkDkI.js"), import("./session-snapshot-C2d3GSXQ.js")]);
	return {
...
async function prepareAgentCommandExecution(opts, runtime) {
	...
	const explicitSessionKey = resolveExplicitAgentCommandSessionKey({
		...
		agentIdOverride,
		shouldScopeDefaultAgentKey: Boolean(rawExplicitSessionKey && !agentIdOverride && classifySessionKeyShape(rawExplicitSessionKey) === "legacy_or_alias" && !isUnscopedSessionKeySentinel(rawExplicitSessionKey)),
		cfg
	});
...
async function agentCommandInternal(opts, runtime = defaultRuntime, deps) {
	...
	try {
		...
		try {
			...
			if (sessionStore && sessionKey && !suppressVisibleSessionEffects) {
				...
				await updateSessionStoreAfterAgentRun({
					...
					preserveRuntimeModel: opts.bootstrapContextRunKind === "heartbeat" || preserveUserFacingSessionModelState,
			...
			if (opts.deliver === true && sessionStore && sessionKey && !suppressVisibleSessionEffects && payloads.length > 0 && !isSubagentSessionKey(sessionKey)) {
				const now = Date.now();
			...
			if (sessionStore && sessionKey && !isSubagentSessionKey(sessionKey) && !suppressVisibleSessionEffects) {
				const entry = sessionStore[sessionKey] ?? sessionEntry;
		...
		if (trackedRestartRecoveryDeliveryContext && sessionStore && sessionKey) try {
			const entry = sessionStore[sessionKey] ?? sessionEntry;
...
async function agentCommandFromIngress(opts, runtime = defaultRuntime, deps) {
	...
	const lifecycleGeneration = opts.lifecycleGeneration ?? captureAgentRunLifecycleGeneration(opts.runId ?? "");
	return await withAgentRunLifecycleGeneration(lifecycleGeneration, () => agentCommandInternal({
		...opts,
		lifecycleGeneration,
		senderIsOwner: opts.senderIsOwner === true
	}, runtime, deps));
