...
import { l as normalizeStringEntries, v as uniqueValues } from "./string-normalization-WNUDCpXX.js";
import { g as shortenHomePath } from "./utils-CCC-BEJH.js";
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef, s as coerceSecretRef } from "./types.secrets-B6pb_3Jn.js";
...
import { a as isValidFileSecretRefId, c as secretRefKey, i as isValidExecSecretRefId, l as validateExecSecretRefId, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage } from "./ref-contract-Bav2KeaN.js";
import { a as resolveSecretRefValue, l as resolveSecretProviderIntegrationConfig, s as isPluginIntegrationSecretProviderConfig } from "./resolve-C1PJUY9f.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CHJ8MmHb.js";
import { n as info, o as success, t as danger } from "./globals-DbTJQTMp.js";
import { G as AUTO_MANAGED_CONFIG_META_PATHS, S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, u as readConfigFileSnapshot } from "./io-fQmSDfK-.js";
import { T as SecretProviderSchema } from "./zod-schema.core-DAimf26A.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-COoNML-C.js";
import { n as formatPluginPackagingRuntimeOutputRecoveryHint } from "./config-recovery-hints-DCnttk3l.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CCAE7mY4.js";
import { n as setCommandJsonMode } from "./json-mode-CMT3Sasq.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BaTj_szb.js");
