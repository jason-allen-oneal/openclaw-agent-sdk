...
import { c as readErrorName, i as formatErrorMessage } from "./errors-CbY2H91D.js";
...
import { u as toSafeImportPath } from "./plugin-module-loader-cache-lz0qhu-X.js";
...
import { f as getAgentRunContext, m as onAgentEvent } from "./agent-events-C3fRM85v.js";
...
import { c as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-BEkoRRyW.js";
import { d as updateSessionStore } from "./store-Dcn5FSKd.js";
import "./sessions-DieR2Eem.js";
import { n as buildAgentRunTerminalOutcomeFromWaitResult, o as formatBlockedLivenessError, s as isBlockedLivenessState } from "./agent-run-terminal-outcome-X--EiwYW.js";
import { i as isAbortedAgentStopReason } from "./run-termination-u49x3Tfg.js";
import { n as extractTextFromChatContent } from "./chat-content-BbLAEXko.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DKoww6Sq.js";
...
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DFEaH2oL.js";
import { d as withSubagentOutcomeTiming, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-Bh_0-7ti.js";
import { n as removeInternalSessionEffectsTranscript } from "./internal-session-effects-D37ZLYJ5.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Ys9_fAT7.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BkEkzWQP.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Ys9_fAT7.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CoxrDc2V.js").then(({ scheduleOrphanRecovery }) => {
