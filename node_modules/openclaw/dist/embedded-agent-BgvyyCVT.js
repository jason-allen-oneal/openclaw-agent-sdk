...
import { S as freezeDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
import { t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { r as hasConfiguredModelFallbacks, s as resolveAgentExecutionContract, y as resolveSessionAgentIds } from "./agent-scope-B4NxGkqZ.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DNJywrQV.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-jnx0nhpN.js";
import { i as getReplyPayloadMetadata, r as copyReplyPayloadMetadata } from "./reply-payload-CZJ2cgZc.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Quvi-RcW.js";
import { o as resolveContextEngine, s as resolveContextEngineOwnerPluginId } from "./registry-DixvBrod.js";
import { b as withAgentRunLifecycleGeneration, d as getAgentEventLifecycleGeneration, f as getAgentRunContext, h as registerAgentRunContext, n as captureAgentRunLifecycleGeneration, r as claimAgentRunContext, t as assertAgentRunLifecycleGenerationCurrent, u as emitAgentPlanEvent } from "./agent-events-C3fRM85v.js";
import { u as resolveStorePath } from "./paths-NEwU8m3X.js";
import { f as updateSessionStoreEntry } from "./store-Dcn5FSKd.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-Dx39C4tw.js";
import "./sessions-DieR2Eem.js";
import { a as resolveProviderAuthProfileId } from "./provider-hook-runtime-Cwefeem_.js";
import { y as prepareProviderRuntimeAuth } from "./provider-runtime-Cp9BfFXg.js";
import "./auth-profiles-BeBRJlFs.js";
import { n as markAuthProfileSuccess } from "./profiles-Bu3mimei.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-CuMi9GBf.js";
import { r as ensureOpenClawModelsJson } from "./models-config-CDOOy1hF.js";
import { t as resolveThinkingDefault } from "./model-thinking-default-DxcHqA8K.js";
import { t as MissingProviderAuthError } from "./model-auth-runtime-shared-ZF0jyHxm.js";
import { a as getApiKeyForModel, g as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-Aq6KQDp8.js";
import { n as formatBillingErrorMessage, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-NOYqsmDF.js";
import "./runs-DI_L8C_8.js";
...
import { i as enqueueCommandInLane, s as getCommandLaneSnapshot } from "./command-queue-DxRdA7fT.js";
import { E as parseImageSizeError, T as parseImageDimensionError, _ as isFailoverErrorMessage, b as isLikelyContextOverflowError, c as formatAssistantErrorText, d as isAuthAssistantError, f as isBillingAssistantError, g as isFailoverAssistantError, m as isCompactionFailureError, n as classifyAssistantFailoverReason, r as classifyFailoverReason, s as extractObservedOverflowTokenCount, x as isRateLimitAssistantError } from "./errors-B4mplIiL.js";
import { a as describeFailoverError, d as resolveFailoverStatus, i as coerceToFailoverError, t as FailoverError } from "./failover-error-CC108ogz.js";
import { A as STRICT_AGENTIC_BLOCKED_TEXT, B as resolveRunLivenessState, C as mergeUsageIntoAccumulator, D as createEmbeddedRunStageTracker, E as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, F as resolveIncompleteTurnPayloadText, G as observeReplayMetadata, H as shouldRetryMissingAssistantTurn, I as resolvePlanningOnlyRetryInstruction, L as resolvePlanningOnlyRetryLimit, M as resolveAckExecutionFastPathInstruction, N as resolveAttemptReplayMetadata, O as formatEmbeddedRunStageSummary, P as resolveEmptyResponseRetryInstruction, R as resolveReasoningOnlyRetryInstruction, S as createUsageAccumulator, U as shouldTreatEmptyAssistantReplyAsSilent, V as resolveSilentToolResultReplyPayload, W as createEmbeddedRunReplayState, _ as resolveOverloadProfileRotationLimit, a as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, b as resolveSameModelRateLimitRetryDelayMs, c as buildUsageAgentMetaFields, d as resolveActiveErrorContext, f as resolveFinalAssistantRawText, g as resolveOverloadFailoverBackoffMs, h as resolveNextSameModelRateLimitRetryCount, i as RUNTIME_AUTH_REFRESH_MARGIN_MS, j as extractPlanningOnlyPlanDetails, k as shouldWarnEmbeddedRunStageSummary, l as createCompactionDiagId, m as resolveMaxRunRetryIterations, n as runAgentHarnessAttempt, o as RUNTIME_AUTH_REFRESH_RETRY_MS, p as resolveFinalAssistantVisibleText, r as selectAgentHarness, s as buildErrorAgentMeta, u as isAssistantForModelRef, v as resolveRateLimitProfileRotationLimit, x as scrubAnthropicRefusalMagic, y as resolveReportedModelRef, z as resolveReplayInvalidFlag } from "./selection-kQiC501t.js";
import { d as isStrictAgenticExecutionContractActive } from "./openclaw-tools-50pm1WIW.js";
import { t as log$1 } from "./logger-BEGZufhT.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-52t6V0oE.js";
import { d as retireSessionMcpRuntimeForSessionKey, u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-B0D_K5RM.js";
import "./agent-bundle-mcp-tools-BGNF7jxG.js";
import { n as rotateTranscriptFileAfterCompaction, r as shouldRotateCompactionTranscript, s as normalizeContextTokenBudget } from "./compaction-successor-transcript-Ncp4Uf5J.js";
import "./tool-split-DXB3RqC6.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-CvzYkYSe.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-C5IM2W3a.js";
import { l as hasMessagingToolDeliveryEvidence, u as hasOutboundDeliveryEvidence } from "./subagent-announce-delivery-BdIxN0mb.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { i as pickFallbackThinkingLevel } from "./embedded-agent-helpers-CULGwdfn.js";
import { c as suspendSession, d as shouldSuppressRawErrorConsoleSuffix, f as LiveSessionModelSwitchError, l as buildApiErrorObservationFields, m as shouldAllowCooldownProbeForReason, s as resolveSessionSuspensionReason } from "./model-fallback-CB6h6-6n.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-DKwhiUG7.js";
...
import { a as resolveLiveToolResultMaxChars, c as truncateOversizedToolResultsInSession, o as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-CE7-U3RC.js";
import { c as resolveCompactionTimeoutMs, o as compactContextEngineWithSafetyTimeout, s as compactWithSafetyTimeout } from "./tool-result-middleware-BUb-oCHG.js";
import "./extra-params-IU6ycWo1.js";
import { m as resolveContextEngineCapabilities, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-t1_F9kum.js";
import { c as runContextEngineMaintenance } from "./context-engine-lifecycle-TJVPBHTV.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, r as evaluateContextWindowGuard, s as resolveContextWindowInfo } from "./context-window-guard-CQzQLML9.js";
import "./sandbox-info-wuJXT5d1.js";
import { n as runAgentCleanupStep } from "./attempt.tool-run-context-CT5r1Qgk.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-Bn2yMFF-.js";
...
import { n as isRecoverableNativeHarnessBindingFailure, t as maybeCompactAgentHarnessSession } from "./compaction-CO9kgXmn.js";
...
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-Di0yKRbB.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-sqGEsK7a.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-DVcQJBBn.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CEKgoPs8.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-C8BChn3T.js";
import { r as buildAgentRuntimePlan } from "./build-BvUOiCFf.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-Bzyfn2MY.js";
import { n as isExecLikeToolName, t as buildEmbeddedRunPayloads } from "./payloads-BzbxMAeK.js";
