...
import { o as toAgentModelListLike } from "./model-input-B2zxl6MM.js";
import { d as resolveAgentModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-B4NxGkqZ.js";
...
import { t as CODEX_APP_SERVER_AUTH_MARKER } from "./model-auth-markers-DICpe16f.js";
...
import { t as resolveModelAuthLabel } from "./model-auth-label-Rer6zgXi.js";
import { o as resolveUsageProviderId } from "./provider-usage.shared-DOxrEMuU.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-CZ08KJDf.js";
import { r as formatUsageWindowSummary } from "./provider-usage-DKOcGm4a.js";
import { t as loadProviderUsageSummary } from "./provider-usage.load-BuZqvtdr.js";
...
function loadAgentHarnessSelectionRuntime() {
	return agentHarnessSelectionRuntimePromise ??= import("./selection-DelXJPau.js");
}
...
async function buildStatusText(params) {
	...
	if (shouldPreferActiveRuntimeAliasAuthLabel({
		runtimeAliasModelEquivalent: areRuntimeModelRefsEquivalent(modelRefs.selected.label, modelRefs.active.label, { config: cfg }),
	...
	const currentUsageProvider = resolveUsageProviderId(activeStatusProvider, { credentialType: usageCredentialType }) ?? resolveUsageProviderId(activeProvider, { credentialType: usageCredentialType });
	let usageLine = null;
