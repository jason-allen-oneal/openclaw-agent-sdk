...
import { t as CONFIG_PATH } from "./paths-mvMm5bYV.js";
import { t as formatCliCommand } from "./command-format-CKGmlpAQ.js";
import { c as isRecord$1 } from "./utils-CCC-BEJH.js";
import { h as parseLegacySecretRefEnvMarker, i as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-B6pb_3Jn.js";
import { i as normalizeProviderId$1 } from "./provider-id-Dq06Bcx6.js";
import { r as normalizeChatChannelId } from "./ids-COROyziI.js";
...
import { n as discoverConfigSecretTargets } from "./target-registry-CHJ8MmHb.js";
import { R as resolveNormalizedProviderModelMaxTokens } from "./io-fQmSDfK-.js";
import { u as collectConfiguredModelRefs } from "./channel-env-var-names-BB2Lxcdw.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-C8rQ5-HL.js";
import { n as formatConfigIssueLines } from "./issue-format-RCKTtsD6.js";
import { r as normalizeTalkSection } from "./talk-C7YVn0OJ.js";
import { c as callGateway } from "./call-BlqKbSL2.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-D_Z6ODEE.js";
...
import { n as isCommonSingleAccountPromotionKey, t as collectSingleAccountPromotionEntries } from "./setup-promotion-keys-Oj7oZvpC.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CGJGGwvr.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-DGNBoJQP.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-CNjdDapx.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BGMSeWmL.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-xigz9ub4.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-lTKPoT-O.js";
...
function removeDerivedRealtimeSpeakerVoice(rawTalk, normalizedTalk) {
	...
	if (!isRecord(rawRealtime) || !normalizedRealtime || rawRealtime.speakerVoice !== void 0 || normalizedRealtime.speakerVoice === void 0 || normalizedRealtime.speakerVoice !== normalizedRealtime.voice) return;
...
function normalizeLegacyMistralModelCost(params) {
	...
	if (!isRecord$1(cost) || cost.cacheRead !== 0) return {
		model: params.model,
		changed: false
	};
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BcZMFmdq.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BqeMlKSc.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CO9rlVBU.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-CKpLjor1.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Bx4ghuLj.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-CzsijGde.js");
