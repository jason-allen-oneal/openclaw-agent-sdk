...
import { a as installOpenClawInternalCorePackageNativeResolver } from "./plugin-module-loader-cache-lz0qhu-X.js";
import { n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-ZgondhPg.js";
import "./defaults-mDjiWzE5.js";
import { s as resolveThinkingDefaultForModel } from "./thinking-CG8AzHpQ.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-BP-mcH2j.js";
import "./transcript-jsonl-CD0KPCG0.js";
import { a as resetOAuthProviders, i as registerOAuthProvider, n as getOAuthProvider, r as getOAuthProviders, t as getOAuthApiKey } from "./oauth-9kOQ0U_n.js";
import { t as resolveModelPluginMetadataSnapshot } from "./model-discovery-context-D817n1Tu.js";
...
import { d as getSupportedThinkingLevels, f as modelsAreEqual, u as clampThinkingLevel } from "./sanitize-unicode-CgzZKr22.js";
import { a as resetApiProviders, c as registerApiProvider, i as streamSimple } from "./stream-4o8pRyto.js";
...
import { A as parseCommandArgs, B as estimateTokens, F as prepareBranchEntries, G as prepareCompaction$1, H as findTurnStartIndex, I as DEFAULT_COMPACTION_SETTINGS, K as shouldCompact, L as calculateContextTokens, N as collectEntriesForBranchSummaryFromBranches, P as generateBranchSummary$1, R as compact$1, U as generateSummary$1, V as findCutPoint, W as getLastAssistantUsage, a as DEFAULT_MAX_LINES, c as truncateHead, i as DEFAULT_MAX_BYTES, j as substituteArgs, l as truncateLine, nt as convertToLlm, q as serializeConversation, s as formatSize, u as truncateTail, z as estimateContextTokens } from "./proxy-BR8vW50h.js";
import { t as llm_exports } from "./llm-Dcf0lsrN.js";
import { a as getLatestCompactionEntry, c as parseSessionEntries, d as runtime_exports, i as getDefaultSessionDir, l as Agent, n as buildSessionContext, o as loadEntriesFromFile, r as findMostRecentSession, s as migrateSessionEntries, t as SessionManager, u as openClawAgentCoreRuntime } from "./session-manager-g-7X6v2O.js";
...
import { a as resolveMediaReferenceLocalPath, n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-C05KIYAZ.js";
import { l as isImageProcessorUnavailableError, o as createImageProcessor } from "./image-ops-PfTOpg74.js";
import { r as formatSkillsForPrompt$1, t as computeSkillPromptVersion } from "./skill-version-D_X6tTQz.js";
	...
	return { exec: (command, cwd, { onData, signal, timeout, env }) => {
		return new Promise((resolve, reject) => {
			...
			waitForChildProcess(child).then((code) => {
				...
				if (timeoutHandle) clearTimeout(timeoutHandle);
				if (signal) signal.removeEventListener("abort", onAbort);
				reject(toLintErrorObject$2(err, "Non-Error rejection"));
			});
		});
	} };
}
			...
			return new Promise((resolve, reject) => {
				...
				(async () => {
					try {
						...
						signal?.removeEventListener("abort", onAbort);
						reject(toLintErrorObject$1(e, "Non-Error rejection"));
					}
				})();
			});
		},
			...
			return new Promise((resolve, reject) => {
				...
				(async () => {
					try {
						...
						signal?.removeEventListener("abort", onAbort);
						if (!aborted) reject(toLintErrorObject(error, "Non-Error rejection"));
					}
				})();
			});
		},
...
//#endregion
export { createBashToolDefinition as $, allToolNames as A, createWriteToolDefinition as B, isEditToolResult as C, InMemoryAuthStorageBackend as Ct, isReadToolResult as D, isLsToolResult as E, createReadOnlyToolDefinitions as F, createGrepTool as G, createReadToolDefinition as H, createReadOnlyTools as I, createFindToolDefinition as J, createGrepToolDefinition as K, createTool as L, createAllTools as M, createCodingToolDefinitions as N, isToolCallEventType as O, createCodingTools as P, createBashTool as Q, createToolDefinition as R, isBashToolResult as S, FileAuthStorageBackend as St, isGrepToolResult as T, executeBashWithOperations as Tt, createLsTool as U, createReadTool as V, createLsToolDefinition as W, createEditToolDefinition as X, createEditTool as Y, withFileMutationQueue as Z, loadExtensionFromFactory as _, generateSummary as _t, createAgentSessionServices as a, InMemorySettingsStorage as at, wrapRegisteredTools as b, generateBranchSummary as bt, loadProjectContextFiles as c, findExactModelReferenceMatch as ct, formatSkillsForPrompt as d, resolveCliModel as dt, createLocalBashOperations as et, loadSkills as f, resolveModelScope as ft, discoverAndLoadExtensions as g, compact as gt, createExtensionRuntime as h, clearApiKeyCache as ht, createAgentSessionFromServices as i, FileSettingsStorage as it, createAllToolDefinitions as j, isWriteToolResult as k, AgentSession as l, findInitialModel as lt, ExtensionRunner as m, ModelRegistry as mt, SessionImportFileNotFoundError as n, createSourceInfo as nt, createAgentSession as o, SettingsManager as ot, loadSkillsFromDir as p, restoreModelFromSession as pt, createFindTool as q, createAgentSessionRuntime as r, createSyntheticSourceInfo as rt, DefaultResourceLoader as s, DefaultPackageManager as st, AgentSessionRuntime as t, wrapToolDefinition as tt, parseSkillBlock as u, parseModelPattern as ut, loadExtensions as v, prepareCompaction as vt, isFindToolResult as w, createEventBus as wt, defineTool as x, AuthStorage as xt, wrapRegisteredTool as y, collectEntriesForBranchSummary as yt, createWriteTool as z };
