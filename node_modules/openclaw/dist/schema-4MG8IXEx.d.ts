...
declare const SkillsProposalRequestRevisionResultSchema: Type.TObject<{
  runId: Type.TString;
  status: Type.TUnion<[Type.TLiteral<"started">, Type.TLiteral<"in_flight">, Type.TLiteral<"ok">]>;
}>;
...
declare const ProtocolSchemas: {
  ...
  SkillsProposalRequestRevisionResult: import("typebox").TObject<{
    runId: import("typebox").TString;
    status: import("typebox").TUnion<[import("typebox").TLiteral<"started">, import("typebox").TLiteral<"in_flight">, import("typebox").TLiteral<"ok">]>;
  }>;
...
//#endregion
export { NodePairApproveParamsSchema as $, TalkClientCreateResultSchema as $a, TickEvent as $i, ExecApprovalGetParams as $n, SkillsProposalRequestRevisionParamsSchema as $o, SkillsProposalInspectResult as $r, AgentsFilesListParams as $t, SessionsDeleteParamsSchema as A, CronStatusParamsSchema as Aa, TalkModeParams as Ai, ConfigSetParams as An, AgentsDeleteParamsSchema as Ao, RequestFrame as Ar, ExecApprovalResolveParamsSchema as At, PushTestParamsSchema as B, UpdateRunParamsSchema as Ba, TalkSessionSteerParams as Bi, CronStatusParams as Bn, AgentsListResultSchema as Bo, SessionsResetParams as Br, errorShape as Bt, SessionsCleanupParamsSchema as C, CronAddParamsSchema as Ca, TalkClientCreateParams as Ci, CommandsListParams as Cn, ArtifactSummarySchema as Co, NodePendingEnqueueResult as Cr, MessageActionParamsSchema as Cs, HelloOkSchema as Ct, SessionsCompactionListParamsSchema as D, CronRemoveParamsSchema as Da, TalkClientToolCallResult as Di, ConfigPatchParams as Dn, AgentSummarySchema as Do, PluginsSessionActionResult as Dr, TickEventSchema as Dt, SessionsCompactionGetParamsSchema as E, CronListParamsSchema as Ea, TalkClientToolCallParams as Ei, ConfigGetParams as En, ArtifactsListParamsSchema as Eo, PluginsSessionActionParams as Er, WakeParamsSchema as Es, ShutdownEventSchema as Et, SessionsPreviewParamsSchema as F, ConfigSchemaLookupParamsSchema as Fa, TalkSessionCreateParams as Fi, CronListParams as Fn, AgentsFilesListParamsSchema as Fo, SessionsDeleteParams as Fr, EnvironmentsListParamsSchema as Ft, WebPushTestParamsSchema as G, ChannelsStartParamsSchema as Ga, TalkSpeakResult as Gi, EnvironmentStatus as Gn, SkillsDetailResultSchema as Go, SkillsBinsResult as Gr, AgentWaitParams as Gt, WebPushSubscribeParams as H, CommandsListParamsSchema as Ha, TalkSessionTurnParams as Hi, DevicePairApproveParams as Hn, AgentsUpdateResultSchema as Ho, SessionsUsageParams as Hr, AgentIdentityParams as Ht, SessionsResetParamsSchema as I, ConfigSchemaLookupResultSchema as Ia, TalkSessionCreateResult as Ii, CronRemoveParams as In, AgentsFilesListResultSchema as Io, SessionsDescribeParams as Ir, EnvironmentsListResultSchema as It, WebPushVapidPublicKeyParams as J, ChannelsStopParamsSchema as Ja, TasksCancelResult as Ji, EnvironmentsListResult as Jn, SkillsProposalApplyResultSchema as Jo, SkillsInstallParams as Jr, AgentsDeleteParams as Jt, WebPushUnsubscribeParams as K, ChannelsStatusParamsSchema as Ka, TaskSummary as Ki, EnvironmentSummary as Kn, SkillsInstallParamsSchema as Ko, SkillsDetailParams as Kr, AgentsCreateParams as Kt, SessionsResolveParamsSchema as L, ConfigSchemaParamsSchema as La, TalkSessionJoinParams as Li, CronRunLogEntry as Ln, AgentsFilesSetParamsSchema as Lo, SessionsListParams as Lr, EnvironmentsStatusParamsSchema as Lt, SessionsListParamsSchema as M, ConfigApplyParamsSchema as Ma, TalkSessionCancelOutputParams as Mi, CronAddParams as Mn, AgentsFileEntrySchema as Mo, SessionOperationEvent as Mr, ExecApprovalsSetParamsSchema as Mt, SessionsPatchParamsSchema as N, ConfigGetParamsSchema as Na, TalkSessionCancelTurnParams as Ni, CronGetParams as Nn, AgentsFilesGetParamsSchema as No, SessionsCleanupParams as Nr, EnvironmentStatusSchema as Nt, SessionsCompactionRestoreParamsSchema as O, CronRunParamsSchema as Oa, TalkConfigParams as Oi, ConfigSchemaParams as On, AgentsCreateParamsSchema as Oo, PollParams as Or, ExecApprovalGetParamsSchema as Ot, SessionsPluginPatchParamsSchema as P, ConfigPatchParamsSchema as Pa, TalkSessionCloseParams as Pi, CronJob as Pn, AgentsFilesGetResultSchema as Po, SessionsCompactParams as Pr, EnvironmentSummarySchema as Pt, NodeListParamsSchema as Q, TalkClientCreateParamsSchema as Qa, TasksListResult as Qi, EventFrame as Qn, SkillsProposalRecordResultSchema as Qo, SkillsProposalInspectParams as Qr, AgentsFilesGetResult as Qt, SessionsSendParamsSchema as R, ConfigSchemaResponseSchema as Ra, TalkSessionJoinResult as Ri, CronRunParams as Rn, AgentsFilesSetResultSchema as Ro, SessionsPatchParams as Rr, EnvironmentsStatusResultSchema as Rt, SessionsAbortParamsSchema as S, PROTOCOL_VERSION as Sa, TalkCatalogResult as Si, CommandEntry as Sn, WebLoginWaitParamsSchema as So, NodePendingEnqueueParams as Sr, AgentParamsSchema as Ss, GatewayFrameSchema as St, SessionsCompactionBranchParamsSchema as T, CronJobSchema as Ta, TalkClientSteerParams as Ti, ConfigApplyParams as Tn, ArtifactsGetParamsSchema as To, NodePresenceAliveReason as Tr, SendParamsSchema as Ts, ResponseFrameSchema as Tt, WebPushSubscribeParamsSchema as U, CommandsListResultSchema as Ua, TalkSessionTurnResult as Ui, DevicePairListParams as Un, ModelsListParamsSchema as Uo, ShutdownEvent as Ur, AgentIdentityResult as Ut, PushTestResultSchema as V, UpdateStatusParamsSchema as Va, TalkSessionSubmitToolResultParams as Vi, CronUpdateParams as Vn, AgentsUpdateParamsSchema as Vo, SessionsResolveParams as Vr, AgentEvent as Vt, WebPushTestParams as W, ChannelsLogoutParamsSchema as Wa, TalkSpeakParams as Wi, DevicePairRejectParams as Wn, SkillsDetailParamsSchema as Wo, SkillsBinsParams as Wr, AgentSummary as Wt, NodeEventResultSchema as X, TalkCatalogParamsSchema as Xa, TasksGetResult as Xi, EnvironmentsStatusResult as Xn, SkillsProposalInspectParamsSchema as Xo, SkillsProposalApplyResult as Xr, AgentsFileEntry as Xt, WebPushVapidPublicKeyParamsSchema as Y, TalkAgentControlResultSchema as Ya, TasksGetParams as Yi, EnvironmentsStatusParams as Yn, SkillsProposalCreateParamsSchema as Yo, SkillsProposalActionParams as Yr, AgentsDeleteResult as Yt, NodeInvokeParamsSchema as Z, TalkCatalogResultSchema as Za, TasksListParams as Zi, ErrorShape as Zn, SkillsProposalInspectResultSchema as Zo, SkillsProposalCreateParams as Zr, AgentsFilesGetParams as Zt, TasksListParamsSchema as _, WizardStatusResult as _a, SkillsUploadCommitParams as _i, ChannelsStatusResult as _n, TalkSessionTurnParamsSchema as _o, NodePairRemoveParams as _r, ToolsEffectiveParamsSchema as _s, LogsTailParamsSchema as _t, WizardStartResultSchema as a, ToolsInvokeResult as aa, SkillsProposalsListParams as ai, AgentsUpdateParams as an, TalkEventSchema as ao, GatewayFrame as ar, SkillsSearchParamsSchema as as, NodePendingAckParamsSchema as at, SnapshotSchema as b, MIN_CLIENT_PROTOCOL_VERSION as ba, TalkAgentControlResult as bi, ChatInjectParams as bn, TalkSpeakResultSchema as bo, NodePendingDrainParams as br, AgentIdentityParamsSchema as bs, ErrorShapeSchema as bt, WizardStepSchema as c, WakeParams as ca, SkillsSearchResult as ci, ArtifactsDownloadParams as cn, TalkSessionCancelTurnParamsSchema as co, LogsTailResult as cr, SkillsSecurityVerdictsResultSchema as cs, NodePendingEnqueueParamsSchema as ct, PluginsUiDescriptorsParamsSchema as d, WizardCancelParams as da, SkillsSkillCardParams as di, ArtifactsGetResult as dn, TalkSessionCreateResultSchema as do, NodeInvokeParams as dr, SkillsStatusParamsSchema as ds, NodePresenceAliveReasonSchema as dt, ToolsCatalogParams as ea, SkillsProposalRecordResult as ei, AgentsFilesListResult as en, TalkClientSteerParamsSchema as eo, ExecApprovalRequestParams as er, SkillsProposalRequestRevisionResultSchema as es, NodePairListParamsSchema as et, TaskSummarySchema as f, WizardNextParams as fa, SkillsSkillCardResult as fi, ArtifactsListParams as fn, TalkSessionJoinParamsSchema as fo, NodeInvokeResultParams as fr, SkillsUpdateParamsSchema as fs, ChatEventSchema as ft, TasksGetResultSchema as g, WizardStatusParams as ga, SkillsUploadChunkParams as gi, ChannelsStatusParams as gn, TalkSessionSubmitToolResultParamsSchema as go, NodePairRejectParams as gr, ToolsCatalogParamsSchema as gs, ChatSendParamsSchema as gt, TasksGetParamsSchema as h, WizardStartResult as ha, SkillsUploadBeginParams as hi, ChannelsStartParams as hn, TalkSessionSteerParamsSchema as ho, NodePairListParams as hr, SkillsUploadCommitParamsSchema as hs, ChatMetadataParamsSchema as ht, WizardStartParamsSchema as i, ToolsInvokeParams as ia, SkillsProposalUpdateParams as ii, AgentsListResult as in, TalkConfigResultSchema as io, ExecApprovalsSnapshot as ir, SkillsProposalsListResultSchema as is, NodePairVerifyParamsSchema as it, SessionsDescribeParamsSchema as j, CronUpdateParamsSchema as ja, TalkSessionAppendAudioParams as ji, ConnectParams as jn, AgentsDeleteResultSchema as jo, ResponseFrame as jr, ExecApprovalsGetParamsSchema as jt, SessionsCreateParamsSchema as k, CronRunsParamsSchema as ka, TalkConfigResult as ki, ConfigSchemaResponse as kn, AgentsCreateResultSchema as ko, PresenceEntry as kr, ExecApprovalRequestParamsSchema as kt, PluginsSessionActionParamsSchema as l, WebLoginStartParams as la, SkillsSecurityVerdictsParams as li, ArtifactsDownloadResult as ln, TalkSessionCloseParamsSchema as lo, NodeEventParams as lr, SkillsSkillCardParamsSchema as ls, NodePendingEnqueueResultSchema as lt, TasksCancelResultSchema as m, WizardStartParams as ma, SkillsUpdateParams as mi, ChannelsLogoutParams as mn, TalkSessionOkResultSchema as mo, NodePairApproveParams as mr, SkillsUploadChunkParamsSchema as ms, ChatInjectParamsSchema as mt, WizardNextParamsSchema as n, ToolsEffectiveParams as na, SkillsProposalRequestRevisionResult as ni, AgentsFilesSetResult as nn, TalkClientToolCallResultSchema as no, ExecApprovalsGetParams as nr, SkillsProposalUpdateParamsSchema as ns, NodePairRemoveParamsSchema as nt, WizardStatusParamsSchema as o, UpdateRunParams as oa, SkillsProposalsListResult as oi, AgentsUpdateResult as on, TalkSessionAppendAudioParamsSchema as oo, HelloOk as or, SkillsSearchResultSchema as os, NodePendingDrainParamsSchema as ot, TasksCancelParamsSchema as p, WizardNextResult as pa, SkillsStatusParams as pi, ArtifactsListResult as pn, TalkSessionJoinResultSchema as po, NodeListParams as pr, SkillsUploadBeginParamsSchema as ps, ChatHistoryParamsSchema as pt, WebPushUnsubscribeParamsSchema as q, ChannelsStatusResultSchema as qa, TasksCancelParams as qi, EnvironmentsListParams as qn, SkillsProposalActionParamsSchema as qo, SkillsDetailResult as qr, AgentsCreateResult as qt, WizardNextResultSchema as r, ToolsEffectiveResult as ra, SkillsProposalReviseParams as ri, AgentsListParams as rn, TalkConfigParamsSchema as ro, ExecApprovalsSetParams as rr, SkillsProposalsListParamsSchema as rs, NodePairRequestParamsSchema as rt, WizardStatusResultSchema as s, UpdateStatusParams as sa, SkillsSearchParams as si, ArtifactSummary as sn, TalkSessionCancelOutputParamsSchema as so, LogsTailParams as sr, SkillsSecurityVerdictsParamsSchema as ss, NodePendingDrainResultSchema as st, WizardCancelParamsSchema as t, ToolsCatalogResult as ta, SkillsProposalRequestRevisionParams as ti, AgentsFilesSetParams as tn, TalkClientToolCallParamsSchema as to, ExecApprovalResolveParams as tr, SkillsProposalReviseParamsSchema as ts, NodePairRejectParamsSchema as tt, PluginsSessionActionResultSchema as u, WebLoginWaitParams as ua, SkillsSecurityVerdictsResult as ui, ArtifactsGetParams as un, TalkSessionCreateParamsSchema as uo, NodeEventResult as ur, SkillsSkillCardResultSchema as us, NodePresenceAlivePayloadSchema as ut, TasksListResultSchema as v, WizardStep as va, Snapshot as vi, ChannelsStopParams as vn, TalkSessionTurnResultSchema as vo, NodePairRequestParams as vr, ToolsInvokeParamsSchema as vs, LogsTailResultSchema as vt, SessionsCompactParamsSchema as w, CronGetParamsSchema as wa, TalkClientCreateResult as wi, CommandsListResult as wn, ArtifactsDownloadParamsSchema as wo, NodePresenceAlivePayload as wr, PollParamsSchema as ws, RequestFrameSchema as wt, StateVersionSchema as x, MIN_PROBE_PROTOCOL_VERSION as xa, TalkCatalogParams as xi, ChatMetadataParams as xn, WebLoginStartParamsSchema as xo, NodePendingDrainResult as xr, AgentIdentityResultSchema as xs, EventFrameSchema as xt, PresenceEntrySchema as y, ProtocolSchemas as ya, StateVersion as yi, ChatEvent as yn, TalkSpeakParamsSchema as yo, NodePairVerifyParams as yr, AgentEventSchema as ys, ConnectParamsSchema as yt, SessionsUsageParamsSchema as z, ConfigSetParamsSchema as za, TalkSessionOkResult as zi, CronRunsParams as zn, AgentsListParamsSchema as zo, SessionsPreviewParams as zr, ErrorCodes as zt };