...
import { G as resolveMemoryDeepDreamingConfig, K as resolveMemoryDreamingConfig, W as resolveMemoryCorePluginConfig } from "./dreaming-BqjvzsgF.js";
import { l as listMemoryCorpusSupplements } from "./memory-state-D1oMTUUg.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BldC7ibm.js";
import { b as readStringParam, g as readPositiveIntegerParam, l as jsonResult, p as readFiniteNumberParam, r as asToolParamsRecord } from "./common-CEBsSh4n.js";
import { r as optionalFiniteNumberSchema, s as stringEnum } from "./typebox-WC1TYVJz.js";
...
import { b as recordShortTermRecalls } from "./short-term-promotion-BUY0Bnvw.js";
...
function buildMemorySearchUnavailableResult(error, overrides) {
	...
	const warning = overrides?.warning ?? (isQuotaError ? "Memory search is unavailable because the embedding provider quota is exhausted." : "Memory search is unavailable due to an embedding/provider error.");
	const action = overrides?.action ?? (isQuotaError ? "Top up or switch embedding provider, then retry memory_search." : "Check embedding provider configuration and retry memory_search.");
	return {
		results: [],
		disabled: true,
		unavailable: true,
