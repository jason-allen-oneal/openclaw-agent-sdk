...
import { I as listTaskFlowRecords, m as listTasksForFlowId } from "./task-registry-kPLgAJMa.js";
...
import { i as buildPluginCompatibilityWarnings } from "./status-DL2DFkLO.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-xHzD4ZUN.js";
import { i as formatLegacyWorkspaceWarning, n as detectLegacyWorkspaceDirs } from "./doctor-workspace-Bmk5SfSL.js";
...
function notePluginVersionDrift(drift) {
	...
	note([
		...
		singleDrift ? `Fix: ${formatCliCommand(`openclaw plugins update ${singleDrift.pluginId}`)} && ${formatCliCommand("openclaw gateway restart")}.` : `Fix: ${formatCliCommand("openclaw plugins update <plugin-id>")} for each drifted plugin, then ${formatCliCommand("openclaw gateway restart")}.`
