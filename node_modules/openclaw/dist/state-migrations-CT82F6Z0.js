...
import { _ as resolveOAuthDir, g as resolveNewStateDir, h as resolveLegacyStateDirs, y as resolveStateDir } from "./paths-mvMm5bYV.js";
...
import { a as repairOpenClawStateDatabaseSchema, d as executeSqliteQuerySync, f as executeSqliteQueryTakeFirstSync, o as runOpenClawStateWriteTransaction, p as getNodeSqliteKysely, r as detectOpenClawStateDatabaseSchemaMigrations } from "./openclaw-state-db-J6qYHGxK.js";
import { n as requireNodeSqlite } from "./sqlite-wal-DqkFpj0C.js";
import { c as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-fA-EQXn-.js";
import "./agent-scope-B4NxGkqZ.js";
import { c as parseAgentSessionKey, o as normalizeSessionKeyPreservingOpaquePeerIds } from "./session-key-utils-Bx3apsJ3.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, n as DEFAULT_MAIN_KEY, t as DEFAULT_AGENT_ID, u as normalizeAgentId } from "./session-key-B_NoIfpX.js";
import { c as resolveDefaultAgentId } from "./agent-scope-config-DNJywrQV.js";
import "./installed-plugin-index-QoVlhjjs.js";
import { c as writePersistedInstalledPluginIndexSync, i as readPersistedInstalledPluginIndexSync, n as parseInstalledPluginIndex } from "./installed-plugin-index-store-Cw5ijacD.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { c as listBundledChannelLegacySessionSurfaces, l as listBundledChannelLegacyStateMigrationDetectors } from "./bundled-C8rQ5-HL.js";
import { i as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, n as createPluginStateKeyedStore, o as countPluginStateLiveEntries } from "./plugin-state-store-CP8nXkMo.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-Eahn-btj.js";
import { l as saveSessionStore } from "./store-Dcn5FSKd.js";
import { r as resolveAllAgentSessionStoreTargetsSync } from "./targets-CSMJMfNO.js";
import "./sessions-DieR2Eem.js";
import { s as writeAcpSessionMetaForMigration } from "./session-meta-DM0X1_Qg.js";
import { o as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-YIjHpfEl.js";
...
function canonicalizeSessionKeyForAgent(params) {
	...
	if (rawLower.startsWith("agent:")) return normalized;
...
async function runPluginDoctorStateMigrationPlans(params) {
	...
	const plans = refreshedPlans.length > 0 ? refreshedPlans : params.detected.pluginPlans?.plans ?? [];
...
async function autoMigrateLegacyAgentDir(params) {
...
async function migrateLegacyAcpSessionMetadata(params) {
	...
	const mainKey = normalizeMainKey(params.cfg.session?.mainKey);
	const scope = params.cfg.session?.scope;
	const seenStorePaths = /* @__PURE__ */ new Set();
	for (const target of targets) {
		const storePath = target.storePath;
		if (seenStorePaths.has(storePath) || !fileExists(storePath)) continue;
...
async function autoMigrateLegacyState(params) {
	...
	if (!detected.sessions.hasLegacy && !detected.agentDir.hasLegacy && !detected.channelPlans.hasLegacy && !detected.pluginPlans?.hasLegacy && !detected.pluginStateSidecar.hasLegacy && !detected.pluginInstallIndex.hasLegacy && !detected.stateSchema.hasLegacy && !detected.taskStateSidecars.hasLegacy && !detected.deliveryQueues.hasLegacy && !detected.execApprovals.hasLegacy) {
		const changes = [
			...stateDirResult.changes,
			...stateSchema.changes,
			...orphanKeys.changes,
...
//#endregion
export { detectLegacyStateMigrations as a, resetAutoMigrateLegacyAgentDirForTest as c, resetAutoMigrateLegacyTaskStateSidecarsForTest as d, runLegacyStateMigrations as f, autoMigrateLegacyTaskStateSidecars as i, resetAutoMigrateLegacyStateDirForTest as l, autoMigrateLegacyState as n, migrateLegacyAgentDir as o, autoMigrateLegacyStateDir as r, migrateOrphanedSessionKeys as s, autoMigrateLegacyAgentDir as t, resetAutoMigrateLegacyStateForTest as u };
