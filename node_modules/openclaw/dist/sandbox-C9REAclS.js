...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-ITGG66tx.js";
import "./config-BqCwA_DI.js";
import { f as isSameSsrFPolicy } from "./ssrf-CvPEXMGn.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-DAj1Euvz.js";
import { c as DEFAULT_USER_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-C9ULOsP_.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, w as SANDBOX_STATE_DIR, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-CPdgpBDI.js";
import { n as isToolAllowed } from "./tool-policy-CT4OxsE8.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-DNVDYYhP.js";
...
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BodDCYrZ.js";
import { A as removeBrowserRegistryEntry, C as resolveSandboxScopeKey, M as updateBrowserRegistry, N as updateRegistry, O as readBrowserRegistry, P as computeSandboxBrowserConfigHash, S as resolveSandboxAgentId, T as slugifySessionKey, _ as appendWorkspaceMountArgs, a as execDocker, b as resolveMaterializedSandboxSkillsWorkspaceDir, c as isDockerDaemonUnavailable, g as appendReadOnlyWorkspaceSkillMountArgs, j as removeRegistryEntry, k as readRegistry, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as formatReadOnlyWorkspaceSkillMountHashState, w as resolveSandboxWorkspaceDir, x as resolveReadOnlyWorkspaceSkillMounts } from "./docker-CzdoQt3S.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-CiOAE1W1.js";
import { A as runDockerSandboxShellCommand, D as buildPinnedRenamePlan, E as buildPinnedRemovePlan, O as buildPinnedWritePlan, T as buildPinnedMkdirpPlan, a as getSandboxBackendManager, b as parseSandboxStatMtimeMs, c as requireSandboxBackendFactory, k as dockerSandboxBackendManager, n as startBrowserBridgeServer, o as getSandboxBackendWorkdirResolver, r as stopBrowserBridgeServer, t as BROWSER_BRIDGES, x as parseSandboxStatSize } from "./browser-bridges-deLjElqf.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
			import("./workspace-kc-Nv_5P.js"),
			import("./remote-CVmmkDkI.js"),
			import("./exec-defaults-BVZXhfD0.js")
		]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-x_MtxfDr.js")).maybePruneSandboxes(cfg);
