...
import { D as listConfiguredAnnounceChannelIdsForConfig } from "./gateway-startup-plugin-ids-mVzqhEQT.js";
...
import { i as resolveCronDeliverySessionKey, n as isInvalidCronSessionTargetIdError } from "./session-target-DNkvuLUI.js";
import { i as readCronRunLogEntriesPageAll, n as isInvalidCronRunLogJobIdError, r as readCronRunLogEntriesPage } from "./run-log-CqgODgsg.js";
...
import { a as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-CRg0zxa4.js";
import { in as errorShape, rn as ErrorCodes } from "./schema-BwaBORnA.js";
import { B as validateCronRunParams, H as validateCronStatusParams, I as validateCronAddParams, L as validateCronGetParams, R as validateCronListParams, U as validateCronUpdateParams, V as validateCronRunsParams, rr as validateWakeParams, t as formatValidationErrors, z as validateCronRemoveParams } from "./src-oj0IwW6K.js";
import { n as resolveCronDeliveryPlan, t as hasExplicitCronDeliveryTarget } from "./delivery-plan-DKOqLu02.js";
import { n as applyJobPatch, y as resolveDeliveryTarget } from "./jobs-BeLaoJgl.js";
...
function assertValidCronUpdatePatch(params) {
	...
	if ("delivery" in params.patch) assertValidCronAnnounceDelivery({
		cfg: params.cfg,
...
const cronHandlers = {
	...
	"cron.runs": async ({ params, respond, context }) => {
		...
		try {
			const matchedJob = (await context.cron.list({ includeDisabled: true })).find((job) => job.id === jobId);
