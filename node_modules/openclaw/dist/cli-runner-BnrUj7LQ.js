...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Quvi-RcW.js";
import { b as withAgentRunLifecycleGeneration, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-C3fRM85v.js";
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-NdJkeRhp.js";
import { t as SessionManager } from "./session-manager-g-7X6v2O.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-U6o7_k27.js";
import { _ as isFailoverErrorMessage, r as classifyFailoverReason } from "./errors-B4mplIiL.js";
import { d as resolveFailoverStatus, o as isFailoverError, t as FailoverError } from "./failover-error-CC108ogz.js";
...
import { n as runAgentEndSideEffects, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-Bdguwwf-.js";
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-CLsHmY5H.js";
import { i as buildUsageWithNoCost, n as buildAssistantMessage } from "./stream-message-shared-CdbBqwfX.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-TJVPBHTV.js";
import { t as buildEmbeddedRunPayloads } from "./payloads-BzbxMAeK.js";
...
import { d as loadCliSessionHistoryMessages, m as buildAgentHookConversationMessages, n as claudeCliSessionTranscriptHasContent, u as loadCliSessionContextEngineMessages } from "./attempt-execution.helpers-C-WoYUdp.js";
...
async function runCliAgentInternal(params) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DFS-tE1W.js");
