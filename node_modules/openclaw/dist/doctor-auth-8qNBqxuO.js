...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, s as resolveDefaultAgentDir } from "./agent-scope-config-DNJywrQV.js";
import { n as ensureAuthProfileStore } from "./store-jnx0nhpN.js";
import { n as hasLocalAuthProfileStoreSource, t as hasAnyAuthProfileStoreSource } from "./source-check-pAgmwAAa.js";
import "./auth-profiles-BeBRJlFs.js";
import { i as formatAuthDoctorHint, n as resolveApiKeyForProfile } from "./oauth-B-N4W-ZD.js";
import { n as buildOAuthRefreshFailureLoginCommand, r as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-DNxwJzrt.js";
...
function formatOAuthRefreshFailureDoctorLine(params) {
	...
	const command = buildOAuthRefreshFailureLoginCommand(rawProvider ? DOCTOR_REAUTH_PROVIDER_ALIASES[rawProvider] ?? rawProvider : null);
