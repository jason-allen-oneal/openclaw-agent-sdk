...
import { x as resolveChannelStreamingBlockCoalesce } from "./streaming-BRnqIMS-.js";
...
function resolveScopedBlockStreamingCoalesce(config) {
	return config ? resolveChannelStreamingBlockCoalesce(config) ?? config.blockStreamingCoalesce : void 0;
}
