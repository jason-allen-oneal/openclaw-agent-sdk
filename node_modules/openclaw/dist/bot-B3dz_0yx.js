...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-CbY2H91D.js";
...
import { r as getChildLogger } from "./logger-563BnNMV.js";
import { t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { n as normalizeAccountId } from "./account-id-Df9e41E6.js";
import { h as sanitizeAgentId, i as buildAgentMainSessionKey, m as resolveThreadSessionKeys } from "./session-key-B_NoIfpX.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DNJywrQV.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-DbTJQTMp.js";
import { i as getRuntimeConfig } from "./io-fQmSDfK-.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-D93_HOsR.js";
import { n as mutateConfigFile } from "./config-BqCwA_DI.js";
import { a as getReplyPayloadTtsSupplement, n as buildTtsSupplementMediaPayload, o as isReplyPayloadNonTerminalToolErrorWarning } from "./reply-payload-CZJ2cgZc.js";
import { u as fireAndForgetHook } from "./hook-runner-global-Quvi-RcW.js";
import { t as createDedupeCache } from "./dedupe-DnzL4okR.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-zwWPrwO1.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-NEwU8m3X.js";
import { V as resolveSessionStoreEntry } from "./store-load-BEkoRRyW.js";
import { d as updateSessionStore, f as updateSessionStoreEntry } from "./store-Dcn5FSKd.js";
import { d as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-NdJkeRhp.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DTn-thXR.js";
import { x as findModelInCatalog } from "./model-selection-shared-By-X2JmI.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-DxcHqA8K.js";
import { c as resolveDefaultModelForAgent } from "./model-selection-CRIOhEQm.js";
import { i as modelSupportsVision, n as loadModelCatalog } from "./model-catalog-D05d2kfO.js";
import { i as isExplicitCommandTurn } from "./command-turn-context-YXLLZVCi.js";
import { n as listChatCommands } from "./commands-registry-list-0qbxeqMZ.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-Bl6V2_lJ.js";
import { n as isAbortRequestText } from "./abort-primitives-CO2vrvx5.js";
import { t as hasControlCommand } from "./command-detection-CsNN0omj.js";
import { d as stripReasoningTagsFromText, g as isInsideCode, h as findCodeRegions } from "./assistant-visible-text-QdHceFYu.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-S1yazmy1.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-Bhv9Hc00.js";
...
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-mRNooZFa.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BJyG0yy2.js";
import { n as firstDefined } from "./allow-from-Ddq5GeWG.js";
import { n as MediaFetchError } from "./fetch-VMXHQrmK.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-Cc0PVjtu.js";
import { t as resolveAckReaction } from "./identity-BZeCE1SF.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-tytC94t4.js";
import { A as resolveTranscriptBackedChannelFinalText, S as resolveChannelStreamingBlockEnabled, d as isPotentialTruncatedFinal, i as buildChannelProgressDraftLineForEntry, j as selectLongerFinalText, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry } from "./streaming-BRnqIMS-.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-1L_d2oHv.js";
import { a as projectOutboundPayloadPlanForDelivery, t as createOutboundPayloadPlan } from "./payloads-DwYjapHo.js";
import { n as createPreviewMessageReceipt } from "./live-DjttXqqq.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-lj5quus3.js";
import { s as formatReasoningMessage } from "./embedded-agent-utils-B9bm-8Xr.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-D5WaLvcp.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DimQZxaa.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Cl3t2MJo.js";
import "./error-runtime-BCoihXsU.js";
import "./media-runtime-DQNqxE2O.js";
import "./number-runtime-DBLVDypr.js";
import "./runtime-config-snapshot-DMApZpnf.js";
import "./runtime-env-Bz4-eUAK.js";
import "./security-runtime-DRoO_c6_.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-C5CaKMWO.js";
import "./string-coerce-runtime-CEGJWkQ_.js";
import "./text-chunking-BgBAa4-u.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-ARMiBhCK.js";
import { r as getPluginCommandSpecs } from "./command-specs-pmwqtDw3.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-ChZ74sL3.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-idTqAPpY.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-DGBUT5bc.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-B3wca__T.js";
import { c as isTelegramEditTargetMissingError, l as isTelegramMessageHasNoTextError } from "./request-timeouts-BU95nyTR.js";
import "./routing-CqTr30kc.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-IMcsY0tl.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-k9j7XKN1.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-D4-6N7fi.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-3P8aSD7o.js";
import "./history-9zD3DzPk.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-7SGHwgw1.js";
import { t as createChannelHistoryWindow } from "./history-window-CU_tFcsO.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-DVval8gI.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-CsSi7NMR.js";
import "./channel-policy-D1WUExii.js";
import "./reply-history-izHWRPFq.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-DOG9pE-q.js";
import "./approval-reply-runtime-B1kxxW-k.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-D4NM8ac1.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-BPJWFd0Q.js";
import "./config-mutation-0JltdIrm.js";
import { t as listSkillCommandsForAgents } from "./chat-commands-B6VZp21z.js";
import { n as isBtwRequestText } from "./btw-command-CSTFWTch.js";
import { t as generateConversationLabel } from "./conversation-label-generator-DwRAtNQs.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-qPEZ5Ae7.js";
import "./reply-chunking-rbCRuDMO.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-BGsd-GVn.js";
import { a as resolveChannelDraftStreamingChunking, c as createMessageReceiveContext, i as createChannelProgressDraftCompositor } from "./channel-outbound-C9Kf2zmk.js";
...
import "./model-session-runtime-DFa10cnB.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-Dh9tdq5l.js";
import "./conversation-runtime-CZ37Nuw1.js";
import "./agent-runtime-GsSfjDVv.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-BAJkmR0Z.js";
import "./agent-harness-runtime-BrQBfDKO.js";
import "./hook-runtime-gQPrAc-S.js";
import "./markdown-table-runtime-Bdft-YUK.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-B7B3XRMF.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-C-zj9Kp-.js";
import { n as formatModelsAvailableHeader } from "./commands-models-B1U-NB-2.js";
import "./command-auth-native-CBZk4ZDm.js";
import "./command-primitives-runtime-BpE8aRxj.js";
import "./command-status-CmQkSar-.js";
import "./command-detection-DeC_3Bpa.js";
import "./command-surface-8qOk5t9q.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-8XJ_gHwg.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-2_QV4FKD.js";
import "./channel-mention-gating-D-bAvPV1.js";
import { n as createChannelIngressResolver, o as defineStableChannelIngressIdentity } from "./message-access-CNP2VW4Q.js";
import "./channel-ingress-runtime-CizvW3Pn.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BRBxU9X-.js";
import { t as loadSessionStore } from "./session-store-runtime-B1z0AcSa.js";
import "./models-provider-runtime-CBUl8ROG.js";
import "./skill-commands-runtime-DKuWZH10.js";
import "./native-command-config-runtime-mtuAEotH.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-BEBZQKqS.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-Bx1v_uyt.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-7mPE3UH5.js";
import { $ as isSenderAllowed, A as resolveTelegramCommandAuthorization, B as withResolvedTelegramForumFlag, C as buildTypingThreadParams, D as loadTelegramPairingStoreIfNeeded, E as isTelegramCommandsAllowFromConfigured, F as resolveTelegramMessageForumFlagHint, G as hasBotMention, H as buildSenderName, I as resolveTelegramReplyId, J as renderTelegramTextEntities, L as resolveTelegramStreamMode, M as resolveTelegramForumFlag, N as resolveTelegramForumThreadId, P as resolveTelegramGroupAllowFromContext, Q as resolveTelegramDmAllow, R as resolveTelegramThreadSpec, S as buildTelegramThreadParams, T as extractTelegramForumFlag, U as extractTelegramLocation, V as buildSenderLabel, W as getTelegramTextParts, X as resolveTelegramPrimaryMedia, Z as expandTelegramAllowFromWithAccessGroups, _ as buildTelegramGroupFrom, b as buildTelegramParentPeer, c as buildTelegramConversationContext, et as normalizeAllowFrom, g as buildGroupLabel, h as TelegramPairingStoreReadError, i as recordSentMessage, j as resolveTelegramDirectPeerId, k as resolveTelegramBotHasTopicsEnabled, l as buildTelegramReplyChain, m as resolveTelegramMessageCacheScope, nt as resolveTelegramEffectiveDmPolicy, q as normalizeForwardedContext, tt as normalizeDmAllowFromWithStore, u as createTelegramMessageCache, v as buildTelegramGroupPeerId, w as describeReplyTarget, x as buildTelegramRoutingTarget, y as buildTelegramInboundOriginTarget, z as shouldUseTelegramDmThreadSession } from "./sent-message-cache-BWgrpGJe.js";
...
import { t as resolveTelegramInlineButtons } from "./button-types-FkrHE_cM.js";
import { n as buildTelegramRichMarkdown, o as splitTelegramRichMarkdownChunks, p as renderTelegramHtmlText, t as TELEGRAM_RICH_TEXT_LIMIT } from "./rich-message-BouId6gu.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-DgGITsTC.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CnxQsFly.js";
import { c as commitTelegramMessageDispatchReplay, f as releaseTelegramMessageDispatchReplay, l as createTelegramMessageDispatchReplayGuard, s as claimTelegramMessageDispatchReplay, u as forgetTelegramMessageDispatchReplay } from "./message-dispatch-dedupe-HhjMCgqS.js";
import { r as cacheSticker } from "./sticker-cache-store-BPR5__7g.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-KQoauhCz.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-C7HdiXmc.js";
import { t as describeStickerImage } from "./sticker-cache-Cdaovq39.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-ByMFZgTB.js";
import { A as apiThrottler, C as resolveTelegramClientTimeoutMinimumSeconds, D as withTelegramApiErrorLogging, O as getOrCreateAccountThrottler, S as createTelegramClientFetch, T as resolveTelegramOutboundClientTimeoutFloorSeconds, a as editMessageTelegram, b as buildInlineKeyboard, j as sequentialize, k as Bot, w as resolveTelegramClientTimeoutSeconds, x as asTelegramClientFetch, y as recordOutboundMessageForPromptContext } from "./send-DsQJjhVA.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CNR-dgbp.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-B8dbBJ6r.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-ChlR386m.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-DBojihHZ.js");
...
function createFreshTelegramSessionStoreLoader(params) {
	const storesByPath = /* @__PURE__ */ new Map();
	const load = ((agentId) => {
...
async function mirrorTelegramAssistantReplyToTranscript(params) {
	...
	if (appended) {
		...
		await updateSessionStoreEntry({
			storePath,
			sessionKey: params.sessionKey,
			update: (current) => current.sessionId === sessionEntry.sessionId ? { updatedAt: transcriptMarkerUpdatedAt } : null
		});
	}
...
function buildRecoveredTelegramBody(params) {
	if (!params.context.isGroup || !params.historyKey || params.context.historyLimit <= 0) return params.currentMessage;
...
function migrateRecoveredTelegramRoomEventHistory(params) {
	...
	if (!params.context.isGroup || params.context.ctxPayload.InboundEventKind !== "room_event" || !originalHistoryKey || !recoveredHistoryKey || originalHistoryKey === recoveredHistoryKey || params.context.historyLimit <= 0) return;
...
function resolveDispatchTelegramContext(params) {
	...
	const recoveredInboundHistory = params.context.isGroup && recoveredHistoryKey && params.context.historyLimit > 0 ? createChannelHistoryWindow({ historyMap: params.context.groupHistories }).buildInboundHistory({
		historyKey: recoveredHistoryKey,
		limit: params.context.historyLimit
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts, retryDispatchErrors = false, suppressFailureFallback = false }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-CJDQyXmq.js")).defaultTelegramBotDeps;
	...
	const draftMaxChars = streamMode === "block" ? Math.min(resolveTelegramDraftStreamingChunking(cfg, route.accountId).maxChars, textLimit) : Math.min(textLimit, TELEGRAM_RICH_TEXT_LIMIT);
	...
	const pushStreamToolProgress = async (line, options) => {
		if (!answerLane.stream || answerLane.finalized || finalAnswerDeliveryStarted || finalAnswerDelivered) return false;
							...
							return telegramDeps.dispatchReplyWithBufferedBlockDispatcher({
								...
								dispatcherOptions: {
									...
									deliver: async (payload, info) => {
										...
										const isNonTerminalWarningAfterDeliveredFinal = isReplyPayloadNonTerminalToolErrorWarning(effectivePayload) && finalAnswerDelivered;
										...
										for (const segment of segments) {
											...
											if (segment.lane === "answer" && info.kind === "tool") {
												...
												if (streamMode === "progress" && answerLane.stream) continue;
												await prepareAnswerLaneForToolProgress();
											}
											const ownedByQueuedAnswerBlockRotation = queuedAnswerBlockRotations.some((entry) => queuedAnswerBlockRotationMatchesDelivery(entry, effectivePayload, info.assistantMessageIndex));
											...
											if (segment.lane === "answer" && info.kind === "block") {
												...
												if (takeQueuedAnswerBlockRotation(effectivePayload, info.assistantMessageIndex) && !preparedAnswerLane) {
													await rotateAnswerLaneForNewMessage();
													rotateAnswerLaneWhenQueuedBlocksSettle = false;
												}
												resetAnswerToolProgressDraft();
...
function createTelegramBotCore(opts) {
	...
	const textLimit = Math.min(resolveTextChunkLimit(cfg, "telegram", account.accountId, { fallbackLimit: TELEGRAM_RICH_TEXT_LIMIT }), TELEGRAM_RICH_TEXT_LIMIT);
