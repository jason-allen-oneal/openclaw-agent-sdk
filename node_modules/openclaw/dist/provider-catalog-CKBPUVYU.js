...
import { c as buildXaiCatalogModels, d as resolveXaiCatalogEntry, s as XAI_IMAGE_MODELS, t as XAI_BASE_URL } from "./model-definitions-whru6Ebx.js";
...
function buildXaiOauthModelFromLiveRow(row) {
	...
	const reasoning = readLiveModelBoolean(row, "supports_reasoning_effort") ?? readLiveModelBoolean(row, "supportsReasoningEffort") ?? fallback?.reasoning ?? false;
	return {
		id: modelId,
