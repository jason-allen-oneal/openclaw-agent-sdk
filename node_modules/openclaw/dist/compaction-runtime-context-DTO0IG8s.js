...
import { o as deriveSessionName } from "./bash-tools.shared-vmCOzjUM.js";
import { l as listRunningSessions } from "./bash-process-registry-DM8pBwCP.js";
...
function resolveEmbeddedCompactionTarget(params) {
	...
	if (slashIdx > 0) {
		...
		const authProfileId = overrideProvider !== (params.provider ?? "")?.trim() ? void 0 : params.authProfileId ?? void 0;
		return {
