...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-D42B4QyE.js";
...
import { a as rejectNodePairing, c as renamePairedNode, f as verifyNodeToken, i as listNodePairing, l as requestNodePairing, s as removePairedNode, t as approveNodePairing } from "./node-pairing-C8MBim3n.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-BEi9QZ6q.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CQtFV9Fn.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-B0N8Z4AB.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BGK1V4Wc.js";
import { l as listDevicePairing } from "./device-pairing-DuJscx_Y.js";
...
import { c as sendApnsBackgroundWake, d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as resolveApnsAuthConfigFromEnv, s as sendApnsAlert, t as clearApnsRegistrationIfCurrent } from "./push-apns-DrNpEPXe.js";
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-D7T6v-ww.js";
import { u as resolveApprovalRequestRecipientConnIds } from "./approval-shared-CaT5tE4t.js";
...
const nodeHandlers = {
	...
	"node.list": async ({ params, respond, client, context }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			...
			const nodes = listKnownNodes(createKnownNodeCatalog({
				...
				pendingNodes: canReadPendingNodePairing(client) ? nodePairing.pending : void 0,
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-D37UlaZF.js");
