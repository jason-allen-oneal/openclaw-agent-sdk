...
import { C as parseUsageCountedSessionIdFromFileName, S as parseSessionArchiveTimestamp, b as isUsageCountedSessionTranscriptFileName, h as isSessionArchiveArtifactName, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, m as isPrimarySessionTranscriptFileName } from "./paths-NEwU8m3X.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BI3m2RBP.js";
import { S as extractToolCallNames, T as stripMessageIdHints, w as stripEnvelope, x as countToolResults } from "./session-utils.fs-Y_TmTCGQ.js";
import { o as normalizeUsage } from "./usage-C67Kbb7n.js";
import { a as resolveModelCostConfigFingerprint, i as resolveModelCostConfig, t as estimateUsageCost } from "./usage-format-BPS8sDt6.js";
	...
	await scanTranscriptFile({
		...
		onEntry: (entry) => {
			...
			if (entry.role === "assistant") {
				...
				if (tsLocal !== void 0) {
					const latencyMs = entry.durationMs ?? (lastUserTimestamp !== void 0 ? Math.max(0, tsLocal - lastUserTimestamp) : void 0);
