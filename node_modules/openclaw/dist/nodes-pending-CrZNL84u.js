...
import { Ct as validateNodePendingEnqueueParams, St as validateNodePendingDrainParams } from "./src-oj0IwW6K.js";
import { r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BGK1V4Wc.js";
import { i as waitForNodeReconnect, n as maybeWakeNodeWithApns, t as maybeSendNodeWakeNudge } from "./nodes-D4jaD3vn.js";
...
function resolvePendingWorkExpiresAtMs(expiresInMs, nowMs) {
	...
	return resolveExpiresAtMsFromDurationMs(Math.max(1e3, Math.trunc(expiresInMs)), { nowMs }) ?? 0;
}
