...
import { S as freezeDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, v as createChildDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
...
import { _ as PluginApprovalResolutions } from "./command-registration-Ql0lsa-j.js";
import { h as getPluginSessionExtensionStateSync } from "./registry-B8gzOJBq.js";
...
import { i as listChannelPlugins, t as getChannelPlugin } from "./registry-BzNekEY8.js";
import "./plugins-CbDXysvw.js";
import { h as normalizeToolName } from "./tool-policy-BPywi0tl.js";
...
import { n as resolveSkillTelemetrySource, r as resolveSkillTelemetrySourceValue } from "./source-UVo0hlSr.js";
import { t as resolveSkillWorkshopConfig } from "./config-XlfFMqhc.js";
import { c as resolveMessageActionDiscoveryChannelId, l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext, s as resolveCurrentChannelMessageToolDiscoveryAdapter } from "./message-action-discovery-B0oSBWpB.js";
import { n as channelPluginHasNativeApprovalPromptUi, t as NATIVE_APPROVAL_PROMPT_RUNTIME_CAPABILITY } from "./native-approval-prompt--aFO2C3B.js";
...
function getTrustedToolPolicyDiagnosticEntries() {
...
function isAbortSignalCancellation(err, signal) {
	...
	return err instanceof Error && (err.name === "AbortError" || "cause" in err && err.cause === signal.reason);
}
...
//#endregion
export { resolveChannelMessageToolHints as A, normalizeCodeModeExecBeforeHookParams as C, listAllChannelSupportedActions as D, getChannelAgentToolMeta as E, resolveChannelReactionGuidance as M, listChannelAgentTools as O, markCodeModeControlTool as S, copyChannelAgentToolMeta as T, wrapToolWithBeforeToolCallHook as _, copyBeforeToolCallHookMarker as a, getCodeModeExecBeforeHookMetadata as b, isAbortSignalCancellation as c, recordAdjustedParamsForToolCall as d, requestDeferredPluginToolApproval as f, testing as g, setBeforeToolCallDiagnosticsEnabled as h, consumeAdjustedParamsForToolCall as i, resolveChannelPromptCapabilities as j, listChannelSupportedActions as k, isBeforeToolCallBlockedError as l, runBeforeToolCallHook as m, buildBlockedToolResult as n, getBeforeToolCallPolicyDiagnosticState as o, rewrapToolWithBeforeToolCallHook as p, cancelDeferredPluginToolApproval as r, hasBeforeToolCallPolicy as s, BeforeToolCallBlockedError as t, isToolWrappedWithBeforeToolCallHook as u, CODE_MODE_EXEC_TOOL_NAME as v, reconcileCodeModeExecBeforeHookParams as w, isCodeModeControlTool as x, CODE_MODE_WAIT_TOOL_NAME as y };
