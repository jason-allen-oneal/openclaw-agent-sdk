...
import { o as readLegacyNpmPluginDeclaration } from "./discovery-BUQqFET8.js";
...
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-DjR-Lha9.js";
import { a as resolveDefaultPluginNpmDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir, s as resolvePluginNpmPackageDir } from "./install-paths-D-sCLR1I.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-fA-EQXn-.js";
import { a as listOfficialExternalPluginCatalogEntries, c as resolveOfficialExternalPluginInstall, l as resolveOfficialExternalPluginLabel, r as getOfficialExternalPluginCatalogManifest, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-h7dZZiYs.js";
import { r as loadInstalledPluginIndex } from "./installed-plugin-index-QoVlhjjs.js";
import { i as listPotentialConfiguredChannelIds, r as listExplicitlyDisabledChannelIdsForConfig } from "./channel-env-var-names-BB2Lxcdw.js";
import { j as resolveConfiguredChannelPresencePolicy, t as collectConfiguredMemoryEmbeddingProviderIds } from "./gateway-startup-plugin-ids-mVzqhEQT.js";
import { r as resolveNpmInstallRecordSpec, t as buildNpmResolutionInstallFields } from "./installs-DnAWOI2f.js";
import { s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-BexO5-Vu.js";
import { n as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-ax1_DF9r.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BFetL3S9.js";
import "./channel-plugin-ids-Bilbiauk.js";
import { a as installPluginFromNpmSpec } from "./install-5B0zvvJg.js";
...
import { r as listRawChannelPluginCatalogEntries } from "./catalog-C-Hwf5GA.js";
...
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-r7CEfNGT.js";
import { n as updateNpmInstalledPlugins } from "./update-BuW2Ohdn.js";
import { n as collectConfiguredRuntimePluginIds, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-DDAkZu5L.js";
import { t as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-Dgdy7dRy.js";
import { c as shouldDeferConfiguredPluginInstallRepair, i as isLegacyPackageUpdateDoctorPass, o as isPostCoreConvergencePass } from "./update-phase-CvHbRkQp.js";
...
function addConfiguredMemoryEmbeddingProviderPluginIds(ids, cfg) {
	...
	for (const entry of listOfficialExternalPluginCatalogEntries()) {
		...
		if ([...manifest?.contracts?.embeddingProviders ?? [], ...manifest?.contracts?.memoryEmbeddingProviders ?? []].some((providerId) => {
