import { i as clearAgentRunContext, m as onAgentEvent } from "./agent-events-C3fRM85v.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const getAgentEventHandler = () => {
		agentEventHandlerPromise ??= Promise.all([import("./server-chat-DVXWYmKw.js"), import("./server-session-key-3s4OfOsr.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = () => {
		sessionEventsModulePromise ??= import("./server-session-events-TsYthLSk.js");
