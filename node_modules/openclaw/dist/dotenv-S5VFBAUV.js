...
import { t as loadGlobalRuntimeDotEnvFiles } from "./dotenv-global-DCtn7zs4.js";
...
function shouldBlockWorkspaceDotEnvKey(key, getProviderAuthBlockedKeys) {
	...
	return shouldBlockWorkspaceRuntimeDotEnvKey(upper) || BLOCKED_WORKSPACE_DOTENV_KEYS.has(upper) || BLOCKED_WORKSPACE_DOTENV_PREFIXES.some((prefix) => upper.startsWith(prefix)) || BLOCKED_WORKSPACE_DOTENV_SUFFIXES.some((suffix) => upper.endsWith(suffix)) || getProviderAuthBlockedKeys().has(upper);
}
