...
import { c as redactSensitiveText } from "./redact-DN0dJKIU.js";
...
import { a as loadCronStore, c as resolveCronStorePath, d as saveCronStore } from "./store-CGXhD-XE.js";
import { n as probeVideoDimensions } from "./media-services-DE3J1qM-.js";
...
import { g as isVoiceCompatibleAudio } from "./media-runtime-DQNqxE2O.js";
import { r as makeProxyFetch } from "./proxy-fetch-EsvqqU3h.js";
...
import { a as isRecoverableTelegramNetworkError, d as isTelegramMisdirectedRequestError, g as tagTelegramNetworkError, l as isTelegramMessageHasNoTextError, m as isTelegramServerError, o as isSafeToRetrySendError, p as isTelegramRateLimitError, r as resolveTelegramRequestTimeoutMs, u as isTelegramMessageNotModifiedError } from "./request-timeouts-BU95nyTR.js";
...
import "./cron-store-runtime-CHm2Nw60.js";
import "./reply-chunking-rbCRuDMO.js";
import "./web-media-B5J6WDKX.js";
import { n as createChannelApiRetryRunner } from "./retry-policy-CR7Nb3Oq.js";
...
import "./retry-runtime-DmLJU7CJ.js";
import { o as resolveTelegramAccount } from "./accounts-BEBZQKqS.js";
import { a as parseTelegramTarget, n as normalizeTelegramChatId, r as normalizeTelegramLookupTarget } from "./targets-CDtCx0Zi.js";
import { C as buildTypingThreadParams, S as buildTelegramThreadParams, i as recordSentMessage, m as resolveTelegramMessageCacheScope, rt as normalizeTelegramReplyToMessageId, u as createTelegramMessageCache } from "./sent-message-cache-BWgrpGJe.js";
import { c as toTelegramRichMessageContextParams, h as telegramHtmlToPlainTextFallback, i as getTelegramRichRawApi, p as renderTelegramHtmlText, r as buildTelegramRichMessage, s as splitTelegramRichTextChunks, t as TELEGRAM_RICH_TEXT_LIMIT } from "./rich-message-BouId6gu.js";
...
async function sendMessageTelegram(to, text, opts) {
	...
	const richMessageOptions = { skipEntityDetection: account.config.linkPreview === false };
	const buildRichMessage = (value) => buildTelegramRichMessage(value, textMode, richMessageOptions);
	...
	const sendTelegramTextChunk = async (chunk, params) => {
		...
		return {
			result: await requestWithChatNotFound(() => richRawApi.sendRichMessage({
				chat_id: chatId,
	...
	const buildTextParams = (isLastChunk) => hasRichThreadParams || isLastChunk && replyMarkup ? {
		...richThreadParams,
	...
	const buildChunkedTextPlan = (rawText) => {
	...
	const sendChunkedText = async (rawText, context) => await sendTelegramTextChunks(buildChunkedTextPlan(rawText), context);
...
async function editMessageTelegram(chatIdInput, messageIdInput, text, opts) {
	...
	const richRawApi = getTelegramRichRawApi(api);
	const richMessage = buildTelegramRichMessage(text, textMode, { skipEntityDetection: opts.linkPreview === false });
	...
	const performTextEdit = () => requestWithEditShouldLog(() => richRawApi.editMessageText({
		chat_id: chatId,
...
//#endregion
export { apiThrottler as A, resolveTelegramClientTimeoutMinimumSeconds as C, withTelegramApiErrorLogging as D, splitTelegramCaption as E, getOrCreateAccountThrottler as O, createTelegramClientFetch as S, resolveTelegramOutboundClientTimeoutFloorSeconds as T, getTelegramNativeQuoteReplyMessageId as _, editMessageTelegram as a, buildInlineKeyboard as b, renameForumTopicTelegram as c, sendPollTelegram as d, sendStickerTelegram as f, buildTelegramSendParams as g, resolveTelegramVoiceSend as h, editMessageReplyMarkupTelegram as i, sequentialize as j, Bot$1 as k, resetTelegramClientOptionsCacheForTests as l, unpinMessageTelegram as m, deleteMessageTelegram as n, pinMessageTelegram as o, sendTypingTelegram as p, editForumTopicTelegram as r, reactMessageTelegram as s, createForumTopicTelegram as t, sendMessageTelegram as u, removeTelegramNativeQuoteParam as v, resolveTelegramClientTimeoutSeconds as w, asTelegramClientFetch as x, recordOutboundMessageForPromptContext as y };
