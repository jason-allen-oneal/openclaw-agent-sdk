...
import { r as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-DNxwJzrt.js";
...
import { _ as isRateLimitErrorMessage, a as formatTransportErrorCopy, b as matchesFormatErrorPattern, c as isLikelyHttpErrorText, f as isAuthErrorMessage, g as isPeriodicUsageLimitErrorMessage, h as isOverloadedErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, l as isRawApiErrorPayload, m as isBillingErrorMessage, n as formatBillingErrorMessage, p as isAuthPermanentErrorMessage, r as formatDiskSpaceErrorCopy, s as isInvalidStreamingEventOrderError, u as isStreamingJsonParseError, v as isServerErrorMessage, x as formatExecDeniedUserMessage, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-NOYqsmDF.js";
import { t as formatSandboxToolPolicyBlockedMessage } from "./runtime-status-D4eSqgVq.js";
...
function formatAssistantErrorText(msg, opts) {
	...
	if (providerRuntimeFailureKind === "auth_invalid_token") return "Authentication failed (provider returned HTTP 401). Your provider token may have expired — try the request again in a moment. If the failure persists, re-authenticate this provider.";
...
//#endregion
export { isTransientHttpError as C, isModelNotFoundErrorMessage as D, parseImageSizeError as E, isReasoningConstraintErrorMessage as S, parseImageDimensionError as T, isFailoverErrorMessage as _, classifyProviderRuntimeFailureKind as a, isLikelyContextOverflowError as b, formatAssistantErrorText as c, isAuthAssistantError as d, isBillingAssistantError as f, isFailoverAssistantError as g, isContextOverflowError as h, classifyFailoverSignal as i, formatUserFacingAssistantErrorText as l, isCompactionFailureError as m, classifyAssistantFailoverReason as n, extractFailoverSignalDetails as o, isCloudCodeAssistFormatError as p, classifyFailoverReason as r, extractObservedOverflowTokenCount as s, GENERIC_ASSISTANT_ERROR_TEXT as t, inferSignalStatus as u, isImageDimensionErrorMessage as v, isUnclassifiedNoBodyHttpSignal as w, isRateLimitAssistantError as x, isImageSizeError as y };
