...
import { A as isBunRuntime } from "./argv-BulIeC99.js";
...
import { d as normalizeTrimmedStringList, l as normalizeStringEntries } from "./string-normalization-WNUDCpXX.js";
import { w as pathExists } from "./fs-safe-aqmM_n6V.js";
import { p as resolveUserPath, r as clampInt } from "./utils-CCC-BEJH.js";
...
import "./clawhub-ayz2fZY0.js";
import { r as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-Ced3DGEX.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-fA-EQXn-.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-h7dZZiYs.js";
import { v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-B4NxGkqZ.js";
...
import { a as resolveAgentDir } from "./agent-scope-config-DNJywrQV.js";
import { r as logVerbose } from "./globals-DbTJQTMp.js";
import { E as validateConfigObjectWithPlugins, F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, u as readConfigFileSnapshot } from "./io-fQmSDfK-.js";
...
import "./installed-plugin-index-records-BexO5-Vu.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-CG8AzHpQ.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-DMwPAosm.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-BwYwN1xh.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-8EWKY4HT.js";
import { t as parseDurationMs } from "./parse-duration-oxu_S07c.js";
import { o as transformConfigFileWithRetry } from "./config-BqCwA_DI.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-Bx5KKfOp.js";
import { g as triggerOpenClawRestart, p as scheduleGatewaySigusr1Restart } from "./restart-CppiWLEI.js";
import { o as normalizeChannelId } from "./registry-r77FTpHr.js";
import { t as getActivePluginChannelRegistry } from "./runtime-CjN6pXNK.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-zwWPrwO1.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-NEwU8m3X.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-CbDXysvw.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
...
import "./sessions-DieR2Eem.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-NdJkeRhp.js";
import { s as migrateSessionEntries } from "./session-manager-g-7X6v2O.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-YXLLZVCi.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-Bl6V2_lJ.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CO2vrvx5.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BI3m2RBP.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-DYVvJ6dV.js";
import { m as replyRunRegistry } from "./reply-run-registry-Ccw3Ogdy.js";
import { p as resolveActiveEmbeddedRunSessionId } from "./run-state-DClKANFE.js";
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync, s as isEmbeddedAgentRunActive } from "./runs-DI_L8C_8.js";
import { i as isSilentReplyPayloadText } from "./tokens-U6o7_k27.js";
import { u as readSessionMessages } from "./session-utils.fs-Y_TmTCGQ.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BtjJDifS.js";
import { o as resolveContextTokensForModel } from "./context-CjnpdDgY.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import { n as formatUsd } from "./usage-format-BPS8sDt6.js";
...
import { n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-cH-a8Dq4.js";
import { A as isRealConversationMessage } from "./compaction-successor-transcript-Ncp4Uf5J.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-CSEkC-AM.js";
import { a as clearSessionQueues } from "./queue-DgtGULP_.js";
import { i as resolveReplyToMode } from "./reply-threading-0Mg-MzO4.js";
import { b as resolveBootstrapTotalMaxChars, v as resolveBootstrapMaxChars } from "./embedded-agent-helpers-CULGwdfn.js";
import { n as routeReply } from "./route-reply--p-hLf3k.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-lj5quus3.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-Dew3j_KP.js";
...
import "./sandbox-C9REAclS.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-C2bbV71d.js";
import { C as setTtsMaxLength, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-o5e1uKRE.js";
import "./tts-Bc1lw7_c.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-DM8pBwCP.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-bmmzkOyn.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DXh85F1c.js";
import { a as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus } from "./task-status-access-CJ5fpZ3R.js";
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-BZIWmjqd.js";
import "./commands-registry-ChZ74sL3.js";
import { n as classifyCompactionReason } from "./compact-reasons-Di0yKRbB.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-rflhdBOv.js";
import { r as handleGoalCommand } from "./commands-goal-DDw6htSU.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CAtgCV5h.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-DsRtgDV4.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-idTqAPpY.js";
...
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-BI2hKn2s.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-CGWBcki3.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-CsSi7NMR.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-CGHmcQ41.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-DU3OxkhL.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-DNNKgGbF.js";
import { n as parseActivationCommand } from "./group-activation-qzpxwTmf.js";
...
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-B6VZp21z.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dq7L4_ND.js";
import { t as extractBtwQuestion } from "./btw-command-CSTFWTch.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-B7B3XRMF.js";
import { r as handleModelsCommand } from "./commands-models-B1U-NB-2.js";
import { r as createExecTool } from "./bash-tools-BDlHWekN.js";
import { t as runBtwSideQuestion } from "./btw-CTyL8z7P.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-DShbgcuI.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, d as resolveCommandSurfaceChannel, l as stopWithText$1, o as resolveRequesterSessionKey, u as resolveChannelAccountId } from "./shared-BFGfHt6M.js";
import { t as buildToolsMessage } from "./status-DJSAGKYu.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CCAE7mY4.js";
import { n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-xejnmIdC.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-D7q1VuxQ.js";
import "./command-export-eubeMevT.js";
import { t as buildStatusReply } from "./commands-status-8EYTmLV8.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-Cr-WOtGX.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-5B0zvvJg.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-CAwjWX9K.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-DL2DFkLO.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-xHzD4ZUN.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-D5S0RRlF.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-CEVMvnfZ.js";
import { n as installPluginFromClawHub } from "./clawhub-BlHR949w.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-Cdc3xYmK.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-CQrvWe2F.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BehA01__.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-CWBWfyci.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-SBcMoZs6.js");
...
async function persistAbortTargetEntry(params) {
	...
	if (storePath) await updateSessionStore(storePath, (store) => {
		...
		store[key] = nextEntry;
		return nextEntry;
	}, { resolveSingleEntryPersistence: (updated) => updated ? {
		sessionKey: key,
		entry: updated
	} : null });
	return true;
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-DaP0lsld.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BhLIed7W.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DcrrVWyD.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-DCX38P9O.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-D3w-rPbc.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-ByG-2Vv0.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-DeDMxELn.js"));
