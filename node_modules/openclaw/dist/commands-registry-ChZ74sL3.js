...
import { n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BzNekEY8.js";
...
import "./commands-text-routing-BkCP8ve-.js";
...
function findCommandByNativeName(name, provider, options) {
	...
	return getChatCommands().find((command) => command.scope !== "text" && [resolveNativeName(command, provider, options), ...command.nativeAliases ?? []].some((nameLocal) => normalizeOptionalLowercaseString(nameLocal) === normalized));
}
