...
import { i as resolveTrajectoryFilePath } from "./paths-Biq9XkB5.js";
import "./sessions-DieR2Eem.js";
import { r as readAcpSessionMeta } from "./session-meta-DM0X1_Qg.js";
import { n as resolveTrajectoryRuntimeFile } from "./runtime-file-BxBUlhIQ.js";
...
async function buildTailSelection(params) {
	...
	const trajectoryPath = await resolveTrajectoryRuntimeFile({
		sessionFile,
...
async function sessionsTailCommand(opts, runtime) {
	...
	for (const target of targets) {
		...
		for (const [key, entry] of Object.entries(store)) selections.push(await buildTailSelection({
