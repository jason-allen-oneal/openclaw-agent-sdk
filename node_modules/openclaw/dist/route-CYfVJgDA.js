import { t as isTruthyEnvValue } from "./env-DcqIKp5M.js";
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, k as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-BulIeC99.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-Dl0rBEHn.js";
import { t as createLazyImportLoader } from "./lazy-promise-BONnzNfb.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-u_XH8zQZ.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-gBVG4H2O.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-B2aRY276.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-tAHO6UfJ.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-B-Wq897O.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BWAV6qLN.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-BRZbWM69.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BV-LvEcY.js"));
...
const routedCommandDefinitions = {
	health: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { healthCommand } = await import("./health-gCQ8uyGP.js");
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-BHFPEyIh.js");
			...
			const { statusCommand } = await import("./status-BRB0wApD.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-B0vvSvJ5.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-ZOj_-Zkx.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-QvFlXy8M.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-Cubc-mXc.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-ebn-ly5D.js");
