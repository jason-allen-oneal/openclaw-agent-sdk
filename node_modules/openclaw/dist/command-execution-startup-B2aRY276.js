...
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-u_XH8zQZ.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-DCVHQ1j-.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-D7F_6J2A.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BujVbe_s.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-tH_YaeAU.js");
	if (params.argv) {
