...
import { m as onAgentEvent, s as emitAgentEvent } from "./agent-events-C3fRM85v.js";
import { i as isClientToolNameConflictError } from "./tool-split-DXB3RqC6.js";
import { f as extractFileContentFromSource, g as resolveInputFileLimits, m as normalizeMimeList, p as extractImageContentFromSource, u as DEFAULT_INPUT_IMAGE_MIMES } from "./runner.entries-BgjJJ-7C.js";
import { i as wrapExternalContent } from "./external-content-pX-Pk1Iu.js";
import { t as renderFileContextBlock } from "./file-context-M6CFQU8x.js";
...
import { a as sendJson, d as writeDone, l as setSseHeaders, s as sendMissingScopeForbidden, u as watchClientDisconnect } from "./http-common-B7U3wQMs.js";
import { a as getBearerToken, n as authorizeOpenAiCompatibleHttpModelOverride, o as getHeader, u as resolveOpenAiCompatibleHttpOperatorScopes } from "./http-auth-utils-DAMcdY14.js";
import { i as resolveAgentIdForRequest, o as resolveGatewayRequestContext, r as isUnknownGatewayAgentError, s as resolveOpenAiCompatModelOverride } from "./http-utils-6sBFWbZ9.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-X6kkdpGe.js";
import { c as buildAgentMessageFromConversationEntries, i as resolveOpenAiCompatError, l as resolveAssistantStreamDeltaText, n as resolveUnsatisfiedToolChoiceMessage, o as normalizeInputHostnameAllowlist, r as toolChoiceConstraintPrompt, t as isToolChoiceConstraintSatisfied } from "./openai-tool-choice-DyAYMszV.js";
...
function buildAgentPrompt(input) {
	...
	for (const [i, item] of input.entries()) if (item.type === "message") {
		const body = extractTextContent(item.content).trim() || (item.role === "user" && i === activeUserMessageIndex && hasImageContent(item.content) ? "User sent image(s) with no text." : "");
		if (!body) continue;
