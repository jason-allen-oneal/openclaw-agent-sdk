...
function loadQmdManagerModule() {
	qmdManagerModulePromise ??= import("./qmd-manager-CcriL5pI.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		if (transient) {
			...
			return manager ? { manager } : await getBuiltinMemorySearchManagerAfterQmdFailure(params, failureReason);
		}
		...
		return manager ? { manager } : await getBuiltinMemorySearchManagerAfterQmdFailure(params, pendingFailureReason);
	}
