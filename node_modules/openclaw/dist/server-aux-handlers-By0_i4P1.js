...
import { a as resolveSecretRefValue } from "./resolve-C1PJUY9f.js";
...
import { r as createResolverContext } from "./runtime-shared-BZtdr2gj.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-BBmSOFBL.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-CHJ8MmHb.js";
...
import { n as getLoadedChannelPlugin } from "./registry-BzNekEY8.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-CbDXysvw.js";
...
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-HKQyjnAT.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-tQKwXl07.js";
...
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-BTTBuKvs.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-8a1OmXK0.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-DOG9pE-q.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-COKh329T.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-D8pvCCR5.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DuJscx_Y.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-tSdC7nye.js";
import { d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalAlert, o as resolveApnsAuthConfigFromEnv, r as loadApnsRegistrations, t as clearApnsRegistrationIfCurrent, u as sendApnsExecApprovalResolvedWake } from "./push-apns-DrNpEPXe.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-D8qHKDLp.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-jS4aDbrv.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-D779zRCw.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-Ds_wA8uC.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
