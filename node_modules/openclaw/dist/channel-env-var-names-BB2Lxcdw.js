...
import { c as isBundledSourceOverlayPath } from "./discovery-BUQqFET8.js";
...
import { t as listChannelCatalogEntries } from "./channel-catalog-registry-CoMZ7aLc.js";
import { h as resolveExistingPluginModulePath, m as loadChannelPluginModule } from "./bundled-C8rQ5-HL.js";
import { r as listBundledChannelIds } from "./bootstrap-registry-BBZtC4Up.js";
import { i as hasNonEmptyString } from "./channel-target-CPTDAkyx.js";
...
function listExplicitlyDisabledChannelIdsForConfig(cfg) {
	...
	if (!channels) return [];
	return Object.entries(channels).filter(([, value]) => isRecord$1(value) && value.enabled === false).map(([channelId]) => normalizeOptionalLowercaseString(channelId)).filter((channelId) => Boolean(channelId));
}
...
//#endregion
export { listPotentialConfiguredChannelPresenceSignals as a, AGENT_MODEL_CONFIG_KEYS as c, listPotentialConfiguredChannelIds as i, collectConfiguredModelRefValues as l, hasMeaningfulChannelConfig as n, hasBundledChannelPackageState as o, listExplicitlyDisabledChannelIdsForConfig as r, listBundledChannelIdsForPackageState as s, isSafeChannelEnvVarTriggerName as t, collectConfiguredModelRefs as u };
