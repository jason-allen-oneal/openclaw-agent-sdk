...
import { b as readStringParam, c as imageResultFromFile, g as readPositiveIntegerParam, l as jsonResult, m as readNonNegativeIntegerParam } from "./common-CEBsSh4n.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-BAJkmR0Z.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-B0N8Z4AB.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-BGK1V4Wc.js";
import { t as describeImageFile } from "./runtime-D4GUiqfk.js";
import "./param-readers-BqIX58yY.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-pFLEOnlD.js";
import { n as withTimeout } from "./sdk-security-runtime-DUrugw5f.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-Zi7_yOF0.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-onqhTuPq.js";
import "./sdk-setup-tools-DyV6DFHC.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-MrakEmVT.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-3APMLJSj.js";
import { r as getBrowserProfileCapabilities } from "./target-id-BJRjs0EP.js";
import { n as normalizeBrowserScreenshot } from "./routes-pdupB_DS.js";
import { t as createBrowserRouteDispatcher } from "./dispatcher-GJSzP6j-.js";
import { n as createBrowserControlContext } from "./plugin-enabled-BpU3jJJU.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-BofFLUnr.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BgBqolE3.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-CY9R73D2.js");
