...
import "./accounts-DDeUrk7s.js";
import "./runtime-api-lLqOH1AA.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-5BWnGaV_.js";
import { t as sendMessageZalo } from "./send-Bzqy_VgI.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BFkl-EAh.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-SF-IVqs-.js");
