...
import { i as createWindowsOutputDecoder, r as spawnWithFallback, t as resolveWindowsCommandShim } from "./windows-command-CggaAJAY.js";
...
async function createChildAdapter(params) {
	...
	const wait = async () => {
		...
		if (waitError !== void 0) throw toLintErrorObject(waitError, "Non-Error thrown");
