...
import { i as getRuntimeConfig, r as createConfigIO } from "./io-fQmSDfK-.js";
import { i as replaceConfigFile } from "./config-BqCwA_DI.js";
import { i as resolveAuthProfileDatabaseFilePaths } from "./sqlite-Dbv69W9J.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Dh_Oi1YB.js";
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets--sBbmioM.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-BqFUxqjW.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-D5cgEWdn.js");
