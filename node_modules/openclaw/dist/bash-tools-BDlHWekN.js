...
import { c as sanitizeHostExecEnvWithDiagnostics, n as isDangerousHostEnvOverrideVarName, o as normalizeHostOverrideEnvVarKey, r as isDangerousHostEnvVarName } from "./host-env-security-RnaFYKhk.js";
...
import { a as logWarn, r as logInfo } from "./logger-Bk5gMrQq.js";
import { t as killProcessTree } from "./kill-tree-kSm0C74g.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-CZeLSeyj.js";
import { a as resolveApprovalAuditTrustPath } from "./exec-command-resolution-CqhcxBz-.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-CFL_Vekh.js";
...
import { i as normalizeMessageChannel, n as isGatewayMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
import "./message-channel-Dx39C4tw.js";
import { C as parseExecApprovalResultText, S as isExecDeniedResultText, d as sanitizeUserFacingText, x as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-NOYqsmDF.js";
...
import { c as describeInterpreterInlineEval } from "./risks-DRxJ1pW5.js";
import { r as buildEnforcedShellCommand } from "./exec-approvals-analysis-B4N2JXzl.js";
import { n as evaluateShellAllowlist } from "./exec-approvals-allowlist-VYEHBfj3.js";
import { A as resolveExecApprovalAllowedDecisions, D as requireValidExecTarget, L as resolveExecApprovalsTranscriptPath, M as resolveExecApprovals, O as requiresExecApproval, P as resolveExecApprovalsFromFile, S as persistAllowAlwaysPatterns, _ as normalizeExecAsk, f as loadExecApprovals, h as minSecurity, k as resolveAllowAlwaysPatternCoverage, l as hasDurableExecApproval, o as addDurableCommandApproval, p as maxAsk, s as commandRequiresSecurityAuditSuppressionApproval, u as hasNodeCommandAllowAlwaysMarker, w as recordAllowlistMatchesUse, z as resolveExecModePolicy } from "./exec-approvals-C6M6SGY3.js";
import { C as textResult, o as failedTextResult } from "./common-CEBsSh4n.js";
import { t as callGatewayTool } from "./gateway-B25HCVzg.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DKOVy8lE.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-B3ho0AFu.js";
import { i as resolveNodeIdFromList, t as listNodes, u as stripMalformedXmlArgValueSuffixFromKeys } from "./nodes-utils-BqX7b_Ao.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-aYM2nllz.js";
import "./delivery-context-CB0EiNbM.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-H0bALkpO.js";
import { t as sendMessage } from "./message-D96PSx3g.js";
import { t as formatDurationCompact } from "./format-duration-BrZ-AaEJ.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-vmCOzjUM.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-DM8pBwCP.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-w74zbC7z.js";
import { t as getProcessSupervisor } from "./supervisor-CgZKC8hb.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-c6o7I58_.js";
import { i as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-DcnAFEuf.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DOG9pE-q.js";
import { i as rejectUnsafeExecControlShellCommand } from "./exec-control-command-guard-Di8r939_.js";
import { n as detectPolicyInlineEval } from "./policy-KTeYxilK.js";
import { i as defaultExecAutoReviewer, t as createModelExecAutoReviewer } from "./exec-auto-reviewer-AYe5QzaV.js";
import { a as registerExecApprovalFollowupRuntimeHandoff, r as isExecApprovalFollowupSessionRebound, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-BQdEUwIw.js";
import { n as formatExecCommand, r as resolveSystemRunCommandRequest, t as extractShellCommandFromArgv } from "./system-run-command-BO3cgBjR.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-2h9yWcHm.js";
...
function createExecTool(defaults) {
	...
	return {
		...
		prepareBeforeToolCallParams: async (args, context) => prepareParamsWithResolvedExecEnv(args, { hookContext: context.hookContext }),
		finalizeBeforeToolCallParams: (params, preparedParams) => (() => {
			const state = getResolvedExecEnvPreparedState(preparedParams);
			if (!state) return params;
			const execParams = params;
			if (state.host && execParams.command && resolveHostForParams(execParams) !== state.host) return { ...execParams };
			return markResolveExecEnvPrepared(execParams, state);
		})(),
		execute: async (_toolCallId, args, signal, onUpdate) => {
			const params = isResolveExecEnvPrepared(args) ? stripMalformedXmlArgValueSuffixFromKeys(args, XML_ARG_VALUE_EXEC_PARAM_KEYS) : await prepareParamsWithResolvedExecEnv(args);
