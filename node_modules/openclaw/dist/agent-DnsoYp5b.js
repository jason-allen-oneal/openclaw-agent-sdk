...
import { a as formatUncaughtError, c as readErrorName } from "./errors-CbY2H91D.js";
...
import { c as parseAgentSessionKey, l as parseRawSessionConversationRef, n as isAcpSessionKey, u as parseThreadSessionSuffix } from "./session-key-utils-Bx3apsJ3.js";
import { f as resolveAgentIdFromSessionKey, s as classifySessionKeyShape, u as normalizeAgentId } from "./session-key-B_NoIfpX.js";
import { c as resolveDefaultAgentId, n as listAgentIds } from "./agent-scope-config-DNJywrQV.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-Clry3kRy.js";
import { d as getAgentEventLifecycleGeneration, i as clearAgentRunContext, m as onAgentEvent, r as claimAgentRunContext, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-C3fRM85v.js";
import { n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-Eahn-btj.js";
import { i as resolveSessionStoreKey, n as canonicalizeSpawnedByForAgent } from "./session-store-key-BE0Qy0oB.js";
import { i as mergeDeliveryContext, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-BlmyB9yJ.js";
...
import { D as resolveMaintenanceConfigFromInput } from "./store-load-BEkoRRyW.js";
import { d as updateSessionStore } from "./store-Dcn5FSKd.js";
import { i as normalizeMessageChannel, n as isGatewayMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
import "./message-channel-Dx39C4tw.js";
import { r as mergeSessionEntry } from "./types-D8S_uNvu.js";
import { c as resolveSessionLifecycleTimestamps, l as resolveTerminalMainSessionTranscriptRegistryCheck, o as hasTerminalMainSessionTranscriptNewerThanRegistrySync } from "./sessions-DieR2Eem.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-CvIGl7dh.js";
import { t as asBoolean } from "./boolean-By0bZpFH.js";
import { a as normalizeAgentRunTimeoutPhase, i as mergeAgentRunTerminalOutcome, t as buildAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-X--EiwYW.js";
import { a as isAgentRunRestartAbortReason, n as AGENT_RUN_RESTART_ABORT_STOP_REASON } from "./run-termination-u49x3Tfg.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId } from "./detached-task-runtime-DKoww6Sq.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { r as readAcpSessionMeta } from "./session-meta-DM0X1_Qg.js";
import { c as shouldPreserveUserFacingSessionStateForInputProvenance, n as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-CYQvfQZP.js";
import { b as resolveSessionModelRef, d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, h as resolveGatewayModelSupportsImages, l as loadGatewaySessionRow, u as loadSessionEntry } from "./session-utils-CFmlVr6t.js";
import { n as resolveSendPolicy } from "./send-policy-Df9c4jHG.js";
import { l as isTimeoutError } from "./failover-error-CC108ogz.js";
import { s as resolveTrustedGroupId } from "./agent-tools.policy-5Rr-S1Gi.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun, s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-DivWGEJB.js";
import "./subagent-announce-delivery-BdIxN0mb.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-H0bALkpO.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-D1kculJq.js";
import { t as clearAllCliSessions } from "./cli-session-D_Cr4kxU.js";
import { in as errorShape, rn as ErrorCodes } from "./schema-BwaBORnA.js";
import { i as validateAgentWaitParams, n as validateAgentIdentityParams, r as validateAgentParams, t as formatValidationErrors } from "./src-oj0IwW6K.js";
import { l as updateChatRunProvider, o as registerChatAbortController, s as resolveAgentRunExpiresAtMs } from "./chat-abort-wGseQqSt.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-BXfFtSwp.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DIb6IKR7.js";
import { n as agentCommandFromIngress } from "./agent-command-Ctv5EwPF.js";
import { n as resolveAgentDeliveryPlanWithSessionRoute, r as resolveAgentOutboundTarget } from "./agent-delivery-Y_4xWgUk.js";
import { t as formatForLog } from "./ws-log-CqhS4yhs.js";
import "./agent-Be8HAA3Z.js";
import { i as parseExecApprovalFollowupApprovalId, n as consumeExecApprovalFollowupRuntimeHandoff, r as isExecApprovalFollowupSessionRebound } from "./bash-tools.exec-approval-followup-state-BQdEUwIw.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-5_kBJ6K3.js";
import { n as setGatewayDedupeEntry, r as waitForTerminalGatewayDedupe, t as readTerminalSnapshotFromGatewayDedupe } from "./agent-wait-dedupe-DgxAVWxh.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dq5NZiXU.js";
import { r as resolveVoiceWakeRouteByTrigger, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BF5EBU0h.js";
import { t as reactivateCompletedSubagentSession } from "./session-subagent-reactivation-C683iBTA.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { registerSubagentRun } = await import("./subagent-registry-BI-1dyBd.js");
	registerSubagentRun({
		runId: params.runId,
		childSessionKey,
