...
const providerIndexCatalogLoader = createLazyImportLoader(() => import("./list.provider-index-catalog-CLw92oNX.js"));
...
async function planAllModelListSources(params) {
	...
	const manifestCatalog = await import("./list.manifest-catalog-B2m6RJD4.js");
	...
	const providerCatalog = await import("./list.provider-catalog-ClrrIBba.js");
