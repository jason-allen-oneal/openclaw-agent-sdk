...
import { a as isRecoverableTelegramNetworkError, h as readTelegramRetryAfterMs, o as isSafeToRetrySendError, p as isTelegramRateLimitError, s as isTelegramClientRejection, u as isTelegramMessageNotModifiedError } from "./request-timeouts-BU95nyTR.js";
import "./routing-CqTr30kc.js";
import { y as buildChannelInboundEventContext } from "./kernel-DE2qKqQk.js";
...
import { a as takeMessageIdAfterStop, i as createFinalizableDraftStreamControlsForState } from "./draft-stream-controls-B2vP943I.js";
import "./web-media-B5J6WDKX.js";
import "./system-event-runtime-PFGDPaBS.js";
import "./conversation-runtime-CZ37Nuw1.js";
import { t as buildModelsProviderData } from "./commands-models-B1U-NB-2.js";
...
import { S as buildTelegramThreadParams, a as wasSentByBot, rt as normalizeTelegramReplyToMessageId } from "./sent-message-cache-BWgrpGJe.js";
import { i as getTelegramRichRawApi, n as buildTelegramRichMarkdown, t as TELEGRAM_RICH_TEXT_LIMIT } from "./rich-message-BouId6gu.js";
import { r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CnxQsFly.js";
import { D as withTelegramApiErrorLogging, a as editMessageTelegram, y as recordOutboundMessageForPromptContext } from "./send-DsQJjhVA.js";
import { n as deliverReplies, r as emitInternalMessageSentHook } from "./delivery-ChlR386m.js";
...
function renderTelegramDraftPreview(text, renderText) {
	...
	return renderText?.(trimmed) ?? {
		text: trimmed,
		richMessage: buildTelegramRichMarkdown(trimmed)
	};
}
...
function createTelegramDraftStream(params) {
	...
	const richReplyParams = replyToMessageId != null ? {
		...threadParams,
		reply_parameters: {
