import { D as ChannelOutboundTargetMode } from "./types.core-ba6ZzuW3.js";
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry, l as InputProvenance } from "./types-DoeN-uEF.js";
import { i as OpenClawConfig, tn as AgentDefaultsConfig } from "./types.openclaw-xtiDgbrd.js";
import { a as AuthProfileFailureReason, c as OAuthCredential, d as TokenCredential, i as AuthProfileCredential, n as AuthProfileBlockedReason, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential, u as ProfileUsageStats } from "./types-ESoOnEL7.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { t as PluginManifestRecord } from "./manifest-registry-BJsVfG4X.js";
import { n as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-BG4FuJTA.js";
import { o as resolveAgentIdFromSessionKey } from "./session-key-fJM_U9Lv.js";
import { f as ThinkLevel$1, m as VerboseLevel } from "./commands-registry.types-B_ifGtDv.js";
import { $c as markAuthProfileCooldown, Ac as hasAvailableAuthForProvider, Al as refreshOAuthCredentialForRuntime, Bc as MissingProviderAuthError, Bl as resolveProviderAuthAliasMap, Cc as RuntimeProviderAuthLookup, Cl as markAuthProfileSuccess, Dc as createRuntimeProviderAuthLookup, Dl as upsertAuthProfileWithLock, Ec as canUseProfileAsProviderEntryApiKey, El as upsertAuthProfile, Fc as resolveModelAuthMode, Fl as AuthProfileEligibilityReasonCode, Gc as isProviderAuthError, Hc as ResolvedProviderAuth, Hl as AuthCredentialReasonCode, Ic as resolveProviderEntryApiKeyBinding, Il as resolveAuthProfileEligibility, Jc as EnvApiKeyResult, Kc as requireApiKey, Kl as CLAUDE_CLI_PROFILE_ID, Lc as resolveProviderEntryApiKeyProfileReference, Ll as resolveAuthProfileOrder, Mc as hasSyntheticLocalProviderAuthConfig, Ml as ExternalCliAuthDiscovery, Nc as hasUsableCustomProviderApiKey, Nl as formatAuthDoctorHint, Oc as getApiKeyForModel, Ol as dedupeProfileIds, Pc as resolveApiKeyForProvider, Pl as resolveAuthProfileDisplayLabel, Qc as markAuthProfileBlockedUntil, Rc as resolveUsableCustomProviderApiKey, Rl as ProviderAuthAliasLookupParams, Sc as ProviderEntryApiKeyBindingResolution, Sl as suggestOAuthProfileIdForLegacyDefault, Tc as applyLocalNoAuthHeaderOverride, Tl as setAuthProfileOrder, Uc as formatMissingAuthError, Vc as ProviderAuthError, Vl as resolveProviderIdForAuth, Wc as isMissingProviderAuthError, Wl as TokenExpiryState, Xc as calculateAuthProfileCooldownMs, Yc as resolveEnvApiKey, Zc as clearAuthProfileCooldown, _c as prepareSimpleCompletionModel, _l as saveAuthProfileStore, ac as AgentInternalEvent, al as isProfileInCooldown, bc as ModelAuthMode, cc as AgentStreamParams, cu as EmbeddedAgentRunMeta, dl as loadAuthProfileStore, el as markAuthProfileFailure, fc as AgentSimpleCompletionSelection, fl as loadAuthProfileStoreForRuntime, gc as completeWithPreparedSimpleCompletionModel, gl as resolvePersistedAuthProfileOwnerAgentDir, hc as SimpleCompletionModelOptions, hl as replaceRuntimeAuthProfileStoreSnapshots, ic as PromptMode, il as getSoonestCooldownExpiry, jc as hasRuntimeAvailableProviderAuth, jl as resolveApiKeyForProfile, kc as getCustomProviderApiKey, kl as listProfilesForProvider, lc as ClientToolDefinition, ll as ensureAuthProfileStoreWithoutExternalProfiles, lu as MessagingToolSend, mc as PreparedSimpleCompletionModelForAgent, ml as loadAuthProfileStoreWithoutExternalProfiles, nl as resolveProfilesUnavailableReason, oc as BlockReplyChunking, ol as clearRuntimeAuthProfileStoreSnapshots, pc as PreparedSimpleCompletionModel, pl as loadAuthProfileStoreForSecretsRuntime, qc as resolveAwsSdkEnvVarName, ql as CODEX_CLI_PROFILE_ID, rl as clearExpiredCooldowns, sc as EmbeddedBlockChunker, sl as ensureAuthProfileStore, tl as resolveProfileUnusableUntilForDisplay, uc as ExecElevatedDefaults, ul as findPersistedAuthProfileCredential, vc as prepareSimpleCompletionModelForAgent, wc as applyAuthHeaderOverride, xc as ProviderCredentialPrecedence, xl as repairOAuthProfileIdMismatch, yc as resolveSimpleCompletionSelectionForAgent, zc as shouldPreferExplicitConfigApiKeyAuth, zl as resetProviderAuthAliasMapCacheForTest } from "./types-Tcpca_5M.js";
import { a as SessionEntry } from "./types-CV60Fq0o.js";
...
import { n as appendCronStyleCurrentTimeLine, r as resolveCronStyleNow, t as CronStyleNow } from "./current-time-D1Wo-ACO.js";
