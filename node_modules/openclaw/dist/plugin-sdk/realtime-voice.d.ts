...
import { $i as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, Kn as RealtimeVoiceProviderPlugin, Mo as RuntimeLogger, Qi as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, _a as RealtimeVoiceToolResultOptions, aa as RealtimeVoiceBridgeEvent, ca as RealtimeVoiceCloseReason, da as RealtimeVoiceProviderConfiguredContext, ea as RealtimeVoiceAudioFormat, fa as RealtimeVoiceProviderId, ga as RealtimeVoiceToolCallEvent, ha as RealtimeVoiceTool, ia as RealtimeVoiceBridgeCreateRequest, jo as PluginRuntimeCore, la as RealtimeVoiceProviderCapabilities, ma as RealtimeVoiceRole, na as RealtimeVoiceBridge, oa as RealtimeVoiceBrowserSession, pa as RealtimeVoiceProviderResolveConfigContext, ra as RealtimeVoiceBridgeCallbacks, rc as RunEmbeddedAgentParams, sa as RealtimeVoiceBrowserSessionCreateRequest, ta as RealtimeVoiceBargeInOptions, ua as RealtimeVoiceProviderConfig } from "./types-Tcpca_5M.js";
import { Bt as TalkEventInput, Gt as createTalkEventSequencer, Ht as TalkEventType, It as TALK_EVENT_TYPES, Lt as TalkBrain, Rt as TalkEvent, Ut as TalkMode, Vt as TalkEventSequencer, Wt as TalkTransport, r as DiagnosticEventInput, zt as TalkEventContext } from "./diagnostic-events-CnqmQPpQ.js";
import { n as EmbeddedAgentQueueMessageOutcome } from "./runs-B7_3nHXX.js";
