import { E as ThinkingLevel, f as Model$1, l as ImageContent$1, r as AssistantMessage } from "./types-Boa_mcGH.js";
import { Dr as AgentMessage, Gr as StreamFn, Mr as AgentToolResult, kr as AgentTool } from "./proxy-XN-E4Kgo.js";
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry, l as InputProvenance, n as GetReplyOptions, o as UserTurnTranscriptRecorder, r as PartialReplyPayload, u as ReplyPayload } from "./types-DoeN-uEF.js";
import { i as CommandTurnKind, n as MsgContext, r as CommandTurnContext, t as FinalizedMsgContext, u as InboundEventKind } from "./templating-CZDTHJRv.js";
import { In as SilentReplyConversationType, i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot } from "./types.openclaw-xtiDgbrd.js";
import { t as ChatType } from "./chat-type-B6XXSSnm.js";
import { o as AgentModelConfig } from "./types.provider-request-D8-dJlQu.js";
import { O as SessionMaintenanceMode, d as ContextVisibilityMode, j as SessionScope, v as HumanDelayConfig } from "./types.base-CrXPFJf5.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-CGvqp937.js";
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-C32zt4KH.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-C597Wbu7.js";
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-ESoOnEL7.js";
import { f as MediaUnderstandingProvider } from "./types-BIM51gjx.js";
...
import { b as ExecTarget, g as ExecAsk, v as ExecMode, y as ExecSecurity } from "./exec-approvals-SqmRBcMF.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-BJsVfG4X.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { P as MessageReceipt } from "./types-B7XEDozJ.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-DzyGVqmh.js";
import { i as WizardPrompter } from "./prompts-DgKIGa-v.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin } from "./types.plugin-LFEYCy9_.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-BG4FuJTA.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-CO0bMmjy.js";
import { n as ConfigReplaceResult, t as ConfigMutationBase } from "./config-7WbMSFhL.js";
import { i as resolveStateDir } from "./paths-p1Mv6cLr.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { o as SsrFPolicy } from "./ssrf-skjEI_i5.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-gRarTgZO.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as ReasoningLevel, f as ThinkLevel, m as VerboseLevel, p as ThinkingCatalogEntry, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-B_ifGtDv.js";
import { i as SkillTelemetrySource, r as SkillSnapshot } from "./types-CiLRlEQW.js";
import { i as ExecAutoReviewer } from "./exec-auto-review-CYFxs7ho.js";
import { r as SandboxBackendExecSpec, s as SandboxFsBridge } from "./backend-handle.types-CSIpH53U.js";
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-CV60Fq0o.js";
...
import { i as HookEntry, o as ensureAgentWorkspace, r as InternalHookHandler } from "./internal-hook-types-CKIMi9vm.js";
import { r as AnyAgentTool } from "./common-BmK5s-nt.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-ZNtJaKv-.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-C8SgRuct.js";
import { s as LogLevel } from "./subsystem-Boo2DQIV.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-_mDVpDI2.js";
import { c as EmbeddedAgentExecutionPhase } from "./store-CTgKMVJa.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-6FEupg54.js";
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-CaRRrtFG.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-BEUAejzz.js";
import { S as resolveSessionFilePath, T as resolveStorePath, _ as updateSessionStoreEntry, b as loadSessionStore, d as patchSessionEntry, g as updateSessionStore, l as getSessionEntry, u as listSessionEntries, v as upsertSessionEntry } from "./sessions-mr1myKMY.js";
import { o as enqueueSystemEvent } from "./system-events-BLt5iC5_.js";
import { a as runCommandWithTimeout } from "./exec-zRR_8-LK.js";
import { s as mediaKindFromMime } from "./constants-DUpDbaN0.js";
import { h as resizeToJpeg, u as getImageMetadata } from "./media-services-C_llATX1.js";
import { n as loadWebMedia } from "./web-media-D1aVPCGn.js";
import { n as detectMime } from "./mime-B6baDqNM.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, g as isVoiceCompatibleAudio, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-BMJMSs8r.js";
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-Cj-cgx9C.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-xOnTeQDJ.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BRP4oV74.js";
import { n as RuntimeWebSearchMetadata, t as RuntimeWebFetchMetadata } from "./runtime-web-tools.types-BgJBzqWL.js";
import { C as SecretInputMode, n as GatewayRequestHandler, v as AgentEventPayload, x as onAgentEvent, y as AgentEventStream } from "./types-2FlL_d3o.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { i as PluginStateSyncKeyedStore, r as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-Bm0_upwK.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-D5aR5DDO.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-DykRJW9b.js";
import { d as MemoryPromptSectionBuilder, o as MemoryFlushPlanResolver, r as MemoryCorpusSupplement, s as MemoryPluginCapability, u as MemoryPluginRuntime } from "./memory-state-C7NjDfv2.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-CwGBSHrC.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, an as PluginHookBeforeToolCallResult, cn as ReplyDispatchRuntimeInfo, ln as ReplyDispatcher, on as ReplyDispatchBeforeDeliver, pn as PluginHookBeforeAgentStartResult, qt as PluginJsonValue, rn as PluginApprovalResolution, sn as ReplyDispatchKind, tt as PluginHookName } from "./hook-types-C-yXhapS.js";
import { Wt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-CnqmQPpQ.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-DOKsF21Q.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-D-wCOowe.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-CU_TeWb2.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-Dg8Q_lIL.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-CX4GiS6q.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-DlBEpCR4.js";
import { t as hasControlCommand } from "./command-detection-DlGnOGwk.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-Clq1Vpp0.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-Dd-2YAe7.js";
import { t as buildPairingReply } from "./pairing-messages-DDHdjeS7.js";
import { p as saveMediaBuffer } from "./store-D6pQmvkB.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-B4WQX84y.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-D6dFDlTf.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-wb36K7IF.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-Dkl42Zb5.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-DEu2KkEh.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-BrwoGq2L.js";
import { a as PairLoopGuardResult, i as PairLoopGuardConfig, s as PairLoopGuardSnapshotEntry } from "./pair-loop-guard-runtime-D5O3zwX9.js";
import { n as createChannelHistoryWindow, t as ChannelHistoryWindow } from "./history-window-BSd8jX-m.js";
import { TSchema, Type } from "typebox";
import { Duplex } from "node:stream";
import { Model } from "openclaw/plugin-sdk/llm";
...
declare function applyLocalNoAuthHeaderOverride<T extends Model$1>(model: T, auth: ResolvedProviderAuth | null | undefined): T;
/**
 ...
 */
declare function applyAuthHeaderOverride<T extends Model$1>(model: T, auth: ResolvedProviderAuth | null | undefined, cfg: OpenClawConfig | undefined): T;
//#endregion
...
type RunEmbeddedAgentParams = {
  sessionId: string;
  sessionKey?: string; /** Immutable gateway lifecycle ownership captured when this execution was admitted. */
...
type AgentRuntimeMessagePresentationButton = {
  ...
  action?: AgentRuntimeMessagePresentationAction; /** Legacy opaque callback value sent when pressed. */
...
type AgentRuntimeMessagePresentationOption = {
  ...
  action?: AgentRuntimeMessagePresentationAction; /** Legacy opaque callback value sent when selected. */
  value?: string;
};
/**
...
type CompactEmbeddedAgentSessionParams = {
  ...
  senderE164?: string;
  authProfileId?: string; /** Host-resolved provider credential for native harness compaction. */
...
type AgentHarness = AgentHarnessRunCapability & AgentHarnessSideQuestionCapability & AgentHarnessClassificationCapability & AgentHarnessCompactionCapability & AgentHarnessSessionLifecycleCapability;
//#endregion
...
type CreateReplyDispatcherWithTyping$1 = typeof createReplyDispatcherWithTyping;
//#endregion
...
type CreateReplyDispatcherWithTyping = CreateReplyDispatcherWithTyping$1;
type ReadChannelAllowFromStoreForAccount = ReadChannelAllowFromStoreForAccount$1;
type UpsertChannelPairingRequestForAccount = UpsertChannelPairingRequestForAccount$1;
...
//#endregion
export { OpenClawPluginService as $, setBeforeToolCallDiagnosticsEnabled as $a, markAuthProfileCooldown as $c, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $i, ProviderRuntimePluginHandle as $l, PluginRuntime as $n, SpeechDirectiveTokenParseResult as $o, CommandSessionMetadataChange as $r, GenerateVideoRuntimeResult as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessDeliveryDefaults as Aa, hasAvailableAuthForProvider as Ac, CliBackendAuthEpochMode as Ai, refreshOAuthCredentialForRuntime as Al, ProviderResolvePromptOverlayContext as An, LlmCompleteUsage as Ao, ConversationFacts as Ar, ChannelIngressQueueEnqueueResult as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, PreemptiveCompactionRoute as Ba, MissingProviderAuthError as Bc, CliBackendThinkingLevel as Bi, resolveProviderAuthAliasMap as Bl, ProviderTransportTurnState as Bn, TaskFlowDetail as Bo, formatInboundEnvelope as Br, WebFetchProviderId as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, RealtimeTranscriptionSessionCallbacks as Ca, RuntimeProviderAuthLookup as Cc, PluginToolMetadataRegistration as Ci, markAuthProfileSuccess as Cl, ProviderReplaySanitizeMode as Cn, TranscriptRewriteReplacement as Co, AccessFacts as Cr, OpenClawPluginToolFactory as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, AgentHarnessAttemptResult as Da, createRuntimeProviderAuthLookup as Dc, CodexAppServerExtensionRuntime as Di, upsertAuthProfileWithLock as Dl, ProviderResolveAuthProfileIdContext as Dn, LlmCompleteMessage as Do, ChannelTurnRecordOptions as Dr, ChannelIngressQueueClaim as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, AgentHarnessAttemptParams as Ea, canUseProfileAsProviderEntryApiKey as Ec, CodexAppServerExtensionFactory as Ei, upsertAuthProfile as El, ProviderReplayToolCallIdMode as En, LlmCompleteCaller as Eo, ChannelTurnDroppedHistoryOptions as Er, ChannelIngressQueue as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, AgentHarnessSupport as Fa, resolveModelAuthMode as Fc, CliBackendPrepareExecutionContext as Fi, AuthProfileEligibilityReasonCode as Fl, ProviderRuntimeProviderConfig as Fn, PluginRuntimeTaskFlows as Fo, SupplementalContextFacts as Fr, onSessionTranscriptUpdate as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BeforeToolCallPolicyDiagnosticState as Ga, isProviderAuthError as Gc, AgentToolResultMiddlewareContext as Gi, hasUsableOAuthCredential as Gl, RealtimeTranscriptionProviderPlugin as Gn, TaskRunView as Go, DispatchReplyWithBufferedBlockDispatcher$1 as Gr, WebSearchProviderContext as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, normalizeUsage as Ha, ResolvedProviderAuth as Hc, PluginTextReplacement as Hi, AuthCredentialReasonCode as Hl, ProviderValidateReplayTurnsContext as Hn, TaskRunAggregateSummary as Ho, resolveEnvelopeFormatOptions as Hr, WebFetchProviderToolDefinition as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSupportContext as Ia, resolveProviderEntryApiKeyBinding as Ic, CliBackendPreparedExecution as Ii, resolveAuthProfileEligibility as Il, ProviderSanitizeReplayHistoryContext as In, PluginRuntimeTaskRuns as Io, ChannelBotLoopProtectionFacts as Ir, PluginWebFetchProviderEntry as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, getBeforeToolCallPolicyDiagnosticState as Ja, EnvApiKeyResult as Jc, AgentToolResultMiddlewareOptions as Ji, augmentModelCatalogWithProviderPlugins as Jl, TranscriptSourceProvider as Jn, TtsConfigResolutionContext as Jo, ReplyDispatcherWithTypingOptions as Jr, WebSearchProviderSetupContext as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, DeferredPluginToolApproval as Ka, requireApiKey as Kc, AgentToolResultMiddlewareEvent as Ki, CLAUDE_CLI_PROFILE_ID as Kl, RealtimeVoiceProviderPlugin as Kn, ResolvedTtsConfig as Ko, DispatchReplyWithDispatcher as Kr, WebSearchProviderId as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, CompactEmbeddedAgentSessionParams as La, resolveProviderEntryApiKeyProfileReference as Lc, CliBackendResolveExecutionArgs as Li, resolveAuthProfileOrder as Ll, ProviderSystemPromptContributionContext as Ln, PluginRuntimeTasks as Lo, recordChannelBotPairLoopAndCheckSuppression as Lr, PluginWebSearchProviderEntry as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessResultClassification as Ma, hasSyntheticLocalProviderAuthConfig as Mc, CliBackendNativeToolMode as Mi, ExternalCliAuthDiscovery as Ml, ProviderResolveUsageAuthContext as Mn, RuntimeLogger as Mo, InboundMediaFacts as Mr, ChannelIngressQueuePruneOptions as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, AgentHarnessSideQuestionParams as Na, hasUsableCustomProviderApiKey as Nc, CliBackendNormalizeConfigContext as Ni, formatAuthDoctorHint as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, BoundTaskFlowsRuntime as No, PreparedChannelTurn as Nr, ChannelIngressQueueRecord as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, AgentHarnessCompactParams as Oa, getApiKeyForModel as Oc, CodexAppServerToolResultEvent as Oi, dedupeProfileIds as Ol, ProviderResolveDynamicModelContext as On, LlmCompleteParams as Oo, ChannelTurnResult as Or, ChannelIngressQueueClaimRef as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, AgentHarnessSideQuestionResult as Pa, resolveApiKeyForProvider as Pc, CliBackendPlugin as Pi, resolveAuthProfileDisplayLabel as Pl, ProviderResolvedUsageAuth as Pn, BoundTaskRunsRuntime as Po, RunChannelTurnParams as Pr, emitSessionTranscriptUpdate as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, runBeforeToolCallHook as Qa, markAuthProfileBlockedUntil as Qc, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qi, ProviderRuntimeModel as Ql, CreatePluginRuntimeOptions as Qn, SpeechDirectiveTokenParseContext as Qo, GetReplyFromConfig as Qr, GenerateVideoParams as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, EmbeddedRunAttemptParams as Ra, resolveUsableCustomProviderApiKey as Rc, CliBackendResolveExecutionArgsContext as Ri, ProviderAuthAliasLookupParams as Rl, ProviderToolSchemaDiagnostic as Rn, DetachedTaskFinalizeParams as Ro, EnvelopeFormatOptions as Rr, WebFetchCredentialResolutionSource as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionSession as Sa, ProviderEntryApiKeyBindingResolution as Sc, PluginSessionTurnUnscheduleByTagResult as Si, suggestOAuthProfileIdForLegacyDefault as Sl, ProviderReplayPolicyContext as Sn, SubagentSpawnPreparation as So, resolveChannelInboundSupplementalContext as Sr, OpenClawPluginToolContext as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, AgentHarness as Ta, applyLocalNoAuthHeaderOverride as Tc, CodexAppServerExtensionContext as Ti, setAuthProfileOrder as Tl, ProviderReplaySessionState as Tn, TranscriptRewriteResult as To, ChannelTurnAdmission as Tr, TaskRecord as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, AgentRuntimePlan as Ua, formatMissingAuthError as Uc, PluginTextTransforms as Ui, DEFAULT_OAUTH_REFRESH_MARGIN_MS as Ul, ProviderWebSocketSessionPolicy as Un, TaskRunCancelResult as Uo, finalizeInboundContext as Ur, WebFetchRuntimeMetadataContext as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, NormalizedUsage as Va, ProviderAuthError as Vc, CliBundleMcpMode as Vi, resolveProviderIdForAuth as Vl, ProviderUsageAuthToken as Vn, TaskFlowView as Vo, formatInboundFromLabel as Vr, WebFetchProviderPlugin as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, BuildAgentRuntimePlanParams as Wa, isMissingProviderAuthError as Wc, AgentToolResultMiddleware as Wi, TokenExpiryState as Wl, ProviderWrapStreamFnContext as Wn, TaskRunDetail as Wo, settleReplyDispatcher as Wr, WebSearchCredentialResolutionSource as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, isToolWrappedWithBeforeToolCallHook as Xa, calculateAuthProfileCooldownMs as Xc, AgentToolResultMiddlewareRuntime as Xi, ProviderThinkingPolicyContext as Xl, UnifiedModelCatalogProviderPlugin as Xn, TTS_AUTO_MODES as Xo, createReplyDispatcherWithTyping as Xr, WebSearchProviderToolExecutionContext as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, hasBeforeToolCallPolicy as Ya, resolveEnvApiKey as Yc, AgentToolResultMiddlewareResult as Yi, ProviderDefaultThinkingPolicyContext as Yl, UnifiedModelCatalogProviderContext as Yn, resolveEffectiveTtsConfig as Yo, createReplyDispatcher as Yr, WebSearchProviderToolDefinition as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, requestDeferredPluginToolApproval as Za, clearAuthProfileCooldown as Zc, OpenClawAgentToolResult as Zi, ProviderThinkingProfile as Zl, VideoGenerationProviderPlugin as Zn, normalizeTtsAutoMode as Zo, DispatchFromConfigResult as Zr, WebSearchRuntimeMetadataContext as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceToolResultOptions as _a, prepareSimpleCompletionModel as _c, PluginSessionExtensionRegistration as _i, saveAuthProfileStore as _l, ProviderPrepareRuntimeAuthContext as _n, ContextEnginePromptCacheInfo as _o, FinalizeChannelInboundContextResult as _r, TtsDirectiveOverrides as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeEvent as aa, AgentInternalEvent as ac, PluginAgentEventEmitResult as ai, isProfileInCooldown as al, ProviderNormalizeToolSchemasContext as an, registerContextEngine as ao, hasVisibleChannelTurnDispatch as ar, SpeechProviderOverrides as as, PluginCommandContext as at, ProviderResolveSyntheticAuthContext as au, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderId as ba, ModelAuthMode as bc, PluginSessionTurnScheduleParams as bi, SqliteWalMaintenanceOptions as bl, ProviderReasoningOutputModeContext as bn, IngestResult as bo, filterChannelInboundSupplementalContext as br, OpenClawPluginActiveModelContext as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, RealtimeVoiceCloseReason as ca, AgentStreamParams as cc, PluginRunContextGetParams as ci, ensureAuthProfileStoreForLocalUpdate as cl, ProviderPlugin as cn, BootstrapResult as co, DurableInboundReplyDeliveryParams as cr, SpeechProviderResolveConfigContext as cs, PluginCommandResult as ct, EmbeddedAgentRunMeta as cu, MigrationItemKind as d, RealtimeVoiceProviderConfiguredContext as da, ExecToolDefaults as dc, PluginSessionActionContext as di, loadAuthProfileStore as dl, ProviderPluginWizard as dn, ContextEngineHostCapability as do, BuildChannelInboundEventContextAsyncParams as dr, SpeechSynthesisRequest as ds, PluginEmbeddingProvider as dt, HEARTBEAT_RESPONSE_TOOL_NAME as du, RealtimeVoiceAudioFormat as ea, GenerateImageParams as ec, ProcessToolDefaults as ei, markAuthProfileFailure as el, ProviderModernModelPolicyContext as en, wrapToolWithBeforeToolCallHook as eo, SubagentRunParams as er, SpeechListVoicesRequest as es, OpenClawPluginServiceContext as et, ProviderSystemPromptContribution as eu, MigrationItemStatus as f, RealtimeVoiceProviderId as fa, AgentSimpleCompletionSelection as fc, PluginSessionActionRegistration as fi, loadAuthProfileStoreForRuntime as fl, ProviderPluginWizardModelPicker as fn, ContextEngineHostRequirements as fo, BuildChannelInboundEventContextParams as fr, SpeechSynthesisStreamRequest as fs, PluginInteractiveHandlerRegistration as ft, HeartbeatToolResponse as fu, MigrationProviderPreparation as g, RealtimeVoiceToolCallEvent as ga, completeWithPreparedSimpleCompletionModel as gc, PluginSessionExtensionProjection as gi, resolvePersistedAuthProfileOwnerAgentDir as gl, ProviderPrepareExtraParamsContext as gn, ContextEngineProjection as go, FinalizeChannelInboundContextParams as gr, SpeechVoiceOption as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, RealtimeVoiceTool as ha, SimpleCompletionModelOptions as hc, PluginSessionAttachmentResult as hi, replaceRuntimeAuthProfileStoreSnapshots as hl, ProviderPrepareDynamicModelContext as hn, ContextEngineOperation as ho, FinalizeChannelInboundContextAsyncParams as hr, SpeechTelephonySynthesisRequest as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeVoiceBridgeCreateRequest as ia, PromptMode as ic, PluginAgentEventEmitParams as ii, getSoonestCooldownExpiry as il, ProviderNormalizeResolvedModelContext as in, ContextEngineFactoryContext as io, hasFinalChannelTurnDispatch as ir, SpeechProviderId as is, OpenClawPluginSessionWorkflowApi as it, ProviderResolveExternalOAuthProfilesContext as iu, OpenClawPluginGatewayMethod as j, AgentHarnessResetParams as ja, hasRuntimeAvailableProviderAuth as jc, CliBackendExecutionMode as ji, resolveApiKeyForProfile as jl, ProviderResolveTransportTurnStateContext as jn, PluginRuntimeCore as jo, DispatchedChannelTurnResult as jr, ChannelIngressQueueFailedRecord as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, AgentHarnessCompactResult as ka, getCustomProviderApiKey as kc, CodexAppServerToolResultHandlerResult as ki, listProfilesForProvider as kl, ProviderResolveNonInteractiveApiKeyParams as kn, LlmCompleteResult as ko, CommandFacts as kr, ChannelIngressQueueCompletedRecord as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, RealtimeVoiceProviderCapabilities as la, ClientToolDefinition as lc, PluginRunContextPatch as li, ensureAuthProfileStoreWithoutExternalProfiles as ll, ProviderPluginCatalog as ln, CompactResult as lo, DurableInboundReplyDeliveryResult as lr, SpeechProviderResolveTalkConfigContext as ls, PluginConfigMigration as lt, MessagingToolSend as lu, MigrationProviderContext as m, RealtimeVoiceRole as ma, PreparedSimpleCompletionModelForAgent as mc, PluginSessionAttachmentParams as mi, loadAuthProfileStoreWithoutExternalProfiles as ml, ProviderPreferRuntimeResolvedModelContext as mn, ContextEngineMaintenanceResult as mo, ChannelInboundSupplementalResolutionOptions as mr, SpeechSynthesisTarget as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeVoiceBridge as na, EmbeddedRunTrigger as nc, ProviderNormalizeConfigContext as ni, resolveProfilesUnavailableReason as nl, ProviderNonInteractiveApiKeyResult as nn, resolveEmbeddedAgentRuntime as no, kernel_d_exports as nr, SpeechProviderConfig as ns, OpenClawPluginSessionControlsApi as nt, ProviderExternalOAuthProfile as nu, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBrowserSession as oa, BlockReplyChunking as oc, PluginAgentEventSubscriptionRegistration as oi, clearRuntimeAuthProfileStoreSnapshots as ol, ProviderNormalizeTransportContext as on, resolveContextEngineOwnerPluginId as oo, resolveChannelTurnDispatchCounts as or, SpeechProviderPrepareSynthesisContext as os, PluginCommandDiagnosticsSession as ot, ProviderSyntheticAuthResult as ou, MigrationPlan as p, RealtimeVoiceProviderResolveConfigContext as pa, PreparedSimpleCompletionModel as pc, PluginSessionActionResult as pi, loadAuthProfileStoreForSecretsRuntime as pl, ProviderPluginWizardSetup as pn, ContextEngineInfo as po, BuiltChannelInboundEventContext as pr, SpeechSynthesisStreamResult as ps, PluginInteractiveHandlerResult as pt, normalizeHeartbeatToolResponse as pu, OpenClawPluginNodeInvokePolicyResult as q, ToolOutcomeObserver as qa, resolveAwsSdkEnvVarName as qc, AgentToolResultMiddlewareHarness as qi, CODEX_CLI_PROFILE_ID as ql, SpeechProviderPlugin as qn, ResolvedTtsModelOverrides as qo, ReplyDispatcherOptions as qr, WebSearchProviderPlugin as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBridgeCallbacks as ra, RunEmbeddedAgentParams as rc, ProviderResolveConfigApiKeyContext as ri, clearExpiredCooldowns as rl, ProviderNormalizeModelIdContext as rn, ContextEngineFactory as ro, recordDroppedChannelInboundHistory as rr, SpeechProviderConfiguredContext as rs, OpenClawPluginSessionStateApi as rt, ProviderResolveExternalAuthProfilesContext as ru, MigrationApplyResult as s, RealtimeVoiceBrowserSessionCreateRequest as sa, EmbeddedBlockChunker as sc, PluginControlUiDescriptor as si, ensureAuthProfileStore as sl, ProviderOAuthProfileIdRepair as sn, AssembleResult as so, DurableInboundReplyDeliveryOptions as sr, SpeechProviderPreparedSynthesis as ss, PluginCommandHandler as st, EmbeddedAgentCompactResult as su, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeVoiceBargeInOptions as ta, GenerateImageRuntimeResult as tc, ProviderApplyConfigDefaultsContext as ti, resolveProfileUnusableUntilForDisplay as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, AgentHarnessTaskRuntimeScope as to, SubagentRunResult as tr, SpeechModelOverridePolicy as ts, OpenClawPluginSessionApi as tt, ProviderExternalAuthProfile as tu, MigrationItemAction as u, RealtimeVoiceProviderConfig as ua, ExecElevatedDefaults as uc, PluginRuntimeLifecycleRegistration as ui, findPersistedAuthProfileCredential as ul, ProviderPluginDiscovery as un, ContextEngine as uo, deliverInboundReplyWithMessageSendContext as ur, SpeechProviderResolveTalkOverridesContext as us, PluginConfigValidation as ut, MessagingToolSourceReplyPayload as uu, MusicGenerationProviderPlugin as v, RealtimeTranscriptionProviderConfig as va, prepareSimpleCompletionModelForAgent as vc, PluginSessionSchedulerJobHandle as vi, updateAuthProfileStoreWithLock as vl, ProviderPreparedRuntimeAuth as vn, ContextEngineRuntimeContext as vo, buildChannelInboundEventContext as vr, TtsDirectiveParseResult as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSessionCreateRequest as wa, applyAuthHeaderOverride as wc, PluginTrustedToolPolicyRegistration as wi, removeProviderAuthProfilesWithLock as wl, ProviderReplaySessionEntry as wn, TranscriptRewriteRequest as wo, AssembledChannelTurn as wr, OpenClawPluginToolOptions as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderResolveConfigContext as xa, ProviderCredentialPrecedence as xc, PluginSessionTurnUnscheduleByTagParams as xi, repairOAuthProfileIdMismatch as xl, ProviderReplayPolicy as xn, SubagentEndReason as xo, finalizeChannelInboundContext as xr, OpenClawPluginHookOptions as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeTranscriptionProviderConfiguredContext as ya, resolveSimpleCompletionSelectionForAgent as yc, PluginSessionSchedulerJobRegistration as yi, SqliteWalMaintenance as yl, ProviderReasoningOutputMode as yn, IngestBatchResult as yo, filterChannelInboundQuoteContext as yr, ResolvedProviderRuntimeAuth as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, EmbeddedRunAttemptResult as za, shouldPreferExplicitConfigApiKeyAuth as zc, CliBackendSideQuestionToolMode as zi, resetProviderAuthAliasMapCacheForTest as zl, ProviderTransformSystemPromptContext as zn, DetachedTaskLifecycleRuntime as zo, formatAgentEnvelope as zr, WebFetchProviderContext as zs, ProviderCatalogOrder as zt };