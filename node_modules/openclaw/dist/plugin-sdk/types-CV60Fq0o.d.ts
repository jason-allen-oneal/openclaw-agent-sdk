...
type SessionEntry = {
  ...
  restartRecoveryRuns?: RestartRecoveryRun[]; /** Durable guard state for automatic subagent orphan recovery. */
  ...
  goal?: SessionGoal; /** Timestamp (ms) when the current sessionId first became active. */
  ...
  pendingFinalDeliveryIntentId?: string | null; /** Current visible run delivery context used only for restart recovery. */
  restartRecoveryDeliveryContext?: DeliveryContext; /** Active run id that owns restartRecoveryDeliveryContext cleanup. */
...
//#endregion
export { SessionEntry as a, AcpSessionRuntimeOptions as c, SessionContextBudgetStatus as i, SessionAcpIdentity as l, GroupKeyResolution as n, SessionScope as o, SessionChatType as r, SessionSystemPromptReport as s, CliSessionBinding as t, SessionAcpMeta as u };