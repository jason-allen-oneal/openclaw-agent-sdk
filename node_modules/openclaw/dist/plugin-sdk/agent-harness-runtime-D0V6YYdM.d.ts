...
import { Dr as AgentMessage, Mr as AgentToolResult, Nr as AgentToolUpdateCallback, kr as AgentTool } from "./proxy-XN-E4Kgo.js";
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry } from "./types-DoeN-uEF.js";
import { u as InboundEventKind } from "./templating-CZDTHJRv.js";
import { i as OpenClawConfig } from "./types.openclaw-xtiDgbrd.js";
import { M as MemoryCitationsMode } from "./types.tools-CGvqp937.js";
import { o as ModelCompatConfig } from "./types.models-C597Wbu7.js";
import { s as AuthProfileStore } from "./types-ESoOnEL7.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { $l as ProviderRuntimePluginHandle, Ba as PreemptiveCompactionRoute, Ei as CodexAppServerExtensionFactory, Gi as AgentToolResultMiddlewareContext, Ki as AgentToolResultMiddlewareEvent, Oi as CodexAppServerToolResultEvent, Ql as ProviderRuntimeModel, Ra as EmbeddedRunAttemptParams, Ti as CodexAppServerExtensionContext, To as TranscriptRewriteResult, Ua as AgentRuntimePlan, Va as NormalizedUsage, Wa as BuildAgentRuntimePlanParams, Wi as AgentToolResultMiddleware, Za as requestDeferredPluginToolApproval, Zi as OpenClawAgentToolResult, _o as ContextEnginePromptCacheInfo, bc as ModelAuthMode, dc as ExecToolDefaults, ei as ProcessToolDefaults, lo as CompactResult, nc as EmbeddedRunTrigger, qa as ToolOutcomeObserver, so as AssembleResult, uo as ContextEngine, vo as ContextEngineRuntimeContext, za as EmbeddedRunAttemptResult } from "./types-Tcpca_5M.js";
import { r as SkillSnapshot } from "./types-CiLRlEQW.js";
import { s as SandboxFsBridge } from "./backend-handle.types-CSIpH53U.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-c5mRZYEt.js";
import { n as FailoverReason, t as EmbeddedContextFile } from "./types-CMKgUJ7Q.js";
import { a as WorkspaceBootstrapFile } from "./internal-hook-types-CKIMi9vm.js";
import { r as AnyAgentTool } from "./common-BmK5s-nt.js";
import { Dr as ToolDefinition } from "./index-C8SgRuct.js";
import { t as SubsystemLogger } from "./subsystem-Boo2DQIV.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, u as PluginHookAgentContext } from "./hook-types-C-yXhapS.js";
import { t as BundleMcpDiagnostic } from "./bundle-mcp-DABlFCpS.js";
import { s as EmbeddedAgentQueueMessageOptions } from "./runs-B7_3nHXX.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DvupTznf.js";
import { P as SandboxContext } from "./sandbox-BWP9JsJd.js";
...
//#endregion
export { RuntimeToolSchemaDiagnostic as $, buildHarnessContextEngineRuntimeContext as A, log as At, SessionWriteLockAcquireTimeoutConfig as B, registerNativeHookRelay as Bt, formatPrePromptPrecheckLog as C, listNodes as Ct, resolveCompactionTimeoutMs as D, callGatewayTool as Dt, compactWithSafetyTimeout as E, NodeListNode as Et, createAgentToolResultMiddlewareRunner as F, NativeHookRelayProvider as Ft, resolveBootstrapContextForRun as G, resolveSessionWriteLockAcquireTimeoutMs as H, testing as Ht, createCodexAppServerToolResultExtensionRunner as I, NativeHookRelayRegistrationHandle as It, hasSandboxBindReadonlyHostShadows as J, resolveBootstrapFilesForRun as K, resolveAgentHarnessBeforePromptBuildResult as L, buildNativeHookRelayCommand as Lt, finalizeHarnessContextEngineTurn as M, buildAgentHookContextChannelFields as Mt, isActiveHarnessContextEngine as N, NativeHookRelayEvent as Nt, assembleHarnessContextEngine as O, classifyEmbeddedAgentRunResultForModelFallback as Ot, runHarnessContextEngineMaintenance as P, NativeHookRelayProcessResponse as Pt, normalizeAgentRuntimeTools as Q, runAgentHarnessAfterCompactionHook as R, hasNativeHookRelayInvocation as Rt, estimateRenderedLlmBoundaryTokenPressure as S, formatToolAggregate as St, compactContextEngineWithSafetyTimeout as T, selectDefaultNodeFromList as Tt, resolveSessionWriteLockOptions as U, CodexBundleMcpThreadConfig as Ut, acquireSessionWriteLock as V, resolveNativeHookRelayDeferredToolApproval as Vt, buildBootstrapContextForFiles as W, LoadCodexBundleMcpThreadConfigParams as Wt, normalizeProviderToolSchemas as X, resolveWritableSandboxBindHostRoots as Y, logAgentRuntimeToolDiagnostics as Z, runAgentHarnessAfterToolCallHook as _, filterToolResultMediaUrls as _t, classifyAgentHarnessTerminalOutcome as a, disposeRegisteredAgentHarnesses as at, PREEMPTIVE_OVERFLOW_ERROR_TEXT as b, isMessagingTool as bt, inferToolMetaFromArgs as c, createOpenClawCodingTools as ct, awaitAgentHarnessAgentEndHook as d, resolveAttemptSpawnWorkspaceDir as dt, filterProviderNormalizableTools as et, getAgentHarnessHookRunner as f, resolveAttemptFsWorkspaceOnly as ft, runAgentHarnessLlmOutputHook as g, extractToolResultMediaArtifact as gt, runAgentHarnessLlmInputHook as h, supportsModelTools as ht, ToolProgressDetailMode as i, projectRuntimeToolInputSchema as it, buildHarnessContextEngineRuntimeContextFromUsage as j, runAgentCleanupStep as jt, bootstrapHarnessContextEngine as k, buildAgentRuntimePlan as kt, loadCodexBundleMcpThreadConfig as l, getPluginToolMeta as lt, runAgentHarnessBeforeAgentFinalizeHook as m, buildSkillWorkshopPromptSection as mt, AgentHarnessTerminalOutcomeInput as n, RuntimeToolInputSchemaJson as nt, detectAndLoadAgentHarnessPromptImages as o, applyEmbeddedAttemptToolsAllow as ot, runAgentHarnessAgentEndHook as p, SKILL_WORKSHOP_TOOL_NAME as pt, hasSandboxBindContainerPathAliases as q, TOOL_PROGRESS_OUTPUT_MAX_CHARS as r, RuntimeToolInputSchemaProjection as rt, formatToolProgressOutput as s, resolveEmbeddedAttemptToolConstructionPlan as st, AgentHarnessTerminalOutcomeClassification as t, inspectRuntimeToolInputSchemas as tt, queueAgentHarnessMessage as u, buildEmbeddedAttemptToolRunContext as ut, runAgentHarnessBeforeMessageWriteHook as v, isToolResultError as vt, shouldPreemptivelyCompactBeforePrompt as w, resolveNodeIdFromList as wt, PreemptiveCompactionDecision as x, isMessagingToolSendAction as xt, LlmBoundaryTokenPressure as y, sanitizeToolResult as yt, runAgentHarnessBeforeCompactionHook as z, invokeNativeHookRelay as zt };