...
import { G as resolveMemoryDeepDreamingConfig, K as resolveMemoryDreamingConfig, X as resolveMemoryLightDreamingConfig, Y as resolveMemoryDreamingWorkspaces, Z as resolveMemoryRemDreamingConfig, q as resolveMemoryDreamingPluginConfig } from "./dreaming-BqjvzsgF.js";
import { r as getActiveMemorySearchManager } from "./memory-runtime-D5cMIC5F.js";
import { a as previewRemHarness, c as removeGroundedShortTermCandidates, i as previewGroundedRemMarkdown, l as repairDreamingArtifacts, n as dedupeDreamDiaryEntries, r as loadShortTermPromotionDreamingStats, s as removeBackfillDiaryEntries, u as writeBackfillDiaryEntries } from "./memory-core-bundled-runtime-D5XnVU30.js";
import { t as formatError } from "./server-utils-Co-s4JxP.js";
import { t as normalizeTrimmedString } from "./record-shared-BFsRS6nC.js";
...
const doctorHandlers = {
	...
	"doctor.memory.dreamDiary": async ({ respond, context, params }) => {
		const cfg = context.getRuntimeConfig();
		const agentId = (typeof params?.agentId === "string" ? normalizeAgentId(params.agentId) : null) || resolveDefaultAgentId(cfg);
		respond(true, {
			agentId,
