...
function registerWorkboardCli(params) {
	...
	workboard.command("list").description("List Workboard cards").option("--board <id>", "Board id").option("--status <status>", "Filter by status").option("--json", "Print JSON", false).action(async (options) => {
