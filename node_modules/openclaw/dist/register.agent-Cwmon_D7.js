...
import { t as registerAgentTurnCommand } from "./register.agent-turn-C5-FWynB.js";
//#region src/cli/program/register.agent.ts
let agentsBindModulePromise;
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-Cw2b652g.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-B7YiUxkq.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-Cn3nIZrt.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-DSQejM6o.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-B-Wq897O.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-Dc6wmxIA.js"), import("./cli-utils-mR2y6FIF.js")]);
	return {
		defaultRuntime,
...
//#endregion
export { registerAgentCommands, registerAgentsCommands };
