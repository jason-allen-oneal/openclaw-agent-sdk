import { P as timestampMsToIsoString, v as parseStrictInteger } from "./number-coercion-CJQ8TR--.js";
...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-DGoSUVUX.js";
import { n as matrixSetupAdapter } from "./setup-core-e7xX4-Dy.js";
import { t as withResolvedActionClient } from "./client-hCoyxEQI.js";
import { r as resolveMatrixAuthContext } from "./config-s2nn_-4X.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DyDu2wjA.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CI5e2wud.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CDF9_3QI.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-CWNXZXH3.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-CCVVlEGY.js");
