import { i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot, xn as SilentReplyConversationType } from "./types.openclaw-DNb3tRUE.js";
import { t as ChatType } from "./chat-type-B6XXSSnm.js";
import { o as AgentModelConfig } from "./types.provider-request-D8-dJlQu.js";
import { M as SessionScope, O as SessionMaintenanceMode, d as ContextVisibilityMode, v as HumanDelayConfig } from "./types.base-D238NWJT.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-B4wsBCxd.js";
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-CT04vGc_.js";
import { E as ThinkingLevel, b as StreamFn, f as Model, l as ImageContent, n as Api, r as AssistantMessage } from "./types-Boa_mcGH.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-Nc1Z-tAz.js";
import { d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, p as UnifiedModelCatalogKind } from "./manifest-registry-Cm9_Td_q.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-Dnz_NArb.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-BwYY6vxH.js";
import { g as ConfigMutationBase, w as ConfigReplaceResult } from "./config-D1S9aLDX.js";
import { y as resolveStateDir } from "./paths-Ddyy2SwV.js";
...
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-Kai3Qa6I.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as ElevatedLevel, f as ReasoningLevel, g as VerboseLevel, h as TraceLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-Vy4CRqJx.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode, h as InputProvenance, m as UserTurnTranscriptRecorder, n as GetReplyOptions, o as TypingController, r as PartialReplyPayload, s as ReplyPayload } from "./types-DpaP82Xu.js";
import { Er as AgentTool, Hr as StreamFn$1, kr as AgentToolResult, wr as AgentMessage } from "./index-CB3EOAcX.js";
import { a as CommandTurnKind, d as InboundEventKind, i as CommandTurnContext, n as MsgContext, t as FinalizedMsgContext } from "./templating-DRZbFvJc.js";
import { a as TaskDeliveryStatus, c as TaskRegistrySummary, d as TaskScopeKind, f as TaskStatus, h as CommandQueueEnqueueFn, i as TaskDeliveryState, l as TaskRuntime, m as TaskTerminalOutcome, n as TaskFlowRecord, o as TaskNotifyPolicy, p as TaskStatusCounts, r as TaskFlowStatus, s as TaskRecord, t as JsonValue, u as TaskRuntimeCounts } from "./task-flow-registry.types-CIM-g_Wc.js";
import { i as SkillTelemetrySource, r as SkillSnapshot, t as SkillCommandSpec } from "./types-CiLRlEQW.js";
...
import { a as SessionContextBudgetStatus, c as SessionSystemPromptReport, n as GroupKeyResolution, o as SessionEntry, s as SessionScope$1, t as CliSessionBinding } from "./types-DA9fh5UN.js";
...
import { r as AnyAgentTool } from "./common-BYJ5YAFM.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-BRtP0qWb.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-BIKbx2Sy.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-DjZBWWpS.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { C as ResolvedProviderAuth } from "./model-auth-B3D9e3u-.js";
...
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-Dt_RavwV.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-DGRv-1v-.js";
import { _ as resolveSessionFilePath, a as patchSessionEntry, b as resolveStorePath, d as updateSessionStoreEntry, f as upsertSessionEntry, i as listSessionEntries, m as loadSessionStore, r as getSessionEntry, u as updateSessionStore } from "./session-key-DMcLfgDg.js";
import { f as MediaUnderstandingProvider } from "./types-8HC48g70.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-B296ZCMm.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-C6bgrHSs.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-DuwOreY6.js";
...
import { n as GatewayRequestHandler, x as SecretInputMode } from "./types-CK_Ks-6C.js";
import { a as onAgentEvent, n as AgentEventPayload, r as AgentEventStream } from "./agent-events-CxC-24IA.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { t as HookEntry } from "./types-BCpQVPCb.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-Cy4qcX5-.js";
import { P as MessageReceipt } from "./types-CZCi_t0r.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-CIfQOxhj.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-CKqYjcaE.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-Bjyq6ufc.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-BOzwHdT7.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, an as PluginHookBeforeToolCallResult, cn as ReplyDispatchRuntimeInfo, ln as ReplyDispatcher, on as ReplyDispatchBeforeDeliver, pn as PluginHookBeforeAgentStartResult, qt as PluginJsonValue, rn as PluginApprovalResolution, sn as ReplyDispatchKind, tt as PluginHookName } from "./hook-types-BVPoA3Lu.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin } from "./types.plugin-CvZqMXJy.js";
import { Wt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-oKqMLldF.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-C__ZZNdY.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-bFh6wCwa.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-BnvyyWBp.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-C9uZ0A1B.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-D2Jcz2e4.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-_IR7dLbh.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-C1FPcl8T.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-Bqu_Swiq.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-kXHKWPK2.js";
import { t as buildPairingReply } from "./pairing-messages-Djq6PbXJ.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-B0a_vkEZ.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-GwB1Jq5q.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-ksq8_S_F.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-DbPlSxWE.js";
...
//#endregion
export { OpenClawPluginService as $, isToolWrappedWithBeforeToolCallHook as $a, OpenClawAgentToolResult as $i, PluginRuntime as $n, resolveEffectiveTtsConfig as $o, CommandSessionMetadataChange as $r, WebSearchProviderToolExecutionContext as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessCompactParams as Aa, ProviderThinkingProfile as Ac, CodexAppServerToolResultEvent as Ai, ProviderResolvePromptOverlayContext as An, LlmCompleteCaller as Ao, ConversationFacts as Ar, ChannelIngressQueueClaim as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, EmbeddedRunAttemptParams as Ba, EmbeddedAgentCompactResult as Bc, CliBackendResolveExecutionArgsContext as Bi, ProviderTransportTurnState as Bn, PluginRuntimeTaskRuns as Bo, formatInboundEnvelope as Br, PluginWebSearchProviderEntry as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, RealtimeTranscriptionProviderResolveConfigContext as Ca, prepareSimpleCompletionModel as Cc, PluginSessionTurnUnscheduleByTagParams as Ci, ProviderReplaySanitizeMode as Cn, IngestBatchResult as Co, AccessFacts as Cr, ResolvedProviderRuntimeAuth as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, AgentHarness as Da, provider_runtime_d_exports as Dc, CodexAppServerExtensionContext as Di, ProviderResolveAuthProfileIdContext as Dn, TranscriptRewriteReplacement as Do, ChannelTurnRecordOptions as Dr, OpenClawPluginToolFactory as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, RealtimeTranscriptionSessionCreateRequest as Ea, augmentModelCatalogWithProviderPlugins as Ec, PluginTrustedToolPolicyRegistration as Ei, ProviderReplayToolCallIdMode as En, SubagentSpawnPreparation as Eo, ChannelTurnDroppedHistoryOptions as Er, OpenClawPluginToolContext as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, AgentHarnessSideQuestionParams as Fa, ProviderExternalOAuthProfile as Fc, CliBackendNormalizeConfigContext as Fi, ProviderRuntimeProviderConfig as Fn, PluginRuntimeCore as Fo, SupplementalContextFacts as Fr, ChannelIngressQueuePruneOptions as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, AgentRuntimePlan as Ga, HEARTBEAT_RESPONSE_TOOL_NAME as Gc, PluginTextTransforms as Gi, RealtimeTranscriptionProviderPlugin as Gn, TaskFlowView as Go, DispatchReplyWithBufferedBlockDispatcher$1 as Gr, WebFetchProviderToolDefinition as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, PreemptiveCompactionRoute as Ha, EmbeddedAgentRunResult as Hc, CliBackendThinkingLevel as Hi, ProviderValidateReplayTurnsContext as Hn, DetachedTaskFinalizeParams as Ho, resolveEnvelopeFormatOptions as Hr, WebFetchProviderContext as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSideQuestionResult as Ia, ProviderResolveExternalAuthProfilesContext as Ic, CliBackendPlugin as Ii, ProviderSanitizeReplayHistoryContext as In, RuntimeLogger as Io, ChannelBotLoopProtectionFacts as Ir, ChannelIngressQueueRecord as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, DeferredPluginToolApproval as Ja, AgentToolResultMiddlewareEvent as Ji, TranscriptSourceProvider as Jn, TaskRunDetail as Jo, ReplyDispatcherWithTypingOptions as Jr, WebSearchProviderContext as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, BuildAgentRuntimePlanParams as Ka, HeartbeatToolResponse as Kc, AgentToolResultMiddleware as Ki, RealtimeVoiceProviderPlugin as Kn, TaskRunAggregateSummary as Ko, DispatchReplyWithDispatcher as Kr, WebFetchRuntimeMetadataContext as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, AgentHarnessSupport as La, ProviderResolveExternalOAuthProfilesContext as Lc, CliBackendPrepareExecutionContext as Li, ProviderSystemPromptContributionContext as Ln, BoundTaskFlowsRuntime as Lo, recordChannelBotPairLoopAndCheckSuppression as Lr, emitSessionTranscriptUpdate as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessDeliveryDefaults as Ma, ProviderRuntimePluginHandle as Mc, CliBackendAuthEpochMode as Mi, ProviderResolveUsageAuthContext as Mn, LlmCompleteParams as Mo, InboundMediaFacts as Mr, ChannelIngressQueueCompletedRecord as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, AgentHarnessResetParams as Na, ProviderSystemPromptContribution as Nc, CliBackendExecutionMode as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, LlmCompleteResult as No, PreparedChannelTurn as Nr, ChannelIngressQueueEnqueueResult as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, AgentHarnessAttemptParams as Oa, ProviderDefaultThinkingPolicyContext as Oc, CodexAppServerExtensionFactory as Oi, ProviderResolveDynamicModelContext as On, TranscriptRewriteRequest as Oo, ChannelTurnResult as Or, OpenClawPluginToolOptions as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, AgentHarnessResultClassification as Pa, ProviderExternalAuthProfile as Pc, CliBackendNativeToolMode as Pi, ProviderResolvedUsageAuth as Pn, LlmCompleteUsage as Po, RunChannelTurnParams as Pr, ChannelIngressQueueFailedRecord as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, hasBeforeToolCallPolicy as Qa, AgentToolResultMiddlewareRuntime as Qi, CreatePluginRuntimeOptions as Qn, TtsConfigResolutionContext as Qo, GetReplyFromConfig as Qr, WebSearchProviderToolDefinition as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, AgentHarnessSupportContext as Ra, ProviderResolveSyntheticAuthContext as Rc, CliBackendPreparedExecution as Ri, ProviderToolSchemaDiagnostic as Rn, BoundTaskRunsRuntime as Ro, EnvelopeFormatOptions as Rr, onSessionTranscriptUpdate as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionProviderId as Sa, completeWithPreparedSimpleCompletionModel as Sc, PluginSessionTurnScheduleParams as Si, ProviderReplayPolicyContext as Sn, ContextEngineRuntimeContext as So, resolveChannelInboundSupplementalContext as Sr, TtsDirectiveParseResult as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, RealtimeTranscriptionSessionCallbacks as Ta, resolveSimpleCompletionSelectionForAgent as Tc, PluginToolMetadataRegistration as Ti, ProviderReplaySessionState as Tn, SubagentEndReason as To, ChannelTurnAdmission as Tr, OpenClawPluginHookOptions as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, NormalizedUsage as Ua, MessagingToolSend as Uc, CliBundleMcpMode as Ui, ProviderWebSocketSessionPolicy as Un, DetachedTaskLifecycleRuntime as Uo, finalizeInboundContext as Ur, WebFetchProviderId as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, EmbeddedRunAttemptResult as Va, EmbeddedAgentRunMeta as Vc, CliBackendSideQuestionToolMode as Vi, ProviderUsageAuthToken as Vn, PluginRuntimeTasks as Vo, formatInboundFromLabel as Vr, WebFetchCredentialResolutionSource as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, normalizeUsage as Wa, MessagingToolSourceReplyPayload as Wc, PluginTextReplacement as Wi, ProviderWrapStreamFnContext as Wn, TaskFlowDetail as Wo, settleReplyDispatcher as Wr, WebFetchProviderPlugin as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, ToolOutcomeObserver as Xa, AgentToolResultMiddlewareOptions as Xi, UnifiedModelCatalogProviderPlugin as Xn, ResolvedTtsConfig as Xo, createReplyDispatcherWithTyping as Xr, WebSearchProviderPlugin as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, HookContext as Ya, AgentToolResultMiddlewareHarness as Yi, UnifiedModelCatalogProviderContext as Yn, TaskRunView as Yo, createReplyDispatcher as Yr, WebSearchProviderId as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, getBeforeToolCallPolicyDiagnosticState as Za, AgentToolResultMiddlewareResult as Zi, VideoGenerationProviderPlugin as Zn, ResolvedTtsModelOverrides as Zo, DispatchFromConfigResult as Zr, WebSearchProviderSetupContext as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceTool as _a, ExecToolDefaults as _c, PluginSessionAttachmentResult as _i, ProviderPrepareRuntimeAuthContext as _n, ContextEngineInfo as _o, FinalizeChannelInboundContextResult as _r, SpeechSynthesisStreamResult as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeCallbacks as aa, resolveAgentTimeoutMs as ac, ProviderResolveConfigApiKeyContext as ai, ProviderNormalizeToolSchemasContext as an, resolveEmbeddedAgentRuntime as ao, hasVisibleChannelTurnDispatch as ar, SpeechModelOverridePolicy as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderConfig as ba, PreparedSimpleCompletionModelForAgent as bc, PluginSessionSchedulerJobHandle as bi, ProviderReasoningOutputModeContext as bn, ContextEngineProjection as bo, filterChannelInboundSupplementalContext as br, SpeechVoiceOption as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, RealtimeVoiceBrowserSession as ca, RunEmbeddedAgentParams as cc, PluginAgentEventSubscriptionRegistration as ci, ProviderPlugin as cn, registerContextEngine as co, DurableInboundReplyDeliveryParams as cr, SpeechProviderId as cs, PluginCommandResult as ct, MigrationItemKind as d, RealtimeVoiceProviderCapabilities as da, OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE as dc, PluginRunContextPatch as di, ProviderPluginWizard as dn, AssembleResult as do, BuildChannelInboundEventContextAsyncParams as dr, SpeechProviderPreparedSynthesis as ds, PluginEmbeddingProvider as dt, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as ea, WebSearchRuntimeMetadataContext as ec, CommandContext as ei, ProviderModernModelPolicyContext as en, requestDeferredPluginToolApproval as eo, SubagentRunParams as er, TTS_AUTO_MODES as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, RealtimeVoiceProviderConfig as fa, BlockReplyChunking as fc, PluginRuntimeLifecycleRegistration as fi, ProviderPluginWizardModelPicker as fn, BootstrapResult as fo, BuildChannelInboundEventContextParams as fr, SpeechProviderResolveConfigContext as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, RealtimeVoiceRole as ga, ExecElevatedDefaults as gc, PluginSessionAttachmentParams as gi, ProviderPrepareExtraParamsContext as gn, ContextEngineHostRequirements as go, FinalizeChannelInboundContextParams as gr, SpeechSynthesisStreamRequest as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, RealtimeVoiceProviderResolveConfigContext as ha, ClientToolDefinition as hc, PluginSessionActionResult as hi, ProviderPrepareDynamicModelContext as hn, ContextEngineHostCapability as ho, FinalizeChannelInboundContextAsyncParams as hr, SpeechSynthesisRequest as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeVoiceBridge as ia, GenerateImageRuntimeResult as ic, ProviderNormalizeConfigContext as ii, ProviderNormalizeResolvedModelContext as in, AgentHarnessTaskRuntimeScope as io, hasFinalChannelTurnDispatch as ir, SpeechListVoicesRequest as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, AgentHarnessCompactResult as ja, ProviderRuntimeModel as jc, CodexAppServerToolResultHandlerResult as ji, ProviderResolveTransportTurnStateContext as jn, LlmCompleteMessage as jo, DispatchedChannelTurnResult as jr, ChannelIngressQueueClaimRef as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, AgentHarnessAttemptResult as ka, ProviderThinkingPolicyContext as kc, CodexAppServerExtensionRuntime as ki, ProviderResolveNonInteractiveApiKeyParams as kn, TranscriptRewriteResult as ko, CommandFacts as kr, ChannelIngressQueue as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, RealtimeVoiceBrowserSessionCreateRequest as la, PromptMode as lc, PluginControlUiDescriptor as li, ProviderPluginCatalog as ln, resolveContextEngine as lo, DurableInboundReplyDeliveryResult as lr, SpeechProviderOverrides as ls, PluginConfigMigration as lt, MigrationProviderContext as m, RealtimeVoiceProviderId as ma, AgentStreamParams as mc, PluginSessionActionRegistration as mi, ProviderPreferRuntimeResolvedModelContext as mn, ContextEngine as mo, ChannelInboundSupplementalResolutionOptions as mr, SpeechProviderResolveTalkOverridesContext as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeVoiceAudioFormat as na, GenerateVideoRuntimeResult as nc, ProcessToolDefaults as ni, ProviderNonInteractiveApiKeyResult as nn, setBeforeToolCallDiagnosticsEnabled as no, kernel_d_exports as nr, SpeechDirectiveTokenParseContext as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBridgeCreateRequest as oa, CurrentInboundPromptContext as oc, PluginAgentEventEmitParams as oi, ProviderNormalizeTransportContext as on, ContextEngineFactory as oo, resolveChannelTurnDispatchCounts as or, SpeechProviderConfig as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, RealtimeVoiceProviderConfiguredContext as pa, EmbeddedBlockChunker as pc, PluginSessionActionContext as pi, ProviderPluginWizardSetup as pn, CompactResult as po, BuiltChannelInboundEventContext as pr, SpeechProviderResolveTalkConfigContext as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, BeforeToolCallPolicyDiagnosticState as qa, normalizeHeartbeatToolResponse as qc, AgentToolResultMiddlewareContext as qi, SpeechProviderPlugin as qn, TaskRunCancelResult as qo, ReplyDispatcherOptions as qr, WebSearchCredentialResolutionSource as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBargeInOptions as ra, GenerateImageParams as rc, ProviderApplyConfigDefaultsContext as ri, ProviderNormalizeModelIdContext as rn, wrapToolWithBeforeToolCallHook as ro, recordDroppedChannelInboundHistory as rr, SpeechDirectiveTokenParseResult as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, RealtimeVoiceBridgeEvent as sa, EmbeddedRunTrigger as sc, PluginAgentEventEmitResult as si, ProviderOAuthProfileIdRepair as sn, ContextEngineFactoryContext as so, DurableInboundReplyDeliveryOptions as sr, SpeechProviderConfiguredContext as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as ta, GenerateVideoParams as tc, CommandHandler as ti, ProviderNonInteractiveApiKeyCredentialParams as tn, runBeforeToolCallHook as to, SubagentRunResult as tr, normalizeTtsAutoMode as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, RealtimeVoiceCloseReason as ua, AgentInternalEvent as uc, PluginRunContextGetParams as ui, ProviderPluginDiscovery as un, resolveContextEngineOwnerPluginId as uo, deliverInboundReplyWithMessageSendContext as ur, SpeechProviderPrepareSynthesisContext as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, RealtimeVoiceToolCallEvent as va, AgentSimpleCompletionSelection as vc, PluginSessionExtensionProjection as vi, ProviderPreparedRuntimeAuth as vn, ContextEngineMaintenanceResult as vo, buildChannelInboundEventContext as vr, SpeechSynthesisTarget as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSession as wa, prepareSimpleCompletionModelForAgent as wc, PluginSessionTurnUnscheduleByTagResult as wi, ProviderReplaySessionEntry as wn, IngestResult as wo, AssembledChannelTurn as wr, OpenClawPluginActiveModelContext as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderConfiguredContext as xa, SimpleCompletionModelOptions as xc, PluginSessionSchedulerJobRegistration as xi, ProviderReplayPolicy as xn, ContextEnginePromptCacheInfo as xo, finalizeChannelInboundContext as xr, TtsDirectiveOverrides as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeVoiceToolResultOptions as ya, PreparedSimpleCompletionModel as yc, PluginSessionExtensionRegistration as yi, ProviderReasoningOutputMode as yn, ContextEngineOperation as yo, filterChannelInboundQuoteContext as yr, SpeechTelephonySynthesisRequest as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, CompactEmbeddedAgentSessionParams as za, ProviderSyntheticAuthResult as zc, CliBackendResolveExecutionArgs as zi, ProviderTransformSystemPromptContext as zn, PluginRuntimeTaskFlows as zo, formatAgentEnvelope as zr, PluginWebFetchProviderEntry as zs, ProviderCatalogOrder as zt };