...
import { u as registerUncaughtExceptionHandler } from "./unhandled-rejections-ctoMIG3g.js";
import { _ as uniqueStrings } from "./string-normalization-WNUDCpXX.js";
import { t as loggingState } from "./state-CHRYWIGY.js";
import { s as setConsoleSubsystemFilter } from "./console-D8buipzn.js";
import { l as resolveAgentIdByWorkspacePath } from "./agent-scope-B4NxGkqZ.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, r as agentSessionKeysMatchByRequestKey, u as normalizeAgentId } from "./session-key-B_NoIfpX.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-CG8AzHpQ.js";
import "./config-BqCwA_DI.js";
import { n as extractAssistantVisibleText } from "./chat-message-content-CnGjfPsN.js";
import { n as modelKey } from "./model-ref-shared-CYEDNFte.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-0qbxeqMZ.js";
...
import { f as isAuthErrorMessage } from "./sanitize-user-facing-text-NOYqsmDF.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import "./usage-format-BPS8sDt6.js";
import { r as classifyFailoverReason } from "./errors-B4mplIiL.js";
import "./embedded-agent-helpers-CULGwdfn.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-zyc3C7Qo.js";
import { r as resolveSessionInfoModelSelection } from "./model-selection-display-FeptE3LP.js";
import "./commands-registry-ChZ74sL3.js";
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-DDw6htSU.js";
import { a as isChatStopCommandText } from "./chat-abort-wGseQqSt.js";
...
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-CpyUvHAd.js";
	...
	const sendMessage = async (text) => {
		...
		try {
			...
			if (!isBtw) {
				...
				const acceptedRunAlreadyCompleted = acceptedRunId !== runId && (consumeCompletedRunForPendingSend?.(acceptedRunId) ?? false);
				if (acceptedRunId !== runId) {
					forgetLocalRunId?.(runId);
					if (!acceptedRunAlreadyCompleted) noteLocalRunId?.(acceptedRunId);
					if (state.pendingSubmitDraft?.runId === runId) state.pendingSubmitDraft = isRunObserved?.(acceptedRunId) ? null : {
						runId: acceptedRunId,
						text
					};
...
function createSessionActions(context) {
	...
	const applySessionInfo = (params) => {
		...
		if (params.clearMissingUsage) {
			...
			if (entry?.totalTokens === void 0) next.totalTokens = null;
		}
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-CmxRwl1Z.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-BNvrNtAY.js");
	...
	const { handleChatEvent, handleAgentEvent, handleBtwEvent, pauseStreamingWatchdog, reconnectStreamingWatchdog, consumeCompletedRunForPendingSend, isRunObserved, flushPendingHistoryRefreshIfIdle } = createEventHandlers({
		chatLog,
		btw,
		tui,
		state,
...
//#endregion
export { createEditorSubmitHandler as C, resolveFinalAssistantText as E, stopTuiSafely as S, shouldEnableWindowsGitBashPasteFallback as T, resolveTuiFooterHostLabel as _, installTuiTerminalLossExitHandler as a, runTui as b, isTuiTerminalLossError as c, resolveGatewayDisconnectState as d, resolveInitialTuiAgentId as f, resolveTuiCtrlCAction as g, resolveLocalAuthSpawnOptions as h, drainAndStopTuiSafely as i, resolveCodexCliBin as l, resolveLocalAuthSpawnCwd as m, createBackspaceDeduper as n, isIgnorableTuiStopError as o, resolveLocalAuthCliInvocation as p, createDeferredTuiFinish as r, isTuiBusyActivityStatus as s, canSubmitTuiChatMessage as t, resolveCtrlCAction as u, resolveTuiSessionKey as v, createSubmitBurstCoalescer as w, scheduleProcessExitAfterTuiReturn as x, resolveTuiShutdownHardExitMs as y };
