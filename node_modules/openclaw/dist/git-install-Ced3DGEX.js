...
import { i as resolveDefaultPluginGitDir } from "./install-paths-D-sCLR1I.js";
...
import { n as preflightPluginGitInstallPolicy } from "./install-security-scan-Bg5MXS_K.js";
import { r as installPluginFromInstalledPackageDir, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-5B0zvvJg.js";
...
async function installPluginFromGitSpec(params) {
	...
	return await withTempDir("openclaw-git-plugin-", async (tmpDir) => {
		...
		if (preflight?.blocked) return buildBlockedGitInstallResult({ blocked: preflight.blocked });
		if (!params.dryRun) {
