...
import { P as timestampMsToIsoString, o as asDateTimestampMs } from "./number-coercion-CJQ8TR--.js";
...
import { n as detectRespawnSupervisor } from "./supervisor-markers-DaOHY-U2.js";
import { s as normalizeUpdateChannel } from "./update-channels-Cv-pxatM.js";
import { n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-E0hUHDz-.js";
import { t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-CGsG9zuq.js";
import { r as startManagedServiceUpdateHandoff } from "./update-managed-service-handoff-CJKtQDq6.js";
...
async function runGatewayUpdateCheck(params) {
	...
	let pendingAutoUpdateRestartDelayMs = null;
	...
	await writeState(statePath, nextState);
	if (pendingAutoUpdateRestartDelayMs !== null) scheduleGatewaySigusr1Restart({
