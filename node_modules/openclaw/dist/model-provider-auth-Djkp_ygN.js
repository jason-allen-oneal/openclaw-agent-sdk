import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DNJywrQV.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore, o as getRuntimeAuthProfileStoreSnapshot } from "./store-jnx0nhpN.js";
import "./auth-profiles-BeBRJlFs.js";
import { i as externalCliDiscoveryForProviders, r as externalCliDiscoveryForProviderAuth } from "./external-cli-discovery-Cr-vJMRB.js";
...
import { c as hasRuntimeAvailableProviderAuth, i as createRuntimeProviderAuthLookup, s as hasAvailableAuthForProvider } from "./model-auth-Aq6KQDp8.js";
...
async function warmCurrentProviderAuthState(cfg, options = {}) {
	...
	const snapshot = await buildCurrentProviderAuthStateSnapshot(cfg, { isCancelled: isWarmStale });
	if (isWarmStale()) return;
	if (options.isCancelled?.() || !isCurrentProviderAuthStateGeneration(ownGeneration)) return;
...
//#endregion
export { warmCurrentProviderAuthStateOffMainThread as a, warmCurrentProviderAuthState as i, createProviderAuthChecker as n, hasAuthForModelProvider as r, buildCurrentProviderAuthStateSnapshot as t };
