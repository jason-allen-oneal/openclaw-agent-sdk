...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-DNJywrQV.js";
import { u as readConfigFileSnapshot } from "./io-fQmSDfK-.js";
import "./config-BqCwA_DI.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-BV57VemT.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-L_caZNC2.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
