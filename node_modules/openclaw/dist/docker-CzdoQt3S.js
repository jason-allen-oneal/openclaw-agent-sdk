...
import { d as executeSqliteQuerySync, i as openOpenClawStateDatabase, o as runOpenClawStateWriteTransaction, p as getNodeSqliteKysely } from "./openclaw-state-db-J6qYHGxK.js";
...
import { s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-ITGG66tx.js";
import { i as acquireSessionWriteLock } from "./session-write-lock-C_veZd_6.js";
import { C as SANDBOX_REGISTRY_PATH, S as SANDBOX_CONTAINERS_DIR, _ as SANDBOX_AGENT_WORKSPACE_MOUNT, b as SANDBOX_BROWSER_REGISTRY_PATH, v as SANDBOX_BROWSERS_DIR } from "./constants-CPdgpBDI.js";
...
import { r as validateSandboxSecurity } from "./validate-sandbox-security-CiOAE1W1.js";
...
//#endregion
export { removeBrowserRegistryEntry as A, resolveSandboxScopeKey as C, migrateLegacySandboxRegistryFiles as D, inspectLegacySandboxRegistryFiles as E, updateBrowserRegistry as M, updateRegistry as N, readBrowserRegistry as O, computeSandboxBrowserConfigHash as P, resolveSandboxAgentId as S, slugifySessionKey as T, appendWorkspaceMountArgs as _, execDocker as a, resolveMaterializedSandboxSkillsWorkspaceDir as b, isDockerDaemonUnavailable as c, readDockerNetworkDriver as d, readDockerNetworkGateway as f, appendReadOnlyWorkspaceSkillMountArgs as g, resolveDockerSpawnInvocation as h, ensureSandboxContainer as i, removeRegistryEntry as j, readRegistry as k, readDockerContainerEnvVar as l, resolveDockerEnvPolicyEpoch as m, dockerContainerState as n, execDockerRaw as o, readDockerPort as p, ensureDockerImage as r, formatDockerDaemonUnavailableError as s, buildSandboxCreateArgs as t, readDockerContainerLabel as u, formatReadOnlyWorkspaceSkillMountHashState as v, resolveSandboxWorkspaceDir as w, resolveReadOnlyWorkspaceSkillMounts as x, isExistingWorkspaceSkillMountSource as y };
