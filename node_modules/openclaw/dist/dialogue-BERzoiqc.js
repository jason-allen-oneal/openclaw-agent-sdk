import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DPbhgx_1.js";
import { r as loadCrestodianOverview } from "./overview-Bs4s6Vxq.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-_ITkwkTO.js")).planCrestodianCommand)({
		input,
		overview
	});
