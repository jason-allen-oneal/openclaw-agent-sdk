...
import { p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-e049XCW0.js";
import { h as classifySystemdUnavailableDetail } from "./systemd-u5t9nViP.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { t as formatConfigIssueLine } from "./issue-format-RCKTtsD6.js";
import { a as resolveGatewaySupervisorLogPaths, i as resolveGatewayRestartLogPath } from "./restart-logs-BvZvRKQN.js";
import { a as isSystemdUnavailableDetail, i as resolveDaemonContainerContext, o as renderSystemdUnavailableHints, r as formatRuntimeStatus } from "./runtime-hints-CIlLGC9H.js";
import { r as isWSLEnv } from "./wsl-Bb_g7JpO.js";
import { a as filterDaemonEnv, d as resolveRuntimeStatusColor, f as safeDaemonEnv, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-BNjX5-jx.js";
import { t as formatGatewayRestartHandoffDiagnostic } from "./restart-handoff-C2IK7x54.js";
import { n as renderPortDiagnosticsForCli, r as resolvePortListeningAddresses, t as gatherDaemonStatus } from "./status.gather-B3dMyVWx.js";
import { i as renderGatewayServiceCleanupHints } from "./inspect-ClJK4pcR.js";
...
function printDaemonStatus(status, opts) {
	...
	if (drift && drift.drifts.length > 0) {
		...
		if (opts.deep) {
			...
			defaultRuntime.log(`${label("Fix:")} ${formatCliCommand("openclaw plugins update <plugin-id>")} for each drifted plugin, then ${formatCliCommand("openclaw gateway restart")}.`);
