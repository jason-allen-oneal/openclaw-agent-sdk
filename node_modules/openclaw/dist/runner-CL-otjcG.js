...
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, y as resolveModelRefFromString } from "./model-selection-shared-By-X2JmI.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DbnOMpU3.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-Mb3MbWfb.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-BgjJJ-7C.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-mNLtF_1v.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-L8jNk0J3.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BfCGHNbO.js");
