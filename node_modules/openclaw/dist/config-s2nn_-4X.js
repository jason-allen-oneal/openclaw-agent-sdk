...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-B6pb_3Jn.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-sZLyyYht.js";
import "./ssrf-runtime-6jmGUu53.js";
import "./retry-runtime-DmLJU7CJ.js";
import "./secret-input-runtime-C9NeYxvy.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BXPQMjjW.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-Gd1yKtzb.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CPbyJmHE.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BK0Yv-T7.js";
import { i as repairCurrentTokenStorageMetaDeviceId } from "./storage-DNinf5LW.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Bvk_Oddl.js"), import("./logging-CZMfOtY8.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-NjE2WgMD.js").then((credentialsReadModule) => ({
