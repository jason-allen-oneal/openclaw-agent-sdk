import { kt as AuthConfig } from "./types.openclaw-DNb3tRUE.js";
...
import { jt as ProviderAuthResult } from "./types-CahKt2JC.js";
...
declare const MAI_IMAGE_MODELS: readonly ["MAI-Image-2.5-Flash", "MAI-Image-2.5", "MAI-Image-2e", "MAI-Image-2"];
declare const MAI_DEFAULT_IMAGE_MODEL = "MAI-Image-2.5";
interface AzAccount {
  name: string;
  id: string;
  tenantId?: string;
...
//#endregion
export { normalizeFoundryEndpoint as A, supportsFoundryReasoningEffort as B, formatFoundryApiLabel as C, isFoundryProviderApi as D, isFoundryMaiImageModel as E, resolveFoundryApi as F, resolveFoundryModelCapabilities as I, resolveFoundryTargetProfileId as L, requiresFoundryMandatoryAdaptiveClaudeThinking as M, requiresFoundryMaxCompletionTokens as N, listConfiguredFoundryProfileIds as O, resolveConfiguredModelNameHint as P, supportsFoundryImageInput as R, extractFoundryEndpoint as S, isFoundryClaudeMythosPreview as T, usesFoundryResponsesByDefault as V, TOKEN_REFRESH_MARGIN_MS as _, AzDeploymentSummary as a, buildFoundryAuthResult as b, DEFAULT_API as c, FoundryProviderApi as d, FoundryResourceOption as f, PROVIDER_ID as g, MAI_IMAGE_MODELS as h, AzCognitiveAccount as i, requiresFoundryEntraIdClaudeAuth as j, mergeFoundryCanonicalModelParams as k, DEFAULT_GPT5_API as l, MAI_DEFAULT_IMAGE_MODEL as m, AzAccessToken as n, COGNITIVE_SERVICES_RESOURCE as o, FoundrySelection as p, AzAccount as r, CachedTokenEntry as s, ANTHROPIC_MESSAGES_API as t, FOUNDRY_ANTHROPIC_SCOPE as u, applyFoundryProfileBinding as v, isAnthropicFoundryDeployment as w, buildFoundryProviderBaseUrl as x, applyFoundryProviderConfig as y, supportsFoundryReasoningContent as z };