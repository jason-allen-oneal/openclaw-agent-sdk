...
function buildCurrentInboundPromptContextPrefix(context, options) {
	return (options?.preferResumableText === true ? context?.resumableText ?? context?.text : context?.text)?.trim() ?? "";
}
...
function buildCurrentInboundPrompt(params) {
	const prefix = buildCurrentInboundPromptContextPrefix(params.context, { preferResumableText: params.preferResumableText });
...
//#endregion
export { buildRuntimeEventSystemContext as a, buildRuntimeContextSystemContext as i, buildCurrentInboundPromptContextPrefix as n, resolveRuntimeContextPromptParts as o, buildRuntimeContextCustomMessage as r, buildCurrentInboundPrompt as t };
