...
import { O as runWithDiagnosticTraceContext, y as createDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-DTe7AQiu.js";
import { a as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING, r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, s as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, t as AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN } from "./auth-rate-limit-v6tnRQCM.js";
import { a as hasForwardedRequestHeaders, c as withSerializedRateLimitAttempt, i as authorizeWsControlUiGatewayConnect, l as checkBrowserOrigin, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-CtNgvH0N.js";
...
import { c as buildDeviceAuthPayloadV3, l as normalizeDeviceMetadataForAuth, s as buildDeviceAuthPayload } from "./client-C6EKqjh8.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-CEPJolq9.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-Dx39C4tw.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-BPk6svmE.js";
import { in as errorShape, rn as ErrorCodes } from "./schema-BwaBORnA.js";
import { F as validateConnectParams, Nt as validateRequestFrame, t as formatValidationErrors } from "./src-oj0IwW6K.js";
import { t as rawDataToString } from "./ws-C3qhmaFC.js";
import { d as updatePairedNodeMetadata, h as sameNodePermissionSurface, l as requestNodePairing, m as sameNodeApprovalSurfaceSet, n as beginNodePairingConnect, o as releaseNodePairingCleanupClaim, p as normalizeNodeApprovalSurfaceList, r as finalizeNodePairingCleanupClaim } from "./node-pairing-C8MBim3n.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-BEi9QZ6q.js";
...
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-B0N8Z4AB.js";
import { n as logWs, t as formatForLog } from "./ws-log-CqhS4yhs.js";
import { a as redeemDeviceBootstrapTokenProfile, d as isPairingSetupBootstrapProfile, l as verifyDeviceBootstrapToken, m as resolveBootstrapProfileScopesForRoles, n as getBoundDeviceBootstrapProfile, o as restoreDeviceBootstrapToken, p as resolveBootstrapProfileScopesForRole, r as getDeviceBootstrapTokenProfile, s as revokeDeviceBootstrapToken } from "./device-bootstrap-IZRNa9jY.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-DuJscx_Y.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Bp5l7wzu.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-Co-s4JxP.js";
import { r as upsertPresence } from "./system-presence-DylNVezb.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-DlUK3aCC.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-TJzWk9R_.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BF5EBU0h.js";
	...
	const handleMessage = async (data) => {
		...
		try {
				...
				if (device && devicePublicKey) {
					...
					const requirePairing = async (reason, existingPairedDevice = null) => {
						...
						if (pairing.request.silent === true) {
							approved = allowSilentBootstrapPairing && boundBootstrapProfile ? await approveBootstrapDevicePairing(pairing.request.requestId, boundBootstrapProfile, { accessMetadata: clientAccessMetadata }) : await approveDevicePairing(pairing.request.requestId, {
								callerScopes: scopes,
			...
			const dispatch = (async () => {
				const { handleGatewayRequest } = await import("./server-methods-DpO_jEIH.js");
