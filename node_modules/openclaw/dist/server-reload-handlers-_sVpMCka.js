...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-fA-EQXn-.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-CppiWLEI.js";
import { a as resetModelCatalogCache } from "./model-catalog-D05d2kfO.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { a as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-Djkp_ygN.js";
import { d as listActiveEmbeddedRunSessionIds, f as listActiveEmbeddedRunSessionKeys, u as getActiveEmbeddedRunCount } from "./run-state-DClKANFE.js";
import { a as refreshContextWindowCache } from "./context-CjnpdDgY.js";
import { u as getTotalQueueSize } from "./command-queue-DxRdA7fT.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CWuK_JIm.js";
import { r as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-runtime-B0D_K5RM.js";
import "./agent-bundle-mcp-tools-BGNF7jxG.js";
import { n as clearSecretsRuntimeSnapshot, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-HKQyjnAT.js";
import { r as resetDirectoryCache } from "./target-resolver-B7bDBPZW.js";
...
import { v as resolveHooksConfig } from "./hooks-DSqLHIFw.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BNk2IbH8.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-tSdC7nye.js";
...
import { t as buildGatewayCronService } from "./server-cron-CNixZIMh.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Cxz0tJ2a.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-D6mFs7hH.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-DXqe_qES.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-D9aesDMA.js"), import("./gmail-watcher-lifecycle-C0BNX5LB.js")]);
		...
		if (shouldRefreshContextWindowCache(plan)) await refreshContextWindowCache(nextConfig);
