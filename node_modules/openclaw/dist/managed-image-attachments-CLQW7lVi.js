...
import { f as readSessionMessagesWithSourceAsync, g as resolveSessionHistoryTranscriptPathAsync } from "./session-utils.fs-Y_TmTCGQ.js";
import { u as loadSessionEntry } from "./session-utils-CFmlVr6t.js";
import "./media-services-DE3J1qM-.js";
import { n as assertLocalMediaAllowed } from "./local-media-access-BBIXrR7P.js";
import { a as sendJson, o as sendMethodNotAllowed, s as sendMissingScopeForbidden } from "./http-common-B7U3wQMs.js";
import { d as resolveOpenAiCompatibleHttpSenderIsOwner, t as authorizeGatewayHttpRequestOrReply, u as resolveOpenAiCompatibleHttpOperatorScopes } from "./http-auth-utils-DAMcdY14.js";
...
async function getSessionManagedOutgoingAttachmentIndex(sessionKey, cache, agentId) {
	...
	const readResult = await readSessionMessagesWithSourceAsync(sessionId, storePath, entry.sessionFile, {
		mode: "full",
