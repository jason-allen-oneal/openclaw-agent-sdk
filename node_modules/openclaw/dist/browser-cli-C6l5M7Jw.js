...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-DYVPNJqV.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-Clbkc1EM.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { i as registerCommandGroups } from "./register-command-groups-CY13trGs.js";
import "./cli-runtime-CTEbMz4c.js";
import "./core-api-Dz-YGX8U.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-BO9qrbEU.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-suMHK04Z.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-CutNL3qv.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-CDXh4ZXi.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-BWXlY22G.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Bh2MPK7r.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
