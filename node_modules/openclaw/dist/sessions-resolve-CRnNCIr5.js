...
import { d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, i as filterAndSortSessionEntries, p as resolveDeletedAgentIdFromSessionKey, s as listSessionsFromStore } from "./session-utils-CFmlVr6t.js";
...
async function resolveSessionKeyFromResolveParams(params) {
	...
	if (hasKey) {
		...
		const agentCheckLegacy = validateSessionAgentExists(cfg, target.canonicalKey, migratedStore[target.canonicalKey], { acpMetadataSessionKey: target.canonicalKey });
