...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, m as mergeSsrFPolicies, x as ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist } from "./ssrf-CvPEXMGn.js";
import { o as withTrustedEnvProxyGuardedFetchMode, r as fetchWithSsrFGuard } from "./fetch-guard-BP-mcH2j.js";
import { r as sanitizeInlineImageDataUrl } from "./inline-image-data-url-CwAAaSvc.js";
import { F as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-Cp9BfFXg.js";
...
import { n as resolveProviderEndpoint } from "./provider-attribution-BnZEAmHB.js";
import { a as mergeModelProviderRequestOverrides, i as getModelProviderRequestTransport, l as resolveProviderRequestPolicyConfig, r as buildProviderRequestDispatcherPolicy } from "./provider-request-config-T3Lq57Ip.js";
import { t as redactIdentifier } from "./redact-identifier-CXp_wA0R.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-B9X9dB3H.js";
import { i as resolveModelBoundThinkingReplayMode, l as calculateCost } from "./sanitize-unicode-CgzZKr22.js";
...
import { a as resolveOpenAIReasoningEffortForModel, i as normalizeOpenAIReasoningEffort, n as isOpenAIGpt54MiniModel, o as supportsOpenAIReasoningEffort, r as isOpenAIGpt55Model, t as resolveOpenAIReasoningEffortMap } from "./openai-reasoning-compat-BZb-xoTp.js";
...
import { i as reconcileOpenAIResponsesToolChoice, n as projectOpenAITools, r as reconcileOpenAICompletionsToolChoice, t as clampOpenAIPromptCacheKey } from "./openai-prompt-cache-fygROe7S.js";
import { a as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-vl0D_wqS.js";
import { i as createReasoningTagTextPartitioner, t as convertMessages } from "./openai-completions-DCEsPPkI.js";
import { c as isResponsesTextContentPartType, i as resolveOpenAIStrictToolSetting, l as isResponsesTextDeltaEventType, n as normalizeOpenAIStrictToolParameters, r as resolveOpenAIStrictToolFlagForProjection, t as findOpenAIStrictToolProjectionDiagnostics } from "./openai-tool-schema-C7t-Si2L.js";
import { l as detectOpenAICompletionsCompat } from "./provider-model-compat-BTmON1Zk.js";
import { r as resolveDebugProxySettings } from "./env-ckWue_wY.js";
import { g as truncateErrorDetail, h as readResponseTextLimited, t as ProviderHttpError } from "./provider-http-errors-CylKzUqE.js";
import { n as ensureModelProviderLocalService } from "./provider-local-service-BLKACvxf.js";
...
async function processResponsesStream(openaiStream, output, stream, model, options) {
	...
	const appendCompletedResponseTextItem = (item) => {
		...
		const block = {
			type: "text",
			text,
			textSignature: encodeTextSignatureV1(stringifyUnknown(item.id), item.phase ?? void 0)
		};
	...
	const backfillCompletedResponseOutput = (response) => {
		...
		for (const rawItem of response.output) {
			...
			if (rawItem.type === "message") appendCompletedResponseTextItem(rawItem);
			else if (rawItem.type === "function_call") appendCompletedResponseToolCallItem(rawItem);
		}
	};
...
//#endregion
export { emitModelTransportDebug as S, resolveMaxTokensParam as _, coerceTransportToolCallArguments as a, flattenCompletionMessagesToStringContent as b, failTransportStream as c, sanitizeNonEmptyTransportPayloadText as d, sanitizeTransportPayloadText as f, canonicalizeMaxTokensParam as g, supportsModelTools as h, createOpenAIResponsesTransportStreamFn as i, finalizeTransportStream as l, buildGuardedModelFetch as m, createAzureOpenAIResponsesTransportStreamFn as n, createEmptyTransportUsage as o, transformTransportMessages as p, createOpenAICompletionsTransportStreamFn as r, createWritableTransportEventStream as s, buildOpenAICompletionsParams as t, mergeTransportHeaders as u, applyOpenAIResponsesPayloadPolicy as v, stripCompletionMessagesToRoleContent as x, resolveOpenAIResponsesPayloadPolicy as y };
