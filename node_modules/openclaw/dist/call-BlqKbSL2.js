...
import { d as resolveGatewayPort, f as resolveIncludeRoots, s as resolveConfigPath, y as resolveStateDir } from "./paths-mvMm5bYV.js";
...
import { a as trimToUndefined } from "./credential-planner-B30i7LWg.js";
import "./credentials-DohyZeAt.js";
import { f as isLoopbackIpAddress } from "./ip-0oQXo6_w.js";
import { n as resolveGatewayAuth } from "./auth-resolve-C0kiP8dc.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards } from "./includes-Cf57krG9.js";
...
import { a as isGatewayConnectAssemblyError, n as GatewayClient, u as loadDeviceAuthToken } from "./client-C6EKqjh8.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-CEPJolq9.js";
import { t as loadGatewayTlsRuntime } from "./gateway-cyLi5C4L.js";
...
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-BXo-qqkH.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-sViOS1mR.js";
import { a as isGatewayMethodClassified, t as CLI_DEFAULT_OPERATOR_SCOPES, u as resolveLeastPrivilegeOperatorScopesForMethod } from "./method-scopes-BtdN3y7s.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-Uvn7nZy5.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-MZVHbWrJ.js")).getRuntimeConfig();
	...
	return await new Promise((resolve, reject) => {
		...
		const client = gatewayCallDeps.createGatewayClient({
			...
			onConnectError: (err) => {
				...
				const shouldSurface = isGatewayConnectAssemblyError(err) || surfaceGatewayClientRequestErrors && isGatewayClientRequestError;
...
async function callGatewayWithScopes(opts, scopes) {
	...
	return await executeGatewayRequestWithScopes({
		...
		connectionDetails,
		deviceIdentity,
		surfaceGatewayClientRequestErrors: useStoredDeviceAuth || opts.requireLocalBackendSharedAuth === true
	});
}
