...
import { a as getResolvedLoggerSettings } from "./logger-563BnNMV.js";
...
import { t as danger } from "./globals-DbTJQTMp.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-fQmSDfK-.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-C8rQ5-HL.js";
import { i as replaceConfigFile } from "./config-BqCwA_DI.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-COoNML-C.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BzNekEY8.js";
import "./plugins-CbDXysvw.js";
import "./message-channel-Dx39C4tw.js";
import "./logging-tj8mDPYF.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-DdWak_DD.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-B0oSBWpB.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-D1kculJq.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BLGguEiN.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-DLbEk8Mn.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets--sBbmioM.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-DO5nSeNy.js";
...
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DMyzUaqC.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-DZMZaF9B.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CfZTP9iw.js";
import { n as resolveLogFile } from "./log-tail-CZjc6az3.js";
import { t as parseLogLine } from "./parse-log-line-BSO0Z-Rb.js";
import { t as describeBinding } from "./agents.binding-format-C3S9Mq5U.js";
import { t as applyAgentBindings } from "./agents.bindings-H0cYf1k5.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-EHg07X96.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BpFj6dJu.js";
import { t as channelsListCommand } from "./list-CdBSTPux.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-DIpOCtvv.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CofY457T.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-ByTCbf1b.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-CiJ3qwhO.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BrVzosDM.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DUWLlKcP.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Dx1hNJ9T.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CPNdzaZk.js");
