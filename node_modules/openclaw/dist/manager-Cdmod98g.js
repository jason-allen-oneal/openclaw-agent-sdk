...
import { t as getEmbeddingProvider } from "./embedding-provider-runtime-Vt-DsINg.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BeO2AZzO.js";
import "./routing-CqTr30kc.js";
import "./embedding-providers-DNi3besK.js";
import { r as listRegisteredMemoryEmbeddingProviderAdapters, t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-DKc2cKiP.js";
import "./memory-core-host-embedding-registry-DCjzTUH_.js";
import { u as enforceEmbeddingMaxInputTokens } from "./memory-core-host-engine-embeddings-D-IkEFyG.js";
import { r as retryTransientMemoryRead, t as hashText } from "./hash-VHZC2Zdf.js";
import { t as isFileMissingError } from "./fs-utils-B1JVxp36.js";
import { a as ensureDir, c as normalizeExtraMemoryPaths, d as runWithConcurrency, f as hasNonTextEmbeddingParts, i as cosineSimilarity, l as parseEmbedding, n as buildMultimodalChunkForIndexing, r as chunkMarkdown, s as listMemoryFiles, t as buildFileEntry, u as remapChunkLines } from "./internal-D6a5pr2X.js";
import "./memory-core-host-engine-foundation-BOHK8K3y.js";
import { l as buildSessionEntry, m as sessionPathForFile, u as listSessionFilesForAgent } from "./engine-qmd-ICS1F7nJ.js";
import "./memory-core-host-engine-qmd-B1dfFKlh.js";
import { n as readMemoryFile } from "./read-file-BLCgcGK_.js";
import { a as ensureMemoryIndexSchema, i as loadSqliteVecExtension, n as configureMemorySqliteWalMaintenance, r as requireNodeSqlite, t as closeMemorySqliteWalMaintenance } from "./engine-storage-CttdjEWY.js";
import "./memory-core-host-engine-storage-CC2gDibe.js";
import "./dreaming-shared-Co0y3swR.js";
...
async function swapMemoryIndexFiles(targetPath, tempPath, options = {}, afterPublish) {
	const resolvedOptions = resolveMemoryIndexFileOptions(options);
...
async function runMemoryAtomicReindex(params) {
	try {
		...
		await swapMemoryIndexFiles(params.targetPath, params.tempPath, params.fileOptions, params.afterPublish);
		return result;
	} catch (err) {
		try {
...
var MemoryManagerEmbeddingOps = class extends MemoryManagerSyncOps {
	...
	upsertEmbeddingCacheEntries(entries, provider = this.provider) {
		...
		if (this.embeddingCacheMirrorDb && this.embeddingCacheMirrorDb !== this.db) try {
			upsertMemoryEmbeddingCache({
			...
			log$2.warn("memory embeddings: failed to mirror safe-reindex cache batch", { error: formatErrorMessage(err) });
		}
	}
