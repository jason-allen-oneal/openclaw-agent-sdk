...
import { n as isAbortError } from "./unhandled-rejections-ctoMIG3g.js";
import { t as createLazyImportLoader } from "./lazy-promise-BONnzNfb.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { S as freezeDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, u as isDiagnosticsEnabled, v as createChildDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
import { t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { a as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-B4NxGkqZ.js";
import { f as resolveAgentIdFromSessionKey } from "./session-key-B_NoIfpX.js";
import { r as resolveAgentConfig } from "./agent-scope-config-DNJywrQV.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-CG8AzHpQ.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-DgKx6Dne.js";
import "./config-BqCwA_DI.js";
import { d as markReplyPayloadForSourceSuppressionDelivery, f as setReplyPayloadMetadata, i as getReplyPayloadMetadata, r as copyReplyPayloadMetadata, s as isReplyPayloadStatusNotice, t as appendReplyMediaFailureWarning } from "./reply-payload-CZJ2cgZc.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-D1oMTUUg.js";
import { d as getAgentEventLifecycleGeneration, h as registerAgentRunContext, i as clearAgentRunContext, n as captureAgentRunLifecycleGeneration, s as emitAgentEvent } from "./agent-events-C3fRM85v.js";
import { o as isAudioFileName } from "./mime-C8mVE2Bw.js";
import { o as normalizeDeliveryContext } from "./delivery-context.shared-BlmyB9yJ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-NEwU8m3X.js";
import { i as readSessionEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BEkoRRyW.js";
import { d as updateSessionStore, f as updateSessionStoreEntry, t as applySessionStoreEntryPatch } from "./store-Dcn5FSKd.js";
import { r as isInternalMessageChannel } from "./message-channel-Dx39C4tw.js";
import { c as resolveSessionPluginStatusLines, l as resolveSessionPluginTraceLines, s as resolveFreshSessionTotalTokens } from "./types-D8S_uNvu.js";
import { g as resolveSessionGoalDisplayState } from "./sessions-DieR2Eem.js";
import "./transcript-jsonl-CD0KPCG0.js";
import { i as modelKey, r as legacyModelKey } from "./model-selection-normalize-CBjx3j0e.js";
import { h as isCliProvider } from "./model-selection-CRIOhEQm.js";
import { c as estimateMessagesTokens } from "./compaction-planning-BD_0nYm1.js";
import { f as resolveModelAuthMode } from "./model-auth-Aq6KQDp8.js";
import { a as isAgentRunRestartAbortReason, o as resolveAgentRunAbortLifecycleFields } from "./run-termination-u49x3Tfg.js";
import { a as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-wBpPJDPa.js";
...
import { s as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-QdHceFYu.js";
import { d as sanitizeUserFacingText } from "./sanitize-user-facing-text-NOYqsmDF.js";
import { m as replyRunRegistry } from "./reply-run-registry-Ccw3Ogdy.js";
import { o as resolveCronJobsStorePath, t as loadCronJobsStore } from "./store-CGXhD-XE.js";
...
import { d as readSessionMessagesAsync } from "./session-utils.fs-Y_TmTCGQ.js";
...
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-BoQs4wK-.js";
...
import { i as resolveModelCostConfig, n as formatUsd, t as estimateUsageCost } from "./usage-format-BPS8sDt6.js";
import { n as resolveSendPolicy } from "./send-policy-Df9c4jHG.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DxRdA7fT.js";
import { i as resolveSandboxConfigForAgent } from "./config-DNVDYYhP.js";
...
import { a as resolveCliRuntimeExecutionProvider, r as isCliRuntimeAliasForProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-8oQxHspB.js";
import { d as stripHeartbeatToken } from "./heartbeat-CicGJ6Bb.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-Ncp4Uf5J.js";
import { a as generateSecureUuid } from "./secure-random-Ds4AFLgz.js";
import { d as hasVisibleAgentPayload } from "./subagent-announce-delivery-BdIxN0mb.js";
import { c as FollowupRunDeferredError, l as completeFollowupRunLifecycle, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession, u as isFollowupRunAborted } from "./queue-DgtGULP_.js";
import { n as resolveAgentIdentity } from "./identity-BZeCE1SF.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-Ba9PLuoj.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-0Mg-MzO4.js";
import "./embedded-agent-helpers-CULGwdfn.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-hELVbTZ3.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply--p-hLf3k.js";
import { o as runWithModelFallback } from "./model-fallback-CB6h6-6n.js";
import { c as setCliSessionId, n as clearCliSession, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-D_Cr4kxU.js";
import "./sandbox-C9REAclS.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-bmmzkOyn.js";
import "./tool-result-middleware-BUb-oCHG.js";
import { n as resolveEffectiveReplyRoute } from "./effective-reply-route-CMX4b9Bu.js";
import { t as runEmbeddedAgent } from "./embedded-agent-BgvyyCVT.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CQGCjyR6.js";
import { n as classifyCompactionReason } from "./compact-reasons-Di0yKRbB.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BvUOiCFf.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-rflhdBOv.js";
import { _ as keepCliSessionBindingOnlyWhenReused, a as buildKnownAgentRunFailureReplyPayload, c as resolveSessionRuntimeOverrideForProvider, d as createCompactionHookNoticePayload, f as createCompactionNoticePayload, g as createCliToolSummaryTracker, h as clearDroppedCliSessionBinding, i as resolveReplyTurnKind, l as runAgentTurnWithFallback, m as shouldNotifyUserAboutCompaction, n as recordReplyUsageState, o as buildPreflightCompactionFailureText, p as readCompactionHookMessages, r as admitReplyTurn, s as resolveRunAfterAutoFallbackPrimaryProbeRecheck, u as normalizeReplyPayloadDirectives, v as runCliAgentWithLifecycle } from "./reply-usage-state-iEobCi62.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DAROa9u0.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-BpOjFr83.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CaJ31McP.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-mFL5xdI9.js";
import { r as enqueueCommitmentExtraction } from "./runtime-Bh9LZ4CP.js";
import { t as resolveFastModeState } from "./fast-mode-Gt-xvstA.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BnR__Nva.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-BZXZZyYW.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-CdAv37Dn.js";
import { t as formatProviderModelRef } from "./model-runtime-CZ08KJDf.js";
import "./fallback-notice-state-B60WYkld.js";
import { n as incrementCompactionCount } from "./session-updates-B-kLWBr7.js";
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-MCTquNH9.js"));
...
async function buildReplyPayloads(params) {
	...
	const hasDirectlySentText = (payload) => {
		...
		const fragmentsByAssistantMessage = /* @__PURE__ */ new Map();
	...
	return async (queued) => {
		...
		try {
			...
			try {
				...
				if (isAgentRunRestartAbortReason(runAbortSignal.reason)) throw runAbortSignal.reason;
...
async function runReplyAgent(params) {
	...
	const persistRestartRecoveryDeliveryContext = async () => {
		...
		const persisted = await updateSessionStoreEntry({
			storePath,
			sessionKey,
			update: async (current) => current.sessionId === replyOperation.sessionId && current.abortedLastRun !== true ? patch : null
		});
		if (persisted) {
	...
	const clearRestartRecoveryDeliveryContext = async () => {
		...
		const persisted = await updateSessionStoreEntry({
			storePath,
			sessionKey,
			update: async (current) => current.sessionId === replyOperation.sessionId && current.abortedLastRun !== true && current.restartRecoveryDeliveryRunId === restartRecoveryDeliveryRunId ? patch : null
		});
		if (persisted) {
			activeSessionEntry = persisted;
			if (activeSessionStore) activeSessionStore[sessionKey] = persisted;
	...
	try {
		...
		const { runId, runResult, fallbackProvider, fallbackModel, fallbackAttempts, directlySentBlockKeys, directlySentBlockPayloads } = runOutcome;
		...
		let replyUsageState;
		{
			...
			replyUsageState = {
				provider: providerUsed,
				model: modelUsed,
				resolvedRef: winnerProvider && winnerModel ? `${winnerProvider}/${winnerModel}` : void 0,
				...
				requested: followupRun.run.provider && followupRun.run.model ? `${followupRun.run.provider}/${followupRun.run.model}` : void 0,
		...
		if (responseUsageMode !== "off" && hasNonzeroUsage(usage) && !preserveUserFacingSessionState) {
			...
			const usageTemplate = responseUsageMode === "full" && replyUsageState ? loadUsageBarTemplate(cfg.messages?.usageTemplate) : void 0;
			const renderedUsageLine = usageTemplate ? renderUsageBar(usageTemplate, buildUsageContract(replyUsageState, replyToChannel)) : void 0;
			if (renderedUsageLine) formatted = renderedUsageLine;
			else if (formatted && responseUsageMode === "full" && sessionKey) formatted = `${formatted} · session \`${sessionKey}\``;
		...
		if (sessionKey && storePath && finalPayloads.length > 0) {
			...
			if (resolvedPendingText) await applySessionStoreEntryPatch({
				...
				patch: {
					...
					pendingFinalDeliveryContext: resolveReplyRunDeliveryContext({
						cfg,
						sessionCtx,
						sessionEntry: activeSessionEntry,
						sessionKey,
