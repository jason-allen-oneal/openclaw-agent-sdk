...
import { r as resolveOutboundChannelPlugin, t as normalizeDeliverableOutboundChannel } from "./channel-resolution-C4vY1RVQ.js";
import { m as mapAllowFromEntries } from "./channel-config-helpers-lj5quus3.js";
import { n as resolveOutboundSessionRoute } from "./outbound-session-Dy1wAUKa.js";
import { i as resolveChannelTarget } from "./target-resolver-B7bDBPZW.js";
import { n as resolveOutboundTargetWithPlugin, t as resolveSessionDeliveryTarget } from "./targets-session-3dVh0b_8.js";
...
async function resolveHeartbeatDeliveryTargetWithSessionRoute(params) {
	...
	if (!resolveOutboundChannelPlugin({
		...
		cfg: params.cfg
	})?.messaging?.resolveOutboundSessionRoute) return delivery;
