import { h as shouldMigrateStateFromPath } from "./argv-BulIeC99.js";
...
import { r as withSuppressedNotes } from "./note-Cg11mIkK.js";
...
async function ensureConfigReady(params) {
	...
	const runStateMigrationPreflight = async () => {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-Dx6TZBd7.js")).runDoctorConfigPreflight({
			migrateState: true,
