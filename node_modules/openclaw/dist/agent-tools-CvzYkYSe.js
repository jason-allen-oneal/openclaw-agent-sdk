...
import { c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DNJywrQV.js";
import { a as logWarn } from "./logger-Bk5gMrQq.js";
import { t as bindAbortRelay } from "./fetch-timeout-BKtgQUmk.js";
...
import { a as resolveGatewayMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
import "./message-channel-Dx39C4tw.js";
import { P as createCodingTools, V as createReadTool } from "./sessions-C_fxanxf.js";
import { c as EXEC_TOOL_DISPLAY_SUMMARY, l as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-CJ8FQUeU.js";
import { a as collectExplicitDenylist, c as hasRestrictiveAllowPolicy, g as resolveToolProfilePolicy, h as normalizeToolName, i as collectExplicitAllowlist, l as mergeAlsoAllowPolicy, p as expandToolGroups, u as replaceWithEffectiveToolAllowlist } from "./tool-policy-BPywi0tl.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-sxySQZer.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-CPdgpBDI.js";
...
import { O as listChannelAgentTools, T as copyChannelAgentToolMeta, _ as wrapToolWithBeforeToolCallHook, a as copyBeforeToolCallHookMarker, p as rewrapToolWithBeforeToolCallHook, u as isToolWrappedWithBeforeToolCallHook } from "./agent-tools.before-tool-call-CsK6Ldwa.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-C-g0qnV5.js";
...
import { C as wrapToolWorkspaceRootGuardWithOptions, S as wrapToolWorkspaceRootGuard, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as resolveOpenClawPluginToolsForOptions, t as createOpenClawTools, v as createSandboxedEditTool, x as wrapToolMemoryFlushAppendOnlyWrite, y as createSandboxedReadTool } from "./openclaw-tools-50pm1WIW.js";
import { s as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-C1EZq5kS.js";
import { t as normalizeToolParameterSchema } from "./agent-tools-parameter-schema-kPd3U8Lr.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-CWuIAGVg.js";
import { n as resolveEventSessionRoutingPolicy } from "./event-session-routing-BKUkHfqC.js";
...
import "./codex-native-web-search-BM5U7fw6.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-C5IM2W3a.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-Cc0PVjtu.js";
import { x as resolveReadOnlyWorkspaceSkillMounts } from "./docker-CzdoQt3S.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-D2snGfUx.js";
...
function findEntry(catalog, id, options) {
	...
	if (!namedEntry) throw new ToolInputError(`Unknown tool id: ${needle}`);
	return namedEntry;
}
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-BB5OPOlm.js"));
...
//#endregion
export { isLocalModelLeanEnabled as C, filterLocalModelLeanTools as S, estimateToolSchemaDirectoryToolNames as _, TOOL_SEARCH_CODE_MODE_TOOL_NAME as a, resolveToolSearchConfig as b, addClientToolsToToolCatalog as c, applyToolSchemaDirectoryCatalog as d, applyToolSearchCatalog as f, createToolSearchCatalogRef as g, collectUniqueCatalogToolNames as h, TOOL_DESCRIBE_RAW_TOOL_NAME as i, addClientToolsToToolSearchCatalog as l, clearToolSearchCatalog as m, resolveProcessToolScopeKey as n, TOOL_SEARCH_RAW_TOOL_NAME as o, buildToolSchemaDirectoryPrompt as p, TOOL_CALL_RAW_TOOL_NAME as r, ToolSearchRuntime as s, createOpenClawCodingTools as t, applyToolCatalogCompaction as u, projectToolSearchTargetTranscriptMessages as v, resolveLocalModelLeanPreserveToolNames as w, applyLocalModelLeanToolSearchDefaults as x, resolveToolSearchCatalogTool as y };
