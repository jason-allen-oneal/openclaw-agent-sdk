...
import { s as upsertAuthProfileWithLock } from "./profiles-Bu3mimei.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-CYEDNFte.js";
import "./workspace-C9ULOsP_.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-wUwORg4s.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DOKMD0Cj.js";
import { n as t } from "./i18n-C0k1rM_n.js";
import { n as openUrl } from "./browser-open-BNUvSG1u.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-Dgdy7dRy.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CZQydcfK.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-XKvZUk7h.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-BtM4MDYv.js");
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-tEtD6TT0.js");
