...
import { a as findBracketedJsonPayloadStart, c as findXmlishToolCallEnd, d as matchesLiteralPrefix, i as consumeJsonToolClosingMarker, l as isPlainTextToolNameChar, o as findHarmonyJsonPayloadStart, s as findJsonObjectEnd, t as parseStandalonePlainTextToolCallBlocks, u as isXmlishNameChar } from "./payload-BgOaqAGo.js";
import { a as resolveOpenAIReasoningEffortForModel, t as resolveOpenAIReasoningEffortMap } from "./openai-reasoning-compat-BZb-xoTp.js";
import "./anthropic-payload-policy-gISaP6Qi.js";
import "./moonshot-thinking-BfT9bPO4.js";
...
function normalizeProviderDoneMessage(message, toolNames, matcher) {
	...
	(async () => {
		...
		try {
			const normalizedEvents = normalizePlainTextToolCallStreamEvents(source, {
				...
				matcher,
				normalizeDoneMessage: ({ message }) => normalizeProviderDoneMessage(message, toolNames, matcher),
				stopAfterDone: true
			});
...
//#endregion
export { streamWithPayloadPatch as C, scrubOverCapPlainTextToolCallMessage as D, normalizePlainTextToolCallStreamEvents as E, createZaiToolStreamWrapper as S, promoteStandalonePlainTextToolCallMessage as T, resolveGoogleGemini3ThinkingLevel as _, createGoogleThinkingStreamWrapper as a, stripTrailingAnthropicAssistantPrefillWhenThinking as b, createPlainTextToolCallCompatWrapper as c, isGoogleGemini25ThinkingBudgetModel as d, isGoogleGemini3FlashModel as f, isOpenAICompatibleThinkingEnabled as g, isGoogleThinkingRequiredModel as h, createGoogleThinkingPayloadWrapper as i, createThinkingOnlyFinalTextWrapper as l, isGoogleGemini3ThinkingLevelModel as m, createAnthropicThinkingPrefillPayloadWrapper as n, createOpenAICompatibleCompletionsThinkingOffWrapper as o, isGoogleGemini3ProModel as p, createDeepSeekV4OpenAICompatibleThinkingWrapper as r, createPayloadPatchStreamWrapper as s, composeProviderStreamWrappers as t, defaultToolStreamExtraParams as u, sanitizeGoogleThinkingPayload as v, extractStandalonePlainTextToolCallText as w, createToolStreamWrapper as x, stripInvalidGoogleThinkingBudget as y };
