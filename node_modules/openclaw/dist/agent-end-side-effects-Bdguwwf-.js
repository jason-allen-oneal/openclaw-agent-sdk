...
import { g as normalizeSkillIndexName } from "./workspace-D_2xSCx7.js";
import { a as proposeUpdateSkill, f as resolveSkillProposalTarget, i as proposeCreateSkill, p as readWorkspaceSkillFile, r as listSkillProposals } from "./service-C2jXhnmt.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-CLsHmY5H.js";
...
const log$1 = createSubsystemLogger("skills/research");
...
async function runSkillResearchAutoCapture(params) {
	...
	try {
		...
		log$1.info(`skill research auto-capture queued workshop proposal ${result.record.target.skillKey}`);
	} catch (error) {
		log$1.warn(`skill research auto-capture skipped: ${String(error)}`);
	}
}
//#endregion
...
//#endregion
export { runAgentEndSideEffects as n, awaitAgentEndSideEffects as t };
