...
import { i as redactSecrets } from "./redact-DN0dJKIU.js";
...
import { i as formatErrorMessage } from "./errors-CbY2H91D.js";
...
import { C as getActiveDiagnosticTraceContext, O as runWithDiagnosticTraceContext, S as freezeDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, t as areDiagnosticsEnabledForProcess, v as createChildDiagnosticTraceContext, x as formatDiagnosticTraceparent, y as createDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
import { t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { y as resolveSessionAgentIds } from "./agent-scope-B4NxGkqZ.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, r as isCronRunSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-DNJywrQV.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CjeTePSl.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-DXKcDDxT.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { i as getRuntimeConfig } from "./io-fQmSDfK-.js";
import { a as normalizeOptionalAgentRuntimeId, r as isDefaultAgentRuntimeId } from "./agent-runtime-id-DiL2DId7.js";
import { n as resolveAgentHarnessPolicy } from "./harness-runtimes-BbJCcEVN.js";
import "./defaults-mDjiWzE5.js";
import { r as createAssistantMessageEventStream } from "./event-stream-ReMmOTzX.js";
import "./config-BqCwA_DI.js";
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-DTahNL39.js";
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime.js";
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-CIjmr4bc.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-Ql0lsa-j.js";
import { b as createCodeModeNamespaceRuntime, x as describeCodeModeNamespacesForPrompt, y as createCodeModeApiVirtualFiles } from "./registry-B8gzOJBq.js";
import { f as setReplyPayloadMetadata } from "./reply-payload-CZJ2cgZc.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Quvi-RcW.js";
import { d as listImportedRuntimePluginIds, o as getActivePluginRegistry } from "./runtime-CjN6pXNK.js";
import { s as resolveContextEngineOwnerPluginId } from "./registry-DixvBrod.js";
import { a as emitAgentApprovalEvent, c as emitAgentItemEvent, l as emitAgentPatchSummaryEvent, o as emitAgentCommandOutputEvent, s as emitAgentEvent } from "./agent-events-C3fRM85v.js";
import { r as MAX_IMAGE_BYTES } from "./constants-Mf57IYS0.js";
import { u as resolveStorePath } from "./paths-NEwU8m3X.js";
import { t as loadSessionStore } from "./store-load-BEkoRRyW.js";
...
import { c as runQuotaSuspensionMaintenance, f as updateSessionStoreEntry } from "./store-Dcn5FSKd.js";
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
import "./message-channel-Dx39C4tw.js";
import { c as bindOwnedSessionTranscriptWrites, l as withOwnedSessionTranscriptWrites } from "./transcript-NdJkeRhp.js";
...
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-C_veZd_6.js";
import { r as isSessionWriteLockAcquireError } from "./session-write-lock-error-CYOzPsPk.js";
import { o as writeJsonlLines, r as serializeJsonlLine } from "./transcript-jsonl-CD0KPCG0.js";
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-Cwefeem_.js";
import { G as transformProviderSystemPrompt, M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms } from "./provider-runtime-Cp9BfFXg.js";
import { n as parseBooleanValue } from "./boolean-By0bZpFH.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-BnZEAmHB.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bf1BpkZq.js";
import { o as normalizeProviderId$1 } from "./model-selection-normalize-CBjx3j0e.js";
import { c as resolveDefaultModelForAgent } from "./model-selection-CRIOhEQm.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, r as extractToolResultIds, t as extractToolCallsFromAssistant } from "./tool-call-id-BNIeGny8.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-B9X9dB3H.js";
import { i as streamSimple } from "./stream-4o8pRyto.js";
import { o as createAgentSession, tt as wrapToolDefinition } from "./sessions-C_fxanxf.js";
import { t as SessionManager } from "./session-manager-g-7X6v2O.js";
import { t as detectRuntimeShell } from "./shell-utils-DKmnHE0C.js";
import { f as resolveModelAuthMode } from "./model-auth-Aq6KQDp8.js";
import { h as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-C9ULOsP_.js";
import { a as isAgentRunRestartAbortReason, n as AGENT_RUN_RESTART_ABORT_STOP_REASON, r as createAgentRunRestartAbortError } from "./run-termination-u49x3Tfg.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BI3m2RBP.js";
import { U as isTerminalTaskStatus } from "./task-registry-kPLgAJMa.js";
import { C as streamWithPayloadPatch, D as scrubOverCapPlainTextToolCallMessage, E as normalizePlainTextToolCallStreamEvents, T as promoteStandalonePlainTextToolCallMessage, w as extractStandalonePlainTextToolCallText } from "./provider-stream-shared-DYzZwCmi.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-BbLAEXko.js";
import { f as findFinalTagMatches, o as stripDowngradedToolCallText, u as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-QdHceFYu.js";
import { C as parseExecApprovalResultText } from "./sanitize-user-facing-text-NOYqsmDF.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { o as markDiagnosticRunProgress } from "./diagnostic-run-activity-C9CRKODq.js";
import { C as resolveEmbeddedSessionFileKey, b as updateActiveEmbeddedRunSnapshot, d as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, v as setActiveEmbeddedRun, y as updateActiveEmbeddedRunSessionFile } from "./runs-DI_L8C_8.js";
import { a as isSilentReplyPrefixText, c as stripLeadingSilentToken, i as isSilentReplyPayloadText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText, s as startsWithSilentToken } from "./tokens-U6o7_k27.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-C67Kbb7n.js";
...
import { l as formatUserFacingAssistantErrorText, p as isCloudCodeAssistFormatError, r as classifyFailoverReason } from "./errors-B4mplIiL.js";
import { f as couldNormalizeToolNamePrefixToAllowedTool, h as normalizeToolName, m as normalizeToolList, p as expandToolGroups } from "./tool-policy-BPywi0tl.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-sxySQZer.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D4eSqgVq.js";
import { c as isSignalTimeoutReason } from "./failover-error-CC108ogz.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-D-VMfpYI.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-jkXQRYZ9.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./agent-tools.policy-5Rr-S1Gi.js";
...
import { A as resolveChannelMessageToolHints, M as resolveChannelReactionGuidance, S as markCodeModeControlTool, k as listChannelSupportedActions, v as CODE_MODE_EXEC_TOOL_NAME, x as isCodeModeControlTool, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-CsK6Ldwa.js";
import { i as getPluginToolMeta } from "./tools-C-g0qnV5.js";
import { l as jsonResult, n as ToolInputError, r as asToolParamsRecord } from "./common-CEBsSh4n.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-8oQxHspB.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-BIyTyphC.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST, r as assertContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CywEqkfH.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-D6-_RNEN.js";
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-C69OI_rE.js";
import { T as isEmbeddedMode, f as isStrictAgenticSupportedProviderModel, p as stripProviderPrefix } from "./openclaw-tools-50pm1WIW.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-5l-MBhk_.js";
import { t as getMachineDisplayName } from "./machine-name-CBTz5R12.js";
import { f as sanitizeTransportPayloadText, h as supportsModelTools, m as buildGuardedModelFetch, u as mergeTransportHeaders } from "./openai-transport-stream-C-e3sRQi.js";
import { t as log$2 } from "./logger-BEGZufhT.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-EmUa6oWt.js";
import { a as stripSystemPromptCacheBoundary, n as ensureSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-vl0D_wqS.js";
import { a as buildCodeSpanIndex, o as createInlineCodeState } from "./openai-completions-DCEsPPkI.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BTmON1Zk.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-52t6V0oE.js";
import { u as resolveSkillsPromptForRun } from "./workspace-D_2xSCx7.js";
import { n as resolveSandboxSkillRuntimeInputs, r as resolveEmbeddedRunSkillEntries, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-Cr3xM-gb.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CbvqUyzX.js";
import { n as redactConfigObject } from "./redact-snapshot-cH-a8Dq4.js";
import { t as resolveCommitHash } from "./git-commit-kGQnzwvq.js";
import { t as resolveOsSummary } from "./os-summary-BQlvd96x.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DMWJbvRh.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-BsjZ1aqc.js";
import { o as isReasoningTagProvider } from "./user-turn-transcript-A1c264HL.js";
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-CNXI-BGk.js";
import { a as getOrCreateSessionMcpRuntime } from "./agent-bundle-mcp-runtime-B0D_K5RM.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-2aI15Sq8.js";
import "./agent-bundle-mcp-tools-BGNF7jxG.js";
import { B as dropReasoningFromHistory, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as readLastCacheTtlTimestamp, G as createPreparedEmbeddedAgentSettingsManager, H as stripThinkingBlocksFromMessage, I as logRuntimeToolSchemaQuarantine, L as guardSessionManager, O as buildEmbeddedExtensionFactories, P as isCacheTtlEligibleProvider, R as repairSessionFileIfNeeded, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, U as wrapAnthropicStreamWithRecovery, V as dropThinkingBlocks, W as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as trackSessionManagerAccess, c as AGENT_RESERVED_TOOL_NAMES, d as collectRegisteredToolNames, f as toSessionToolAllowlist, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as buildEmbeddedSystemPrompt, o as mapThinkingLevel, p as applySystemPromptToSession, r as shouldRotateCompactionTranscript, t as rotateTranscriptAfterCompaction, u as collectCoreBuiltinToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as createEmbeddedAgentResourceLoader, y as prewarmSessionFile, z as assessLastAssistantMessage } from "./compaction-successor-transcript-Ncp4Uf5J.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyAgentAutoCompactionGuard, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-R-XbC6UK.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, o as toToolDefinitions, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-DXB3RqC6.js";
import { C as isLocalModelLeanEnabled, S as filterLocalModelLeanTools, _ as estimateToolSchemaDirectoryToolNames, a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, b as resolveToolSearchConfig, c as addClientToolsToToolCatalog, d as applyToolSchemaDirectoryCatalog, f as applyToolSearchCatalog, g as createToolSearchCatalogRef, h as collectUniqueCatalogToolNames, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as addClientToolsToToolSearchCatalog, m as clearToolSearchCatalog, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, p as buildToolSchemaDirectoryPrompt, r as TOOL_CALL_RAW_TOOL_NAME, s as ToolSearchRuntime, t as createOpenClawCodingTools, u as applyToolCatalogCompaction, v as projectToolSearchTargetTranscriptMessages, w as resolveLocalModelLeanPreserveToolNames, x as applyLocalModelLeanToolSearchDefaults, y as resolveToolSearchCatalogTool } from "./agent-tools-CvzYkYSe.js";
import { o as REQUIRED_PARAM_GROUPS } from "./nodes-utils-BqX7b_Ao.js";
import { o as optionalStringEnum } from "./typebox-WC1TYVJz.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-C5IM2W3a.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-CSEkC-AM.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { c as hasCommittedMessagingToolDeliveryEvidence, f as hasAcceptedSessionSpawn, l as hasMessagingToolDeliveryEvidence, p as normalizeAcceptedSessionSpawnResult, y as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-BdIxN0mb.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ByaJGDhT.js";
import { b as resolveBootstrapTotalMaxChars, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-CULGwdfn.js";
import { M as formatToolAggregate } from "./streaming-BRnqIMS-.js";
import { d as parseReplyDirectives } from "./payloads-DwYjapHo.js";
import { d as shouldSuppressRawErrorConsoleSuffix, l as buildApiErrorObservationFields, p as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-CB6h6-6n.js";
import { a as extractThinkingFromTaggedStream, c as inferToolMetaFromArgs, d as sanitizeAssistantVisibleStreamText, i as extractAssistantVisibleText, l as isAssistantMessage, n as extractAssistantText, o as extractThinkingFromTaggedText, r as extractAssistantThinking, t as THINKING_TAG_SCAN_RE, u as promoteThinkingTagsToBlocks } from "./embedded-agent-utils-B9bm-8Xr.js";
...
import { t as registerProviderStreamForModel } from "./provider-stream-xsNVzoaM.js";
import { b as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-B0bRSEpe.js";
import { n as buildSubagentList } from "./subagent-list-BoA6XoM6.js";
import { a as listControlledSubagentRuns } from "./subagent-control-DDvyUyBI.js";
import { o as resolveSandboxContext } from "./sandbox-C9REAclS.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-DTO0IG8s.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-bmmzkOyn.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-B1di_awi.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-D5YC2wdZ.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BV57VemT.js";
import { a as isMessagingToolSendAction, o as isMessagingToolTargetEvidenceAction, r as isMessagingTool } from "./embedded-agent-messaging-DZP5HfHM.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { a as extractMessagingToolSourceReplyPayload, c as extractToolResultMediaArtifact, d as isToolResultError, f as isToolResultTimedOut, i as extractMessagingToolSend, l as extractToolResultText, m as sanitizeToolResult, n as collectMessagingMediaUrlsFromRecord, o as extractToolErrorCode, p as sanitizeToolArgs, r as collectMessagingMediaUrlsFromToolResult, s as extractToolErrorMessage, t as buildToolLifecycleErrorResult, u as filterToolResultMediaUrls } from "./embedded-agent-subscribe.tools-B2A6MVZq.js";
import { n as isDeliveredMessagingToolResult, t as isDeliveredMessageToolOnlySourceReplyResult } from "./embedded-agent-message-tool-source-reply-CVIWv1Xf.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-W6xrR3Zx.js";
import { t as EmbeddedBlockChunker } from "./embedded-agent-block-chunker-DH4NVUQq.js";
import { n as runAgentEndSideEffects } from "./agent-end-side-effects-Bdguwwf-.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-CLsHmY5H.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-Bg4kQKen.js";
import { t as collectRuntimeChannelCapabilities } from "./runtime-capabilities-IPSdMSCv.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-DUKsPWex.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-Buf_pCgk.js";
import { r as buildStreamErrorAssistantMessage } from "./stream-message-shared-CdbBqwfX.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, l as truncateOversizedToolResultsInSessionManager, s as truncateOversizedToolResultsInMessages } from "./tool-result-truncation-CE7-U3RC.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-D6GtR58D.js";
import { a as resolveUserTimezone } from "./date-time-CcWivhrg.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-DZ5pfh4w.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DXh85F1c.js";
import { c as resolveCompactionTimeoutMs, d as shouldAllowProviderOwnedThinkingReplay, u as resolveTranscriptPolicy } from "./tool-result-middleware-BUb-oCHG.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-IU6ycWo1.js";
...
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-TJVPBHTV.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-D51XC0IR.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-wuJXT5d1.js";
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, n as runAgentCleanupStep, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-CT5r1Qgk.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-CCaCLIiF.js";
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-CJ5fpZ3R.js";
...
import "./tool-loop-detection-DySV2vRU.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-TLPxtoNw.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-Ccq_0iyB.js";
import { t as detectAndLoadPromptImages } from "./images-CUqifyhD.js";
import { o as resolveRuntimeContextPromptParts, r as buildRuntimeContextCustomMessage, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-Q7uCpeK8.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-Pzi88bhM.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./agent-tools.before-tool-call-CYB_QDgo.js"));
...
async function handleToolExecutionEnd(ctx, evt) {
	...
	const didDeliverMessagingResult = isMessagingTool(toolName) && isDeliveredMessagingToolResult({
		toolName,
		args: startArgs,
		result,
		isError: isToolError
	});
	const committedMediaUrls = didDeliverMessagingResult && isMessagingSend ? [...pendingMediaUrls, ...collectMessagingMediaUrlsFromToolResult(result)] : [];
	if (pendingText) {
...
function resolveIncompleteTurnPayloadText(params) {
	...
	const unsignedThinkingOnlyTerminal = params.payloadCount !== 0 && !joinAssistantTexts(params.attempt.assistantTexts).length && isUnsignedThinkingOnlyAssistantTurn(assistant);
	if (params.payloadCount !== 0 && !toolUseTerminal && !unsignedThinkingOnlyTerminal || params.aborted && params.externalAbort || params.timedOut || params.attempt.clientToolCalls || params.attempt.yieldDetected || params.attempt.didSendDeterministicApprovalPrompt || params.attempt.lastToolError) return null;
	...
	if (!incompleteTerminalAssistant && !reasoningOnlyAssistant && !unsignedThinkingOnlyTerminal && !emptyResponseAssistant && stopReason !== "error") return null;
...
function normalizeMessagesForCurrentPromptBoundary(params) {
	...
	const boundaryOptions = params.timezone ? { timezone: params.timezone } : void 0;
	return normalizeMessagesForLlmBoundary([...params.messages, promptMessage], boundaryOptions).slice(0, -1);
}
...
*/
function stampUserTextWithMessageTimestamp(text, timestamp, timezone) {
...
function stripHistoricalInboundMetadataFromUserMessages(messages, options) {
	...
	const nextMessages = messages.map((message, index) => {
		...
		const transformText = (raw) => {
			...
			return stampUserTextWithMessageTimestamp(isActive ? raw : stripInboundMetadata(raw), messageTimestamp, options?.timezone);
		};
		if (typeof content === "string") {
...
*/
function resolveSameModelRateLimitBackoffMs(retriesSoFar) {
		...
		try {
			...
			session = (await createEmbeddedAgentSessionWithResourceLoader({
				...
				options: {
					...
					resolveDeferredTool: deferredDirectoryToolsCallable ? ({ toolCall }) => {
						...
						const definition = tool ? toToolDefinitions([tool])[0] : void 0;
			...
			try {
				...
				try {
					...
					const unwindowedLlmBoundaryMessagesForPrecheck = contextEnginePromptAuthority === "preassembly_may_overflow" && unwindowedContextEngineMessagesForPrecheck ? normalizeMessagesForLlmBoundary(unwindowedContextEngineMessagesForPrecheck, boundaryTimezone ? { timezone: boundaryTimezone } : void 0) : void 0;
...
//#endregion
export { STRICT_AGENTIC_BLOCKED_TEXT as A, resolveRunLivenessState as B, mergeUsageIntoAccumulator as C, createEmbeddedRunStageTracker as D, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as E, resolveIncompleteTurnPayloadText as F, observeReplayMetadata as G, shouldRetryMissingAssistantTurn as H, resolvePlanningOnlyRetryInstruction as I, createTrajectoryRuntimeRecorder as K, resolvePlanningOnlyRetryLimit as L, resolveAckExecutionFastPathInstruction as M, resolveAttemptReplayMetadata as N, formatEmbeddedRunStageSummary as O, resolveEmptyResponseRetryInstruction as P, resolveReasoningOnlyRetryInstruction as R, createUsageAccumulator as S, timestampOptsFromConfig as T, shouldTreatEmptyAssistantReplyAsSilent as U, resolveSilentToolResultReplyPayload as V, createEmbeddedRunReplayState as W, resolveOverloadProfileRotationLimit as _, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as a, resolveSameModelRateLimitRetryDelayMs as b, buildUsageAgentMetaFields as c, resolveActiveErrorContext as d, resolveFinalAssistantRawText as f, resolveOverloadFailoverBackoffMs as g, resolveNextSameModelRateLimitRetryCount as h, RUNTIME_AUTH_REFRESH_MARGIN_MS as i, extractPlanningOnlyPlanDetails as j, shouldWarnEmbeddedRunStageSummary as k, createCompactionDiagId as l, resolveMaxRunRetryIterations as m, runAgentHarnessAttempt as n, RUNTIME_AUTH_REFRESH_RETRY_MS as o, resolveFinalAssistantVisibleText as p, selectAgentHarness as r, buildErrorAgentMeta as s, resolveAvailableAgentHarnessPolicy as t, isAssistantForModelRef as u, resolveRateLimitProfileRotationLimit as v, injectTimestamp as w, scrubAnthropicRefusalMagic as x, resolveReportedModelRef as y, resolveReplayInvalidFlag as z };
