...
import { t as appendFileTransferAudit } from "./audit-D72AxalE.js";
...
async function persistAllowAlways(input) {
	...
	await mutateConfigFile({
		...
		mutate: (draft) => {
			...
			let key = [input.nodeId, input.nodeDisplayName].filter((k) => typeof k === "string" && k.length > 0).find((c) => Object.hasOwn(fileTransfer, c));
			if (!key) {
