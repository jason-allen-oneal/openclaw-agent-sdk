...
import { d as setSessionRuntimeModel, f as canonicalizeAbsoluteSessionFilePath, p as rewriteSessionFileForNewSessionId, r as mergeSessionEntry } from "./types-D8S_uNvu.js";
...
import { c as setCliSessionId, n as clearCliSession, s as setCliSessionBinding } from "./cli-session-D_Cr4kxU.js";
...
const contextModuleLoader = createLazyImportLoader(() => import("./context-DCQSzAv5.js"));
...
async function updateSessionStoreAfterAgentRun(params) {
	...
	const persisted = await updateSessionStore(storePath, (store) => {
		if (preserveUserFacingRunState && !store[sessionKey]) return;
		...
		resolveSingleEntryPersistence: (entryLocal) => entryLocal ? {
			sessionKey,
			entry: entryLocal
		} : void 0
	});
