...
import { a as markAutoFallbackPrimaryProbe, m as resolveAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-B4NxGkqZ.js";
...
import { b as withAgentRunLifecycleGeneration, h as registerAgentRunContext, i as clearAgentRunContext, m as onAgentEvent, n as captureAgentRunLifecycleGeneration, s as emitAgentEvent } from "./agent-events-C3fRM85v.js";
import { b as resolveGroupSessionKey, d as updateSessionStore } from "./store-Dcn5FSKd.js";
import { o as resolveMessageChannel } from "./message-channel-normalize-D-mHlbxC.js";
import { i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-Dx39C4tw.js";
import "./sessions-DieR2Eem.js";
import { i as classifyOAuthRefreshFailureError, n as buildOAuthRefreshFailureLoginCommand, r as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-DNxwJzrt.js";
import { y as resolveModelRefFromString } from "./model-selection-shared-By-X2JmI.js";
import { h as isCliProvider, u as resolvePersistedOverrideModelRef } from "./model-selection-CRIOhEQm.js";
import { i as isMissingProviderAuthError } from "./model-auth-runtime-shared-ZF0jyHxm.js";
import "./model-auth-Aq6KQDp8.js";
import { a as isAgentRunRestartAbortReason, n as AGENT_RUN_RESTART_ABORT_STOP_REASON, o as resolveAgentRunAbortLifecycleFields, r as createAgentRunRestartAbortError } from "./run-termination-u49x3Tfg.js";
import { _ as isRateLimitErrorMessage, d as sanitizeUserFacingText, h as isOverloadedErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, m as isBillingErrorMessage, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-NOYqsmDF.js";
import { a as createReplyOperation, m as replyRunRegistry, n as ReplyRunAlreadyActiveError } from "./reply-run-registry-Ccw3Ogdy.js";
import { f as logSessionTurnCreated } from "./diagnostic-IFZYvbDc.js";
...
import { C as isTransientHttpError, b as isLikelyContextOverflowError, h as isContextOverflowError, m as isCompactionFailureError } from "./errors-B4mplIiL.js";
import { o as isFailoverError } from "./failover-error-CC108ogz.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-D-VMfpYI.js";
import { a as resolveCliRuntimeExecutionProvider, r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-8oQxHspB.js";
import { d as stripHeartbeatToken } from "./heartbeat-CicGJ6Bb.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-Ba9PLuoj.js";
...
import { f as LiveSessionModelSwitchError, o as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-CB6h6-6n.js";
import { n as clearCliSession, r as getCliSessionBinding } from "./cli-session-D_Cr4kxU.js";
import { c as inferToolMetaFromArgs } from "./embedded-agent-utils-B9bm-8Xr.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-bmmzkOyn.js";
import { a as isMessagingToolSendAction } from "./embedded-agent-messaging-DZP5HfHM.js";
import { l as extractToolResultText } from "./embedded-agent-subscribe.tools-B2A6MVZq.js";
import { a as resolveCurrentTurnImages, i as isReplyProfilerEnabled, o as resolveSilentReplyPolicy } from "./effective-reply-route-CMX4b9Bu.js";
import { r as formatAuthProfileFailureMessage, t as runEmbeddedAgent } from "./embedded-agent-BgvyyCVT.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CQGCjyR6.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-BvUOiCFf.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-rflhdBOv.js";
import { n as runCliAgent } from "./cli-runner-BnrUj7LQ.js";
...
import { n as createBlockReplyContentKey } from "./block-reply-pipeline-BpOjFr83.js";
...
async function runAgentTurnWithFallback(params) {
	...
	while (true) try {
		...
		if (isReplyOperationRestartAbort(params.replyOperation)) throw isAgentRunRestartAbortReason(restartAbortReason) ? restartAbortReason : createAgentRunRestartAbortError();
...
//#endregion
export { keepCliSessionBindingOnlyWhenReused as _, buildKnownAgentRunFailureReplyPayload as a, resolveSessionRuntimeOverrideForProvider as c, createCompactionHookNoticePayload as d, createCompactionNoticePayload as f, createCliToolSummaryTracker as g, clearDroppedCliSessionBinding as h, resolveReplyTurnKind as i, runAgentTurnWithFallback as l, shouldNotifyUserAboutCompaction as m, recordReplyUsageState as n, buildPreflightCompactionFailureText as o, readCompactionHookMessages as p, admitReplyTurn as r, resolveRunAfterAutoFallbackPrimaryProbeRecheck as s, consumeReplyUsageState as t, normalizeReplyPayloadDirectives as u, runCliAgentWithLifecycle as v };
