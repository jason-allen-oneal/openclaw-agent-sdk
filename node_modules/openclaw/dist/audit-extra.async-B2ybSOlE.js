...
import { _ as resolveOAuthDir } from "./paths-mvMm5bYV.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./workspace-kc-Nv_5P.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CaldjiQX.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-MeHSq9Vp.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-DTaPdGvi.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./scanner-BesLxWXC.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Celjy4EJ.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-BgfHwL-P.js");
