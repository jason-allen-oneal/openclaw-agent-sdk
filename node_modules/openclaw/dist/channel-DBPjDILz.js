...
import { u as parseThreadSessionSuffix } from "./session-key-utils-Bx3apsJ3.js";
...
import { b as readStringParam, g as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError } from "./common-CEBsSh4n.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-lj5quus3.js";
import "./string-coerce-runtime-CEGJWkQ_.js";
import { t as chunkTextForOutbound } from "./text-chunking-BgBAa4-u.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-EAs5v0O0.js";
import "./channel-core-Cv7X07AL.js";
import "./routing-CqTr30kc.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-D1WUExii.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-D0q4NZ6S.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-45ez7UJI.js";
import "./approval-delivery-runtime-B5Z_yjNe.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DLWtIqHq.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CK7R7DuT.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-BxC-ERQZ.js";
import "./approval-native-runtime-Cqfekuub.js";
import { w as createChannelMessageAdapterFromOutbound } from "./channel-outbound-C9Kf2zmk.js";
import "./conversation-runtime-CZ37Nuw1.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BevxX6Pu.js";
import "./channel-status-DxlXr0Xh.js";
import "./channel-actions-plUQGGiE.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BRBxU9X-.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BXPQMjjW.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CPbyJmHE.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-uRio41MZ.js";
import { n as normalizeMatrixUserId } from "./allowlist-k_lkAH4x.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-B2lyZmro.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-wSeofnfp.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-BCKwsiMr.js";
import { t as formatMatrixErrorMessage } from "./errors-DZI7Ga2n.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-BibEUd14.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-F98AD6ae.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-D_-3k8pY.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-DWS4OJlC.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BwJTxYic.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-BDXEy3Wt.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-e7xX4-Dy.js";
...
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-D8Tu94PL.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DFWH6sfy.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DeZVO2Fp.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Ddmm8U1A.js"), "matrixChannelRuntime");
let matrixDoctorModulePromise = null;
const loadMatrixDoctorModule = async () => {
	matrixDoctorModulePromise ??= import("./doctor-CtVt1RsL.js");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BOnG99Yr.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
