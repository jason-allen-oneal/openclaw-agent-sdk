...
import "../../agent-settings-R-XbC6UK.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-D_qg5ElV.js";
import { t as resolveMemoryCoreNowMs } from "../../time-DhPCijtC.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-BmPIm9XG.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CT_OGlM3.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-C5sVXKhB.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-GkK8Mypn.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DKfaVJD9.js");
