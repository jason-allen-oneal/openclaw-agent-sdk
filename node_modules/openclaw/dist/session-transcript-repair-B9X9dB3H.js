import { c as normalizeOptionalString, p as readStringValue, t as hasNonEmptyString } from "./string-coerce-mnp54Vah.js";
import { n as extractToolResultId, o as isAllowedToolCallName, r as extractToolResultIds, s as normalizeAllowedToolNames, t as extractToolCallsFromAssistant } from "./tool-call-id-BNIeGny8.js";
...
function findLaterMatchingToolResult(params) {
	for (let index = params.startIndex; index < params.messages.length; index += 1) {
		...
		if (!id || id !== params.toolCallId || params.seenToolResultIds.has(id)) continue;
