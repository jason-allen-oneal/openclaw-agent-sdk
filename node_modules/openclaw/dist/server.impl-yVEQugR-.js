...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DcqIKp5M.js";
...
import { O as runWithDiagnosticTraceContext, g as setDiagnosticsEnabledForProcess, u as isDiagnosticsEnabled, y as createDiagnosticTraceContext } from "./diagnostic-events-DNqaP5x8.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-BbA2Znit.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CjeTePSl.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-DXKcDDxT.js";
...
import { c as buildRateLimitIdentityKey, l as createAuthRateLimiter, o as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL } from "./auth-rate-limit-v6tnRQCM.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedKeyedAttempt } from "./auth-CtNgvH0N.js";
import { n as resolveGatewayAuth } from "./auth-resolve-C0kiP8dc.js";
import { i as getRuntimeConfig, j as applyConfigOverrides, s as promoteConfigSnapshotToLastKnownGood, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-fQmSDfK-.js";
...
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-CppiWLEI.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-C2IK7x54.js";
import { f as pinActivePluginChannelRegistry, g as releasePinnedPluginHttpRouteRegistry, h as releasePinnedPluginChannelRegistry, p as pinActivePluginHttpRouteRegistry } from "./runtime-CjN6pXNK.js";
...
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-IRSLm2FP.js";
import "./sessions-DieR2Eem.js";
import { a as enqueueSystemEvent } from "./system-events--U8AE18s.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-IFZYvbDc.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-DV0Fnc3U.js";
import { o as resolveCronJobsStorePath } from "./store-CGXhD-XE.js";
import { p as resolveActiveEmbeddedRunSessionId, u as getActiveEmbeddedRunCount } from "./run-state-DClKANFE.js";
import { r as getActiveCronJobCount } from "./active-jobs-DCucn-SJ.js";
import { u as getTotalQueueSize } from "./command-queue-DxRdA7fT.js";
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-HKQyjnAT.js";
import { s as setFallbackGatewayContextResolver } from "./server-plugins-C0AakYiQ.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-CmaFU5gD.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-9LytxRlq.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-D6Qf-mR-.js";
import { l as requestNodePairing, r as finalizeNodePairingCleanupClaim, u as reusePendingNodePairingForReconnect } from "./node-pairing-C8MBim3n.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-CXqtaPQY.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CqhS4yhs.js";
import { t as createDefaultDeps } from "./deps-D2lrxzX8.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-B7U3wQMs.js";
...
import { n as resolveAssistantIdentity } from "./assistant-identity-Dq5NZiXU.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-DlUK3aCC.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-C-9KK3tN.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Cxz0tJ2a.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DeBmCVR-.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-DsLh3zif.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-B6harCkf.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BNFKvQWO.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-5G90cJq1.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-CibcmRmd.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-CoMLW6oP.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BAjJ0ljy.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-0zLA4-pe.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-B4b-MzyS.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-B9dBzgLq.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-D6OsadA5.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-CwDRMyJ-.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-D9GvwwoU.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DNtP3ma2.js");
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-D0fUC3ly.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-BVS78k34.js");
...
const loadGatewayModelCatalogModule = async () => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-CSnzAf9A.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-Bct9jfId.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-J1wTf21a.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DDp9h2Vt.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DXwM8IhL.js");
...
const loadGatewayPluginBootstrapModule = async () => {
	gatewayPluginBootstrapModulePromise ??= import("./server-plugin-bootstrap-DgMSTyVY.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-CvX6sSz2.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-DGL61Ruj.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const startupConfigModulePromise = import("./server-startup-config-DZDWP62N.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-C8-rnM5i.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-Doye_-ia.js");
	...
	const { createChannelManager } = await import("./server-channels-BhILCSyS.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-DVd7MR8z.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DZwijdCI.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-CxKq-Z61.js"), import("./server-runtime-startup-services-v2acXtqc.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-By0_i4P1.js"), import("./server-methods-DpO_jEIH.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-D0MGVS71.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-DVl4y0d7.js")
			]);
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-CBaIVgvn.js"), import("./route-capability-9Y_C1THF.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-Bw-rKLlS.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-_sVpMCka.js");
