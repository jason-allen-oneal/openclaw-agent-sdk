...
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DNJywrQV.js";
...
import { h as normalizeToolName, i as collectExplicitAllowlist } from "./tool-policy-BPywi0tl.js";
import { n as resolveEffectiveToolPolicy } from "./agent-tools.policy-5Rr-S1Gi.js";
import { i as getPluginToolMeta, o as setPluginToolMeta } from "./tools-C-g0qnV5.js";
...
import { t as buildWorkspaceSkillStatus } from "./status-CCOf0c1X.js";
import { r as inspectRuntimeToolInputSchemas } from "./tool-schema-projection-DUKsPWex.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt } from "./attempt-tool-construction-plan-CCaCLIiF.js";
import { t as collectUnavailableAgentSkills } from "./doctor-skills-core-N-TJqicN.js";
...
async function collectProviderCatalogProjectionFindings(cfg) {
	const { runProviderStaticCatalog } = await import("./provider-discovery-D6bOnqJU.js");
...
function collectAgentRuntimeToolSchemaFindings(params) {
	...
	try {
		...
		return [...preNormalizationFindings, agentRuntimeToolNormalizationFailureFinding({
			agentId: params.agentId,
			error
		})];
	}
