import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, r as lowercasePreservingWhitespace } from "./string-coerce-mnp54Vah.js";
import { P as timestampMsToIsoString, b as parseStrictPositiveInteger, s as asFiniteNumber } from "./number-coercion-CJQ8TR--.js";
import { _ as uniqueStrings, l as normalizeStringEntries, o as normalizeSingleOrTrimmedStringList } from "./string-normalization-WNUDCpXX.js";
...
import { c as listActiveMemoryPublicArtifacts, r as getMemoryCapabilityRegistration } from "./memory-state-D1oMTUUg.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BldC7ibm.js";
import { p as readFiniteNumberParam } from "./common-CEBsSh4n.js";
import { o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DEcD802I.js";
import "./number-runtime-DBLVDypr.js";
import "./security-runtime-DRoO_c6_.js";
import "./string-coerce-runtime-CEGJWkQ_.js";
import "./gateway-runtime-CQxqE9M3.js";
import { n as callGatewayFromCli } from "./gateway-rpc-Clbkc1EM.js";
import { r as resolveTranscriptStemToSessionKeys, t as extractTranscriptIdentityFromSessionsMemoryHit } from "./session-transcript-hit-CYlUCd-4.js";
import "./memory-host-core-B63ADpij.js";
import { r as retryTransientMemoryRead } from "./hash-VHZC2Zdf.js";
import "./memory-core-host-engine-storage-CC2gDibe.js";
import { n as withTrailingNewline, t as replaceManagedMarkdownBlock } from "./memory-host-markdown-mHNl3RAL.js";
import { r as getActiveMemorySearchManager } from "./memory-host-search-CLSo6JE1.js";
import "./param-readers-BqIX58yY.js";
import { S as writeMemoryWikiSourceSyncState, b as setImportedSourceEntry, c as readMemoryWikiImportRunRecord, g as pruneImportedSourceEntries, i as countMemoryWikiImportRunStateRows, l as resolveMemoryWikiImportRunsDir, p as assertMemoryWikiSourceSyncStateCapacity, t as MEMORY_WIKI_IMPORT_RUN_STATE_MAX_ENTRIES, u as writeMemoryWikiImportRunRecord, v as readMemoryWikiSourceSyncState, x as shouldSkipImportedSourceWrite } from "./import-runs-state-w-5ZK3Ty.js";
import { d as resolveMemoryWikiConfig, o as WIKI_SEARCH_BACKENDS, s as WIKI_SEARCH_CORPORA } from "./config-CPXuDbhU.js";
...
const DASHBOARD_PAGES = [
	...
	},
	{
		...
		buildBody: ({ config, managedImportedSourcePagePaths, pages, now, sourceRelativeTo }) => {
			const matches = pages.filter((page) => page.kind !== "report" && !(isUnmanagedRawSourceSummary(page) && !managedImportedSourcePagePaths.has(page.relativePath))).flatMap((page) => {
...
async function writeWikiPage(params) {
	...
	if (await root$2.readText(params.relativePath).catch(() => "") === rendered) return false;
...
function isRegularFileStat$1(value) {
...
async function writeOkfConceptPage(params) {
	...
	try {
		if (isRegularFileStat$1(pageStat) && pageStat.nlink > 1) await vault.remove(params.pagePath);
		await vault.write(params.pagePath, params.content);
	} catch (error) {
		if (error instanceof FsSafeError) {
			if (error.code !== "symlink" && error.code !== "path-alias") throw new Error(`Refusing to write OKF concept page (${error.code}): ${params.pagePath}: ${error.message}`, { cause: error });
			throw new Error(`Refusing to write OKF concept page through symlink: ${params.pagePath}`, { cause: error });
		}
		throw error;
	}
	return {
...
//#endregion
export { runObsidianSearch as A, initializeMemoryWikiVault as B, renderMemoryWikiStatus as C, runObsidianCommand as D, probeObsidianCli as E, WIKI_SEARCH_MODES as F, getMemoryWikiPage as I, readQueryableWikiPages as L, ingestMemoryWikiSource as M, applyMemoryWikiMutation as N, runObsidianDaily as O, normalizeMemoryWikiMutationInput as P, searchMemoryWiki as R, buildMemoryWikiDoctorReport as S, syncMemoryWikiImportedSources as T, parseWikiMarkdown as V, runWikiObsidianStatus as _, runWikiChatGptImport as a, runWikiStatus as b, runWikiDoctor as c, runWikiInit as d, runWikiLint as f, runWikiObsidianSearch as g, runWikiObsidianOpenCli as h, runWikiBridgeImport as i, lintMemoryWikiVault as j, runObsidianOpen as k, runWikiGet as l, runWikiObsidianDailyCli as m, runWikiApplyMetadata as n, runWikiChatGptRollback as o, runWikiObsidianCommandCli as p, runWikiApplySynthesis as r, runWikiCompile as s, registerWikiCli as t, runWikiIngest as u, runWikiOkfImport as v, resolveMemoryWikiStatus as w, runWikiUnsafeLocalImport as x, runWikiSearch as y, compileMemoryWikiVault as z };
