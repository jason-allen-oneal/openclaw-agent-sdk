...
import { c as readErrorName, i as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-CbY2H91D.js";
...
import { a as isRecoverableTelegramNetworkError, t as TELEGRAM_GET_UPDATES_REQUEST_TIMEOUT_MS } from "./request-timeouts-BU95nyTR.js";
import { t as drainPendingDeliveries } from "./delivery-queue-runtime-6XjRnjKk.js";
...
import { d as isTelegramMessageDispatchReplayForgetError } from "./message-dispatch-dedupe-HhjMCgqS.js";
import { c as writeTelegramUpdateOffset, o as readTelegramUpdateOffset, r as deleteTelegramUpdateOffset } from "./update-offset-store-Xo5P0cEM.js";
import { D as withTelegramApiErrorLogging } from "./send-DsQJjhVA.js";
import { a as runWithTelegramSpooledReplayUpdate, i as getTelegramSequentialKey, n as buildTelegramReplyFenceLaneKey, r as supersedeTelegramReplyFenceLane, t as createTelegramBot } from "./bot-B3dz_0yx.js";
...
function resolveTelegramIngressSpoolDir(params) {
	...
	return path.join(stateDir, "telegram", `${TELEGRAM_INGRESS_SPOOL_PREFIX}${normalizeAccountId(params.accountId)}`);
}
...
function resolveQueueParts(spoolDir) {
	...
	return {
		accountId: normalizeAccountId(basename.startsWith(TELEGRAM_INGRESS_SPOOL_PREFIX) ? basename.slice(14) : basename),
...
async function releaseTelegramSpooledUpdateClaim(update) {
	await createTelegramIngressQueue(path.dirname(update.pendingPath)).release(queueMutationTarget(update));
}
