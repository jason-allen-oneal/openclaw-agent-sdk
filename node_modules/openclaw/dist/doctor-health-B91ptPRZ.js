...
async function doctorCommand(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-CRgg3jst.js");
	const { printWizardHeader } = await import("./onboard-helpers-DXRVcXC9.js");
	...
	const { maybeOfferUpdateBeforeDoctor } = await import("./doctor-update-Ccb1tYfY.js");
	...
	const { maybeRepairUiProtocolFreshness } = await import("./doctor-ui-9XwwUpFp.js");
	const { noteSourceInstallIssues } = await import("./doctor-install-BaSIOtlX.js");
	const { noteStalePluginRuntimeSymlinks } = await import("./plugin-runtime-symlinks-D-jUCQTn.js");
	const { noteStartupOptimizationHints } = await import("./doctor-platform-notes-DnfMLGZg.js");
	await maybeRepairUiProtocolFreshness(effectiveRuntime, prompter);
	noteSourceInstallIssues(root);
	await noteStalePluginRuntimeSymlinks(root);
	noteStartupOptimizationHints();
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-DM_BswkL.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-DsOwQX7S.js");
