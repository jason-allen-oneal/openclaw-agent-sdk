...
import { c as resolveAgentExplicitModelPrimary, d as resolveAgentModelFallbacksOverride } from "./agent-scope-B4NxGkqZ.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DNJywrQV.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-B3AjhIK3.js";
import { a as restoreCurrentPluginMetadataSnapshotState, o as setCurrentPluginMetadataSnapshot, r as getCurrentPluginMetadataSnapshot, t as captureCurrentPluginMetadataSnapshotState } from "./current-plugin-metadata-snapshot-CjeTePSl.js";
import { r as createConfigIO } from "./io-fQmSDfK-.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-gkDtz1VG.js";
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-CZeLSeyj.js";
...
import { P as evaluateStoredCredentialEligibility, i as ensureAuthProfileStoreWithoutExternalProfiles, v as loadPersistedAuthProfileStore } from "./store-jnx0nhpN.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BFetL3S9.js";
import { j as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Cp9BfFXg.js";
...
import "./profiles-Bu3mimei.js";
import { i as resolveAuthProfileOrder, r as resolveAuthProfileEligibility } from "./order-7QnPW4As.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-CuMi9GBf.js";
import { g as resolveConfiguredModelRef, i as buildModelAliasIndex, y as resolveModelRefFromString } from "./model-selection-shared-By-X2JmI.js";
import { i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-CBjx3j0e.js";
import { b as resolveProviderEnvAuthLookupMaps, d as isNonSecretApiKeyMarker, f as isOAuthApiKeyMarker, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-DICpe16f.js";
...
import { h as resolveUsableCustomProviderApiKey, o as getCustomProviderApiKey } from "./model-auth-Aq6KQDp8.js";
import "./workspace-C9ULOsP_.js";
import { c as resolveKnownAgentId, r as ensureFlagCompatibility } from "./shared-CPDr1SqP.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-B90LQMBD.js";
import { t as maskApiKey } from "./mask-api-key-D2MLa8WN.js";
import { t as loadModelsConfig } from "./load-config-CWDrTH_A.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-B-KoyCnV.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-D8EpIMJk.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./terminal-core/table.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-HpRKbp3R.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		const resolveStatusAuthOrder = (order, provider) => {
			if (!order) return;
		...
		const listProviderProfileCandidates = (provider) => {
			...
			const explicitOrder = resolveStatusAuthOrder(store.order, providerAuthKey) ?? resolveStatusAuthOrder(store.order, providerKey) ?? resolveStatusAuthOrder(cfg.auth?.order, providerAuthKey) ?? resolveStatusAuthOrder(cfg.auth?.order, providerKey);
		...
		const hasUsableProviderAuth = (provider, options) => {
			for (const candidate of listRuntimeAuthProviderCandidates(provider, options)) if (listProviderProfileCandidates(candidate).some((profileId) => {
				const credential = store.profiles[profileId];
				return credential ? hasUsableAuthProfile(profileId, credential) : false;
			}) || hasUsableNonProfileAuth(candidate)) return true;
			return false;
		};
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-oGRVFjOO.js");
			runtime.log("");
