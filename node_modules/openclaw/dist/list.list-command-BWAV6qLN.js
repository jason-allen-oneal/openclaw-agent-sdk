...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-BPqzufTQ.js";
...
import { b as resolveProviderEnvAuthLookupMaps, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-DICpe16f.js";
import "./model-selection-CRIOhEQm.js";
import { t as resolveEnvApiKey } from "./model-auth-env-C3DgdFrA.js";
import { s as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-ZF0jyHxm.js";
import { l as hasSyntheticLocalProviderAuthConfig, u as hasUsableCustomProviderApiKey } from "./model-auth-Aq6KQDp8.js";
import { a as formatTokenK, h as createModelCatalogProviderAliasCanonicalizer, m as canonicalizeModelCatalogProviderAlias, r as ensureFlagCompatibility } from "./shared-CPDr1SqP.js";
import { n as loadModelsConfigWithSource } from "./load-config-CWDrTH_A.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-Mq2rfWlF.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-fkcZLJvM.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-C2D2ons9.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-N3JV2Vxx.js"),
		import("./agent-scope-CaldjiQX.js"),
		import("./workspace-8JcCCrsN.js")
	]);
