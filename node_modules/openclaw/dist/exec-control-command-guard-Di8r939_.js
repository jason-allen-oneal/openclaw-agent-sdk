...
import { t as buildCommandPayloadCandidates } from "./risks-DRxJ1pW5.js";
...
function detectUnsafeExecControlShellCommand(command) {
...
function rejectUnsafeExecControlShellCommand(command) {
