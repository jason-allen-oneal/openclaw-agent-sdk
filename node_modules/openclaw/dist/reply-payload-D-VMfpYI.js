import { a as normalizeLowercaseStringOrEmpty, p as readStringValue } from "./string-coerce-mnp54Vah.js";
...
async function sendTextMediaPayload(params) {
	...
	if (urls.length > 0) {
		...
		return await sendPayloadMediaSequence({
			text,
			mediaUrls: urls,
			send: async ({ text: textLocal, mediaUrl }) => await params.adapter.sendMedia({
				...params.ctx,
				text: textLocal,
				mediaUrl,
