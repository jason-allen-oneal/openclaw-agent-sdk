import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, n as localeLowercasePreservingWhitespace, s as normalizeOptionalLowercaseString } from "./string-coerce-mnp54Vah.js";
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-DN0dJKIU.js";
...
import { i as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-CbY2H91D.js";
...
import { o as emitTrustedDiagnosticEvent } from "./diagnostic-events-DNqaP5x8.js";
...
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-CVq3IOV2.js";
import "./agent-scope-B4NxGkqZ.js";
import { i as resolveAgentContextLimits } from "./agent-scope-config-DNJywrQV.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CjeTePSl.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-DXKcDDxT.js";
...
import { P as getCompactionProvider } from "./registry-B8gzOJBq.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Quvi-RcW.js";
import { F as isCacheEnabled, I as resolveCacheTtlMs, N as createExpiringMapCache } from "./store-load-BEkoRRyW.js";
import { n as sanitizeInlineImageBase64 } from "./inline-image-data-url-CwAAaSvc.js";
import { h as redactTranscriptMessage, m as isTranscriptOnlyOpenClawAssistantModel, p as isTranscriptOnlyOpenClawAssistantMessage$1 } from "./transcript-NdJkeRhp.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DTn-thXR.js";
import "./transcript-jsonl-CD0KPCG0.js";
import { K as validateProviderReplayTurnsWithPlugin, V as sanitizeProviderReplayHistoryWithPlugin, w as resolveProviderCacheTtlEligibility } from "./provider-runtime-Cp9BfFXg.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-BNIeGny8.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-B9X9dB3H.js";
import { i as streamSimple, o as getApiProvider } from "./stream-4o8pRyto.js";
import { ot as SettingsManager, s as DefaultResourceLoader } from "./sessions-C_fxanxf.js";
import { n as SUMMARIZATION_OVERHEAD_TOKENS } from "./compaction-planning-BD_0nYm1.js";
import { i as isSilentReplyPayloadText, o as isSilentReplyText } from "./tokens-U6o7_k27.js";
import { C as stripInternalMetadataForDisplay } from "./session-utils.fs-Y_TmTCGQ.js";
...
import { i as hasInterSessionUserProvenance, n as annotateInterSessionPromptText, r as applyInputProvenanceToUserMessage, s as normalizeInputProvenance } from "./input-provenance-CYQvfQZP.js";
...
import { l as isTimeoutError } from "./failover-error-CC108ogz.js";
...
import { t as log$3 } from "./logger-BEGZufhT.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible } from "./proxy-EmUa6oWt.js";
import { a as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-vl0D_wqS.js";
import { i as mergePreparedUserTurnMessageForRuntime } from "./user-turn-transcript-A1c264HL.js";
import { b as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime-B0D_K5RM.js";
import { a as resolveEffectiveCompactionMode, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-R-XbC6UK.js";
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt-ByaJGDhT.js";
import { c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, r as validateGeminiTurns, u as downgradeOpenAIReasoningBlocks, x as sanitizeGoogleTurnOrdering } from "./embedded-agent-helpers-CULGwdfn.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-xsNVzoaM.js";
import { n as createAnthropicVertexStreamFnForModel } from "./simple-completion-transport-CuosGKEE.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-Bg4kQKen.js";
import { t as STREAM_ERROR_FALLBACK_TEXT } from "./stream-message-shared-CdbBqwfX.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS, u as truncateToolResultMessage } from "./tool-result-truncation-CE7-U3RC.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-D6GtR58D.js";
import { a as resolveUserTimezone, t as formatDateStamp } from "./date-time-CcWivhrg.js";
import { a as computeAdaptiveChunkRatioWithWorker, d as shouldAllowProviderOwnedThinkingReplay, i as buildHistoryPrunePlanWithWorker, l as providerRequiresSignedThinking, n as resolveContextWindowTokens$1, r as summarizeInStages, t as createAgentToolResultMiddlewareRunner, u as resolveTranscriptPolicy } from "./tool-result-middleware-BUb-oCHG.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-IU6ycWo1.js";
...
async function repairSessionFileIfNeeded(params) {
	...
	if (droppedLines === 0 && rewrittenAssistantMessages === 0 && droppedBlankUserMessages === 0 && rewrittenUserMessages === 0 && removedCorruptedImageBlocks === 0) {
...
function buildSuccessorEntries(params) {
	...
	for (const entry of allEntries) {
		...
		const transformed = reparented.type === "message" && preCompactionKeptBranchIds.has(reparented.id) ? {
			...reparented,
...
//#endregion
export { isRealConversationMessage as A, dropReasoningFromHistory as B, sanitizeSessionHistory as C, limitHistoryTurns as D, getHistoryLimitFromSessionKey as E, readLastCacheTtlTimestamp as F, createPreparedEmbeddedAgentSettingsManager as G, stripThinkingBlocksFromMessage as H, logRuntimeToolSchemaQuarantine as I, guardSessionManager as L, consumeCompactionSafeguardCancelReason as M, setCompactionSafeguardCancelReason as N, buildEmbeddedExtensionFactories as O, isCacheTtlEligibleProvider as P, repairSessionFileIfNeeded as R, normalizeAssistantReplayContent as S, buildEmbeddedMessageActionDiscoveryInput as T, wrapAnthropicStreamWithRecovery as U, dropThinkingBlocks as V, isZeroUsageEmptyStopAssistantTurn as W, resolveEmbeddedAgentBaseStreamFn as _, flushPendingToolResultsAfterIdle as a, trackSessionManagerAccess as b, AGENT_RESERVED_TOOL_NAMES as c, collectRegisteredToolNames as d, toSessionToolAllowlist as f, resolveEmbeddedAgentApiKey as g, describeEmbeddedAgentStreamStrategy as h, dedupeDuplicateUserMessagesForCompaction as i, readPostCompactionContext as j, hasMeaningfulConversationContent as k, collectAllowedToolNames as l, buildEmbeddedSystemPrompt as m, rotateTranscriptFileAfterCompaction as n, mapThinkingLevel as o, applySystemPromptToSession as p, shouldRotateCompactionTranscript as r, normalizeContextTokenBudget as s, rotateTranscriptAfterCompaction as t, collectCoreBuiltinToolNames as u, resolveEmbeddedAgentStreamFn as v, validateReplayTurns as w, createEmbeddedAgentResourceLoader as x, prewarmSessionFile as y, assessLastAssistantMessage as z };
