...
import { n as GatewayClient, r as GatewayClientRequestError, u as loadDeviceAuthToken } from "./client-C6EKqjh8.js";
...
import { i as READ_SCOPE } from "./operator-scopes-CS3xdS-V.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-COcJMHpR.js");
