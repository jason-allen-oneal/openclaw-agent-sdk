...
import { a as readRecentSessionMessagesWithStatsAsync, f as readSessionMessagesWithSourceAsync, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-Y_TmTCGQ.js";
import "./session-utils-CFmlVr6t.js";
import { o as projectChatDisplayMessages, t as resolveTranscriptPathForComparison } from "./session-transcript-path-CXYa7E96.js";
...
var SessionHistorySseState = class SessionHistorySseState {
	...
	async readRawSnapshotAsync() {
		if (this.cursor === void 0 && typeof this.limit === "number") {
			const snapshot = await readRecentSessionMessagesWithStatsAsync(this.target.sessionId, this.target.storePath, this.target.sessionFile, {
		...
		const snapshot = await readSessionMessagesWithSourceAsync(this.target.sessionId, this.target.storePath, this.target.sessionFile, {
			mode: "full",
