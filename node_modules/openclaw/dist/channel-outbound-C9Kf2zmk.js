...
import "./ingress-queue-BFMx4Sx2.js";
...
import "./session-context-BJdulVUq.js";
...
import { c as resolveTextChunkLimit } from "./chunk-1L_d2oHv.js";
import "./payloads-DwYjapHo.js";
...
import "./reply-pipeline-7SGHwgw1.js";
import "./draft-stream-controls-B2vP943I.js";
import "./identity-Kaf1FxdO.js";
...
const loadChannelMessageRuntimeModule = async () => {
	channelMessageRuntimeModulePromise ??= import("./runtime-8SKjVNss.js");
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-B1acTXY6.js")).deliverInboundReplyWithMessageSendContext(...args);
};
