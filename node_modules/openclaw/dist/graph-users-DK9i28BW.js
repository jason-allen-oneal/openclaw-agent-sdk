...
import { c as hasConfiguredSecretInput, f as normalizeResolvedSecretInputString, p as normalizeSecretInputString } from "./types.secrets-B6pb_3Jn.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-sZLyyYht.js";
...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-Bt2gteFE.js";
...
async function loadSdkModules() {
	sdkAppPromise ??= Promise.all([import("./dist-BhVHAoSz.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-UAZjIOT1.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
		App: apps.App,
