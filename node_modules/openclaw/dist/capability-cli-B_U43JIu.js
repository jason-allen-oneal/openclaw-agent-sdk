...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-DNJywrQV.js";
...
import { p as normalizeThinkLevel } from "./thinking-CG8AzHpQ.js";
...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-BlqKbSL2.js";
...
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-jnx0nhpN.js";
import { D as registerMemoryEmbeddingProvider, T as listMemoryEmbeddingProviders } from "./registry-B8gzOJBq.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-CRIOhEQm.js";
...
import { d as resolveApiKeyForProvider } from "./model-auth-Aq6KQDp8.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-DKwhiUG7.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DbnOMpU3.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets--sBbmioM.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-Dy3sS7LZ.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-C2bbV71d.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-o5e1uKRE.js";
import "./tts-Bc1lw7_c.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D46DVVWN.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-rv4fcT8X.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-Vt-DsINg.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BeO2AZzO.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CSSbC7BO.js";
import { n as runCommandWithRuntime } from "./cli-utils-BlzSH7R8.js";
import { t as removeCommandByName } from "./command-tree-CA1ToIBK.js";
import { t as collectOption } from "./helpers-gBVG4H2O.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-D4GUiqfk.js";
import { o as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-D5XnVU30.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BRZbWM69.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-sfthMvmr.js");
