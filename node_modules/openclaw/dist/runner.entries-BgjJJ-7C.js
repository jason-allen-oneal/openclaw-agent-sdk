...
import { t as buildRandomTempFilePath } from "./temp-download-DdDTUgDl.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-BaxqicKH.js";
import { l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig } from "./config-state-0eXXevbb.js";
...
import { i as runExec } from "./exec-iwN9d-_i.js";
import { a as loadManifestContractSnapshot } from "./manifest-contract-eligibility-BFetL3S9.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-h45noMgy.js";
...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-T3Lq57Ip.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-DICpe16f.js";
...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-VMXHQrmK.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CYWsER5a.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Cc0PVjtu.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.js";
import { t as describeImageWithModel } from "./image-runtime-Dk2-Auiv.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-DbnOMpU3.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-Mb3MbWfb.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { n as providerOperationRetryConfig } from "./operation-retry-B5TpzNgi.js";
import "./temp-path-BPbF9HF3.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Cfhv66o5.js";
import { t as applyTemplate } from "./templating-CLmjS51i.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-EsvqqU3h.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-L8jNk0J3.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BfCGHNbO.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
