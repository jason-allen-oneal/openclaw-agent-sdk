...
import { l as calculateCost, n as transformMessages, s as buildBaseOptions, t as sanitizeSurrogates, u as clampThinkingLevel } from "./sanitize-unicode-CgzZKr22.js";
...
import { n as projectOpenAITools, r as reconcileOpenAICompletionsToolChoice, t as clampOpenAIPromptCacheKey } from "./openai-prompt-cache-fygROe7S.js";
...
const REASONING_TAG_RE = /<\s*(\/?)\s*(?:(?:antml:)?(?:think(?:ing)?|thought|reasoning)|antthinking)\b[^<>]*>/gi;
...
//#endregion
export { buildCodeSpanIndex as a, createReasoningTagTextPartitioner as i, streamOpenAICompletions as n, createInlineCodeState as o, streamSimpleOpenAICompletions as r, convertMessages as t };
