...
import { c as classifyPortListener, l as formatPortDiagnostics, o as inspectPortUsage } from "./ports-D2AqR0d4.js";
import { a as probeGateway } from "./probe-Ceu_sglj.js";
import { r as resolveGatewayProbeAuthSafeWithSecretInputs } from "./probe-auth-DpokG3N4.js";
...
async function waitForGatewayHealthyRestart(params) {
	...
	for (let attempt = 0; attempt < attempts; attempt += 1) {
		if (snapshot.healthy && (!params.requireRunningService || snapshot.runtime.status === "running")) return withWaitContext(snapshot, "healthy", attempt * delayMs);
