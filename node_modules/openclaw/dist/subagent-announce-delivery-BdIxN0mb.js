...
import { i as isCronSessionKey, r as isCronRunSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { n as normalizeAccountId } from "./account-id-Df9e41E6.js";
import { d as normalizeMainKey, f as resolveAgentIdFromSessionKey } from "./session-key-B_NoIfpX.js";
import { i as getRuntimeConfig } from "./io-fQmSDfK-.js";
import "./config-BqCwA_DI.js";
import "./call-BlqKbSL2.js";
...
import { i as mergeDeliveryContext, o as normalizeDeliveryContext } from "./delivery-context.shared-BlmyB9yJ.js";
...
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-CwsLAv0O.js";
import { p as resolveActiveEmbeddedRunSessionId } from "./run-state-DClKANFE.js";
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync, s as isEmbeddedAgentRunActive, u as isEmbeddedRunAbandoned } from "./runs-DI_L8C_8.js";
import { i as isSilentReplyPayloadText } from "./tokens-U6o7_k27.js";
import { a as isAgentMediatedCompletionSourceTool, c as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-CYQvfQZP.js";
import { n as getSessionBindingService, s as normalizeConversationRef } from "./session-binding-service-DByf0bZl.js";
import { s as isOutboundDeliveryError } from "./deliver-Cgr2aBSp.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-jkXQRYZ9.js";
import "./delivery-context-CB0EiNbM.js";
import { n as wrapPromptDataBlock } from "./sanitize-for-prompt-ByaJGDhT.js";
import { i as routeToDeliveryFields, r as routeFromConversationRef } from "./route-projection-V5gWY8Mf.js";
import { r as sourceDeliveryTargetsMatch } from "./source-delivery-plan-ZABXD_4F.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-C0AakYiQ.js";
import { t as resolveQueueSettings } from "./queue-DgtGULP_.js";
...
import { t as resolveConversationIdFromTargets } from "./conversation-id-CK1z1CKA.js";
...
async function sendSubagentAnnounceDirectly(params) {
	...
	try {
		...
		if (params.expectsCompletionMessage && !shouldDeliverAgentFinal && !requiresMessageToolDelivery && !hasVisibleGatewayAgentPayload(directAnnounceResponse) && !hasGatewayAgentCompletionSideEffectEvidence(directAnnounceResponse) && !hasIntentionalSilentGatewayAgentPayload(directAnnounceResponse)) return {
			delivered: false,
			path: "direct",
			reason: "visible_reply_missing",
			error: "completion agent did not produce a visible reply"
...
//#endregion
export { AGENT_INTERNAL_EVENT_TYPE_TASK_COMPLETION as _, resolveSubagentAnnounceTimeoutMs as a, hasCommittedMessagingToolDeliveryEvidence as c, hasVisibleAgentPayload as d, hasAcceptedSessionSpawn as f, formatAgentInternalEventsForPrompt as g, formatAgentInternalEventsForPlainPrompt as h, loadSessionEntryByKey as i, hasMessagingToolDeliveryEvidence as l, isNonTerminalAgentRunStatus as m, isInternalAnnounceRequesterSession as n, resolveSubagentCompletionOrigin as o, normalizeAcceptedSessionSpawnResult as p, loadRequesterSessionEntry as r, runAnnounceDeliveryWithRetry as s, deliverSubagentAnnouncement as t, hasOutboundDeliveryEvidence as u, formatGeneratedAttachmentLines as v, mediaUrlsFromGeneratedAttachments as y };
