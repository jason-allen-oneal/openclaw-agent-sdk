...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, s as resolveInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-fA-EQXn-.js";
...
function readPersistedInstalledPluginIndexFromSqlite(options = {}) {
	...
	try {
		return parseInstalledPluginIndexSqliteRow(openOpenClawStateDatabase(resolveStateDatabaseOptions(options)).db.prepare(`
