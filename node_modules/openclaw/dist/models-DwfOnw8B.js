import { _ as parseStrictFiniteNumber, l as asPositiveSafeInteger } from "./number-coercion-CJQ8TR--.js";
...
async function discoverVercelAiGatewayModels() {
	...
	try {
		const discovered = (await getCachedLiveProviderModelRows({
		...
		})).map(asVercelGatewayModelShape).map(buildDiscoveredModelDefinition).filter((entry) => entry !== null);
