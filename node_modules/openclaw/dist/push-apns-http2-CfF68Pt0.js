...
var HttpConnectTunnelAttempt = class {
	...
	startTimeout() {
		const timeoutMs = this.params.timeoutMs === void 0 || this.params.timeoutMs <= 0 ? void 0 : resolveTimerTimeoutMs(this.params.timeoutMs, MIN_CONNECT_TIMEOUT_MS);
		if (timeoutMs !== void 0) this.timeout = setTimeout(() => {
			this.fail(/* @__PURE__ */ new Error(`Proxy CONNECT timed out after ${timeoutMs}ms`));
		}, timeoutMs);
	}
	clearTimer() {
		if (this.timeout) {
...
//#endregion
export { probeApnsHttp2ReachabilityViaProxy as a, createApnsResponseBodyCapture as i, appendApnsResponseBodyCapture as n, connectApnsHttp2Session as r, APNS_HTTP2_CANCEL_CODE as t };
