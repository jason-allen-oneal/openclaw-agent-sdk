import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString } from "./string-coerce-mnp54Vah.js";
...
import { _ as uniqueStrings, l as normalizeStringEntries, n as normalizeAtHashSlug } from "./string-normalization-WNUDCpXX.js";
import { r as openRootFile } from "./root-file-jRMCpJW4.js";
import { v as sliceUtf16Safe, y as truncateUtf16Safe } from "./utils-CCC-BEJH.js";
...
import { n as CHAT_CHANNEL_ORDER } from "./ids-COROyziI.js";
import { i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, p as resolveAgentSkillsFilter, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-B4NxGkqZ.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, u as normalizeAgentId } from "./session-key-B_NoIfpX.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-DNJywrQV.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-B3AjhIK3.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-DXKcDDxT.js";
import { r as logVerbose } from "./globals-DbTJQTMp.js";
...
import { d as normalizeElevatedLevel, f as normalizeReasoningLevel, g as normalizeVerboseLevel, m as normalizeTraceLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels, u as isSessionDefaultDirectiveValue } from "./thinking-CG8AzHpQ.js";
import "./config-BqCwA_DI.js";
import { a as normalizeAnyChannelId } from "./registry-r77FTpHr.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-CIjmr4bc.js";
import { l as markCommandReplyForDelivery } from "./reply-payload-CZJ2cgZc.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Quvi-RcW.js";
...
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-BlmyB9yJ.js";
import "./message-channel-constants-CgI32lqD.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-NEwU8m3X.js";
import { D as resolveMaintenanceConfigFromInput, V as resolveSessionStoreEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BEkoRRyW.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-IRSLm2FP.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BzNekEY8.js";
import { b as resolveGroupSessionKey, d as updateSessionStore, g as deriveSessionMetaPatch } from "./store-Dcn5FSKd.js";
...
import { r as isInternalMessageChannel } from "./message-channel-Dx39C4tw.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-D8S_uNvu.js";
import { a as hasTerminalMainSessionTranscriptNewerThanRegistry, c as resolveSessionLifecycleTimestamps } from "./sessions-DieR2Eem.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-CvIGl7dh.js";
import { n as resolveSessionKey } from "./session-key-bwyd0m3E.js";
import { d as resolveAndPersistSessionFile } from "./transcript-NdJkeRhp.js";
import { y as resolveModelRefFromString } from "./model-selection-shared-By-X2JmI.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-DxcHqA8K.js";
import "./model-selection-CRIOhEQm.js";
import { n as loadModelCatalog } from "./model-catalog-D05d2kfO.js";
import { s as getMediaDir } from "./store-C9M_0A1p.js";
import { d as ensureAgentWorkspace, h as isWorkspaceBootstrapPending } from "./workspace-C9ULOsP_.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, r as isAuthorizedTextSlashCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-YXLLZVCi.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-Bl6V2_lJ.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-CO2vrvx5.js";
...
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-wBpPJDPa.js";
import { a as enqueueSystemEvent } from "./system-events--U8AE18s.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { _ as waitForReplyRunEndBySessionId, g as resolveActiveReplyRunThreadId, h as resolveActiveReplyRunSessionId, i as abortReplyRunBySessionId, l as isReplyRunActiveForSessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, u as isReplyRunStreamingForSessionId } from "./reply-run-registry-Ccw3Ogdy.js";
import { a as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText } from "./tokens-U6o7_k27.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-B7VNQKmB.js";
import { n as annotateInterSessionPromptText, o as isInterSessionInputProvenance } from "./input-provenance-CYQvfQZP.js";
import { l as getQueueSize, r as clearCommandLane } from "./command-queue-DxRdA7fT.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-Bhv9Hc00.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-mRNooZFa.js";
import { x as normalizeExecTarget } from "./exec-approvals-C6M6SGY3.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-B49veuCn.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-CicGJ6Bb.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-52t6V0oE.js";
import { a as resolvePersistedUserTurnText, n as buildPersistedUserTurnMediaInputsFromFields, o as isReasoningTagProvider, r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-A1c264HL.js";
import { u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-B0D_K5RM.js";
import "./agent-bundle-mcp-tools-BGNF7jxG.js";
import "./delivery-context-CB0EiNbM.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun } from "./subagent-spawn-plan-DivWGEJB.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { d as extractQueueDirective, f as skipDirectiveArgPrefix, p as takeDirectiveToken, t as resolveQueueSettings } from "./queue-DgtGULP_.js";
import { t as buildOutboundSessionContext } from "./session-context-BJdulVUq.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-3KJRVv63.js";
import { r as getCliSessionBinding } from "./cli-session-D_Cr4kxU.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-wuJXT5d1.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-Dp9_flb7.js";
import { t as resolveChannelModelOverride } from "./model-overrides-OHunRizl.js";
import { a as resolveCurrentTurnImages, r as createReplyTimingTracker, s as resolveSilentReplySettings, t as isSystemEventProvider } from "./effective-reply-route-CMX4b9Bu.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-BkCP8ve-.js";
import "./commands-registry-ChZ74sL3.js";
import { n as hasInboundMedia, t as hasInboundAudio } from "./inbound-media-Bidp906t.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DAROa9u0.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-DDw6htSU.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CAtgCV5h.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-zay2pJux.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-idTqAPpY.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-c9UeTEOK.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-mFL5xdI9.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-DGBUT5bc.js";
...
import { n as shouldUseFromAsSenderFallback } from "./command-auth-Dw6QZO1u.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-fnVhj49B.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-DDCtYlOn.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-Bhqrnj4A.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-BLl9MAh-.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-D3Nh2jnN.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-IMcsY0tl.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-Dhiu7C0L.js";
import { t as resolveFastModeState } from "./fast-mode-Gt-xvstA.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-BnR__Nva.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-CW2Df3DJ.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BD9n8qra.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-C2sUDuml.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-c9clcyWx.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-Cgqn-5by.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-iXunKRfS.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-1G2-vCcs.js";
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-B6VZp21z.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-BZXZZyYW.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CdAv37Dn.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dq7L4_ND.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DalXCNcz.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-DIm4eW6D.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-Deb0PLqL.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-qULxosdH.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-iXmFMKuK.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-CjBAQr86.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-8SKjVNss.js");
...
async function initSessionState(params) {
	...
	const freshEntry = isSystemEvent && canReuseExistingEntry || ((entryFreshness?.fresh ?? false) || softResetAllowed && canReuseExistingEntry) && !terminalMainTranscriptNewerThanRegistry;
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-CrirFZTb.js"));
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const { sessionCtx, sessionEntry, previousSessionEntry, sessionStore, sessionKey, sessionId, isNewSession, resetTriggered, systemSent, storePath, sessionScope, groupResolution, isGroup, triggerBodyNormalized, bodyStripped } = sessionState;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { applySessionStoreEntryPatch } = await import("./sessions-D93GAjj_.js");
