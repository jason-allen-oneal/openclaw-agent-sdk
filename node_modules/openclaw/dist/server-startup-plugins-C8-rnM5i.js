...
import { r as collectUnregisteredConfiguredMemoryEmbeddingProviders } from "./gateway-startup-plugin-ids-mVzqhEQT.js";
import { s as listCoreGatewayMethodNames } from "./core-descriptors-CqQ0q50E.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-0pR8_hqf.js";
import { j as listRegisteredEmbeddingProviders } from "./registry-B8gzOJBq.js";
import { I as createEmptyPluginRegistry, S as setActivePluginRegistry, o as getActivePluginRegistry } from "./runtime-CjN6pXNK.js";
import "./channel-plugin-ids-Bilbiauk.js";
import { n as loadPluginLookUpTable } from "./plugin-lookup-table-BJpP-uH-.js";
import { l as initSubagentRegistry } from "./subagent-registry-B0bRSEpe.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-ChqOWNk0.js";
import { n as listGatewayMethods } from "./server-methods-list-DeBmCVR-.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-DrO_w_ej.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-Bno8cPX1.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-DgMSTyVY.js");
