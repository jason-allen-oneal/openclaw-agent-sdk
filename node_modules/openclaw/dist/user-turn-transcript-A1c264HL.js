...
import { O as resolveProviderReasoningOutputModeWithPlugin } from "./provider-runtime-Cp9BfFXg.js";
import { r as applyInputProvenanceToUserMessage, s as normalizeInputProvenance } from "./input-provenance-CYQvfQZP.js";
...
async function persistUserTurnTranscript(params) {
	...
	if (!message) return;
	const { resolveSessionTranscriptFile } = await import("./transcript-DpF68wO8.js");
...
function createUserTurnTranscriptRecorder(params) {
	...
	const handlePersistenceError = (error) => {
		...
		import("./globals-ux6uhDg0.js").then(({ logVerbose }) => {
