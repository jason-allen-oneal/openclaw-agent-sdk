import { a as normalizeLowercaseStringOrEmpty, p as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-mnp54Vah.js";
...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-BnZEAmHB.js";
import { l as resolveProviderRequestPolicyConfig } from "./provider-request-config-T3Lq57Ip.js";
import { i as streamSimple } from "./stream-4o8pRyto.js";
import { C as streamWithPayloadPatch } from "./provider-stream-shared-DYzZwCmi.js";
import { a as patchCodexNativeWebSearchPayload, o as resolveCodexNativeSearchActivation } from "./codex-native-web-search-core-C1EZq5kS.js";
import { S as emitModelTransportDebug, b as flattenCompletionMessagesToStringContent, i as createOpenAIResponsesTransportStreamFn, v as applyOpenAIResponsesPayloadPolicy, x as stripCompletionMessagesToRoleContent, y as resolveOpenAIResponsesPayloadPolicy } from "./openai-transport-stream-C-e3sRQi.js";
import { a as resolveOpenAIReasoningEffortForModel } from "./openai-reasoning-compat-BZb-xoTp.js";
import { t as log$1 } from "./logger-BEGZufhT.js";
import { r as resolveAnthropicEphemeralCacheControl, t as applyAnthropicEphemeralCacheControlMarkers } from "./anthropic-payload-policy-gISaP6Qi.js";
...
function createOpenAIFastModeWrapper(baseStreamFn) {
	const underlying = baseStreamFn ?? streamSimple;
	return (model, context, options) => {
		if (model.api !== "openai-responses" && model.api !== "openai-chatgpt-responses" && model.api !== "azure-openai-responses" || model.provider !== "openai") return underlying(model, context, options);
		const originalOnPayload = options?.onPayload;
		return underlying(model, context, {
			...options,
			onPayload: (payload) => {
