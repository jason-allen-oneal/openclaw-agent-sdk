...
import { isBlockedSpecialUseIpv4Address, isBlockedSpecialUseIpv6Address, isIpv4Address, isIpv6Address, parseCanonicalIpAddress, } from "../net-policy/ip.js";
import { DEFAULT_DENY_PRIVATE_RANGES } from "../index.js";
/**
 * Check whether a domain is in the denied list.
 * Supports exact match and wildcard prefix (*.example.com).
 */
function isDeniedDomain(domain, deniedDomains) {
 ...
 */
export function checkNetworkEgress(domain, policy) {
    // Egress mode check
 ...
 */
export function isPrivateIp(ip, denyRanges = [...DEFAULT_DENY_PRIVATE_RANGES]) {
    void denyRanges;
 ...
 */
export function checkDnsRebinding(domain, resolvedIp, policy) {
